...
const getOrders = () => {
  ...
  fetch(`${_domain__WEBPACK_IMPORTED_MODULE_2__.appAddr}/api/orders/get-all`).then(res => res.json()).then(data => {
    ...
    data.data.forEach(d => {
      ...
      (0,_drawOrders__WEBPACK_IMPORTED_MODULE_1__.drawOrders)(d, data);
    });
...
const triggerRoutesModal = e => {
  ...
  console.log(_domain__WEBPACK_IMPORTED_MODULE_2__.state);
