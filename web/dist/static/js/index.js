...
`;
const issuedHandler = (e, issuedInput, plotI, userI) => {
  ...
  okBtn.addEventListener('click', () => {
    ...
    if (check) {
      (0,_routesModal__WEBPACK_IMPORTED_MODULE_1__.addLog)(_table__WEBPACK_IMPORTED_MODULE_2__.user.nickname, `${plot.value} За смену ${date.value} ${userData.value} ${issuedTodayInput.value}`, '#visible__comments');
    } else {
      (0,_routesModal__WEBPACK_IMPORTED_MODULE_1__.addLog)(_table__WEBPACK_IMPORTED_MODULE_2__.user.nickname, `${plot.value} За смену ${issuedTodayInput.value}`, '#visible__comments');
    }
    (0,_routesModal__WEBPACK_IMPORTED_MODULE_1__.addLog)(_table__WEBPACK_IMPORTED_MODULE_2__.user.nickname, `${plot.value} За смену ${date.value} ${userData.value} ${issuedTodayInput.value}`, '#visible__comments');
    modal.click();
  });
...
const triggerRoutesModal = e => {
  ...
  issuedBtn.addEventListener('click', e => {
    (0,_issuedModal__WEBPACK_IMPORTED_MODULE_11__.issuedHandler)(e, issued, routePlot.value, routeUser.value);
  });
...
if (!(_modules_state__WEBPACK_IMPORTED_MODULE_4__.state.adminCheck || _modules_state__WEBPACK_IMPORTED_MODULE_4__.state.manCheck)) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\n.container {\n  padding: 0 15px;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: #447e9b;\n  margin-bottom: 15px;\n}\n.main__button {\n  height: 28px;\n  text-align: center;\n  border: 1px solid black;\n  border-radius: 5px;\n  background: white;\n  color: #447e9b;\n  transition: color 0.3s;\n  cursor: pointer;\n  padding: 5px;\n}\n.main__button:hover {\n  color: #13d9d9;\n  transition: color 0.3s;\n}\n.main__input {\n  padding: 5px;\n  cursor: text;\n  border: 1px solid black;\n  border-radius: 5px;\n  color: #447e9b;\n}\n.main-table__data {\n  width: 100%;\n  height: 68vh;\n  overflow: scroll;\n  margin-bottom: 5px;\n  border-left: 1px solid black;\n  border-right: 1px solid black;\n}\n@media screen and (max-width: 1200px) {\n  .main-table__data {\n    height: 65vh;\n  }\n}\n@media screen and (min-width: 1500px) {\n  .main-table__data {\n    height: 73vh;\n  }\n}\n@media screen and (min-width: 1920px) {\n  .main-table__data {\n    height: 77vh;\n  }\n}\n.main__select {\n  text-align: center !important;\n}\n.main__select {\n  width: 100%;\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n}\n\n.warning {\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active,\na:hover,\na {\n  -webkit-text-decoration: none;\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n}\nselect:disabled:hover {\n  color: gray;\n}\n\ninput:disabled {\n  cursor: default;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n}\nbutton:disabled:hover {\n  color: gray;\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test__form {\n  display: none;\n  visibility: hidden;\n}\n.test__list {\n  background: none;\n}\n.test__item {\n  background: transparent;\n}\n.test__input {\n  background: transparent;\n  outline: none;\n  border: none;\n}\n\n.admin-form__button {\n  width: 130px;\n  transition: color 0.3s;\n  position: absolute;\n  right: 24px;\n}\n.admin-form__button:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n.admin-form__user {\n  margin-right: 10px;\n}\n.admin-form__exit {\n  transition: color 0.3s;\n}\n.admin-form__exit:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n.search {\n  display: flex;\n  align-items: center;\n}\n@media screen and (max-width: 1200px) {\n  .search {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 1;\n  position: absolute;\n  min-width: 100%;\n  background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border: 1px solid #333;\n}\n.check-helper--long {\n  min-width: 300%;\n}\n.check-helper--errored {\n  padding: 0;\n  color: black;\n}\n\n.nav-filters {\n  margin-top: 10px;\n  margin-bottom: 15px;\n  position: relative;\n  border: 1px solid black;\n  border-radius: 5px;\n  padding: 5px 25px;\n  display: flex;\n  flex-direction: column;\n}\n.nav-filters__list {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.nav-filters__list:not(:last-child) {\n  padding-bottom: 5px;\n  margin-bottom: 5px;\n}\n.nav-filters__item:not(:last-child) {\n  margin-right: 10px;\n}\n.nav-filters__button--chosen {\n  background: #f3efef;\n  color: #13d9d9;\n}\n\n.nav-filters__plots {\n  margin-top: 15px;\n  border-bottom: 1px solid black;\n}\n.nav-filters__filters {\n  margin-bottom: 0 !important;\n}\n.nav-filters__reset {\n  width: 131px;\n  display: block;\n  align-self: center;\n}\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: #f3efef;\n  border: 1px solid black;\n  border-bottom: none;\n  border-radius: 5px 5px 0 0;\n  padding: 5px 30px;\n}\n.main-header__title {\n  height: 34px;\n  color: #447e9b;\n  margin-right: 20px;\n  font-size: 27px;\n}\n.main-header__nav {\n  display: flex;\n  align-items: center;\n  width: 400px;\n}\n.main-header__button:not(:last-child) {\n  margin-right: 20px;\n}\n\n.header-routes__filter:not(:last-child) {\n  margin-right: 10px;\n}\n.header-routes__planned-date {\n  width: 120px;\n}\n\n#search__target {\n  width: 120px !important;\n}\n\n#search__target {\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  color: #13d9d9;\n}\n\n.modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n}\n.modal_content {\n  display: flex;\n  flex-direction: column;\n  width: 900px;\n  height: auto;\n  background: white;\n  border: 1px solid black;\n  border-radius: 5px;\n}\n.modal-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 5px;\n  background: #f3efef;\n  color: #447e9b;\n  height: 30px;\n  text-align: center;\n}\n.modal__trigger {\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  justify-content: center;\n  width: 100%;\n  height: 100px;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  color: #447e9b;\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 5px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n}\n.data__file {\n  position: relative;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 60px;\n}\n\n.link__preview {\n  display: block;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 10px;\n}\n\n.file__preview {\n  width: 280px;\n  height: 280px;\n}\n.file__download {\n  color: #447e9b !important;\n}\n.file__download {\n  cursor: pointer;\n  position: absolute;\n  width: 30px;\n  height: 40px;\n  bottom: 5px;\n  right: 10px;\n  transition: color 0.3s;\n}\n.file__download:hover {\n  color: #13d9d9 !important;\n}\n.file__download:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__remove {\n  color: #447e9b !important;\n}\n.file__remove {\n  cursor: pointer;\n  top: 0px;\n  right: 5px;\n  position: absolute;\n  font-size: 26px;\n  transform: rotate(45deg);\n  transition: color 0.3s;\n}\n.file__remove:hover {\n  color: red !important;\n}\n.file__remove:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__original {\n  color: #447e9b !important;\n}\n.file__original {\n  position: absolute;\n  top: 5px;\n  left: 5px;\n  transition: color 0.3s;\n}\n.file__original:hover {\n  color: #13d9d9 !important;\n}\n.file__original:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__name {\n  color: #447e9b;\n  text-align: center;\n}\n.file__all {\n  align-self: center;\n  width: 170px;\n  margin-bottom: 15px;\n}\n\n.modal_content--route {\n  width: 615px;\n  height: auto;\n}\n\n.route__config {\n  padding: 0 10px;\n}\n.route-block__wrapper {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n}\n.route__block {\n  display: flex;\n  flex-direction: column;\n}\n.route__input:not(:disabled) {\n  cursor: pointer;\n}\n.route-plan__date {\n  margin-right: 0 !important;\n}\n.route__label {\n  text-align: center;\n}\n.route__btn {\n  width: 170px;\n}\n.route__select {\n  width: 170px;\n  margin-bottom: 10px;\n}\n.route__input {\n  width: 170px;\n  margin-right: 30px;\n}\n.route__input--small {\n  width: 48%;\n}\n.route__input--small:not(:last-child) {\n  margin-right: 2%;\n}\n.route__input--top {\n  text-align: center;\n  margin-bottom: 10px;\n  height: 28px;\n}\n.route__section {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  margin-bottom: 15px;\n}\n\n.section-logs {\n  width: 100%;\n  background: #f3efef;\n  border: 1px solid black;\n  border-radius: 5px;\n  padding: 5px;\n  margin-bottom: 30px;\n}\n.section-logs__title {\n  text-align: center;\n  margin-bottom: 10px;\n  color: #447e9b;\n}\n.section-logs__list {\n  margin-bottom: 30px;\n  height: 85px;\n  overflow-y: scroll;\n}\n.section-logs__item {\n  color: #13d9d9;\n  margin-bottom: 5px;\n}\n.section-logs__comment {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.section-logs__input {\n  width: 350px;\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n.section-finish__cancel {\n  margin-right: 30px;\n}\n.section-finish__delete:hover {\n  color: red !important;\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued {\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment__title {\n  color: #447e9b;\n  text-align: center;\n  margin-bottom: 30px;\n}\n.comment__prev {\n  overflow-y: scroll;\n  background: #f3efef;\n  height: 100%;\n}\n.comment__item {\n  color: #13d9d9;\n  font-size: 17px;\n}\n.comment__item:not(:last-child) {\n  margin-bottom: 6px;\n}\n\n.confirm__title {\n  margin-top: 10px;\n  text-align: center;\n  color: #447e9b;\n  margin-bottom: 25px;\n}\n.confirm__section {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.confirm__button {\n  margin-bottom: 10px;\n}\n.confirm__button--ok {\n  margin-right: 25px;\n}\n\n.progress-block {\n  width: 170px;\n}\n\n.quantity-block {\n  display: flex;\n}\n.quantity-block__labels {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.quantity-block__label {\n  margin-right: 35px;\n}\n.quantity-block__inshifts {\n  margin-right: 22px;\n  position: relative;\n  right: 13px;\n}\n\n.route-type__paused {\n  border: 2px solid orange;\n}\n.route-type__error {\n  border: 2px solid red;\n}\n.route-type__start {\n  border: 2px solid #ffff4e;\n}\n.route-type__finish {\n  border: 2px solid green;\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n}\n#route__delete:disabled:hover {\n  color: gray !important;\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-error__input {\n  margin-right: 0;\n  width: 90%;\n  height: 50px;\n  margin-bottom: 15px;\n}\n.modal-error__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-issued__date {\n  margin-bottom: 10px;\n  margin-right: 0;\n}\n.modal-issued__input {\n  margin-right: 0;\n  width: 20%;\n  height: 28px;\n  margin-bottom: 15px;\n}\n.modal-issued__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.modal--comment .modal_content {\n  width: 650px;\n  height: 450px;\n  padding: 10px;\n}\n\n.comments-list {\n  height: 250px;\n  overflow-y: scroll;\n}\n.comments-list__item {\n  color: #13d9d9;\n  border: 1px solid black;\n  border-radius: 5px;\n  padding: 6px;\n  min-height: 28px;\n  margin-bottom: 5px;\n  display: flex;\n  align-items: center;\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n  margin-bottom: 25px;\n}\n\n.comments__prev {\n  margin-bottom: 25px;\n}\n\n.comments__yours {\n  margin-bottom: 25px;\n}\n\n.modal-plan {\n  padding: 5px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-plan__section {\n  width: 250px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.modal-plan__section:not(:last-child) {\n  margin-bottom: 10px;\n}\n.modal-plan__data {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__input {\n  width: 120px;\n}\n.modal-plan__check {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__exclude {\n  text-align: center;\n  height: 100px;\n}\n.modal-plan__exclude-option {\n  text-align: center;\n  padding: 2px;\n}\n.modal-plan__exclude-option:hover {\n  cursor: pointer;\n}\n\n.confirm__title--plan {\n  margin-bottom: 15px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.main-table__header {\n  display: flex;\n  align-items: center;\n  position: sticky;\n  z-index: 10;\n  top: 0;\n  width: 100%;\n}\n.main-table__item {\n  display: flex;\n  align-items: center;\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table__cell {\n  height: 28px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-size: 16px;\n  cursor: default;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  background: white;\n}\n.table__cell:not(:last-child) {\n  border-right: 1px solid black;\n}\n.table:last-child {\n  border-right: none;\n}\n.table__use label {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.table__use label:hover {\n  color: #13d9d9;\n  transition: color 0.3s;\n}\n.table__data {\n  height: 28px;\n  width: 100%;\n  text-align: center;\n  border-radius: 1px;\n  border: none;\n  background: white;\n  color: black;\n  outline: 3.3px #447e9b;\n  position: relative;\n}\n.table__data--ro {\n  cursor: default;\n  outline: none;\n}\n.table__data--chosen {\n  font-size: 15px;\n  background: #f3efef;\n  color: #447e9b;\n}\n.table__data--opened {\n  height: 56px;\n  border-bottom: 1px solid black;\n  font-size: 15px;\n  background: #f3efef;\n  color: #447e9b;\n}\n.table__data--current {\n  color: #13d9d9;\n  -webkit-text-decoration: underline;\n  text-decoration: underline;\n  font-style: italic;\n}\n.table__db {\n  display: flex;\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__timestamp {\n  min-width: 100px;\n  max-width: 100px;\n}\n.table__files {\n  min-width: 32px;\n  max-width: 32px;\n  position: relative;\n}\n.table__number {\n  min-width: 80px;\n  max-width: 80px;\n}\n.table__sample {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table__client {\n  min-width: 160px;\n  max-width: 160px;\n}\n.table__name {\n  min-width: 260px;\n  max-width: 260px;\n}\n.table__material {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__quantity {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued {\n  border-right: 1px solid black !important;\n}\n.table__issued {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued--done {\n  color: green;\n  animation: issued-ready infinite 4s;\n}\n.table__complete {\n  border-right: none !important;\n}\n.table__complete {\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n}\n.table__complete input {\n  height: 26px;\n}\n.table__m {\n  min-width: 36px;\n  max-width: 36px;\n}\n.table__endtime {\n  min-width: 130px;\n  max-width: 130px;\n}\n.table__route:last-child {\n  border-right: 1px solid black !important;\n}\n.table__routes {\n  min-width: 400px;\n  max-width: 400px;\n}\n.table__p {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table-p-select, .table-m-select {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  cursor: pointer;\n}\n.table__comment {\n  flex-grow: 1;\n  min-width: 200px;\n  max-width: 100%;\n}\n.table-routes__wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body_cell {\n  max-height: 56px;\n  font-size: 16px;\n  border-right: 1px solid black;\n  border-bottom: 1px solid black;\n  position: relative;\n}\n.table-body_cell:last-child {\n  border-right: none;\n}\n.table-body_cell--opened {\n  height: 56px;\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n  50% {\n    background: green;\n    color: white;\n  }\n  100% {\n    background: white;\n    color: black;\n  }\n}\n.table__route:first-child {\n  border-left: none;\n}\n.table__route--issued {\n  border-top: none;\n  max-height: 28px;\n}\n.table__route--issued:last-child {\n  border-right: 1px solid black;\n}\n.table__route--issued:first-child {\n  border-left: none;\n}\n.table__route--issued input {\n  height: 26px;\n}\n\n.route {\n  color: black;\n}\n.route--planned {\n  -webkit-text-decoration: underline;\n  text-decoration: underline;\n}\n.route--paused {\n  background: orange;\n}\n.route--started {\n  background: #ffff4e;\n}\n.route--error {\n  background: #de1313;\n}\n.route--completed {\n  background: #09d009;\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color 0.3s;\n}\n.order__delete:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: white;\n}", "",{"version":3,"sources":["webpack://./web/src/static/css/table/table.scss","webpack://./web/src/static/css/main.scss","webpack://./web/src/static/css/var.scss","webpack://./web/src/static/css/table/top_filters.scss","webpack://./web/src/static/css/table/table_nav.scss","webpack://./web/src/static/css/table/files_modal.scss","webpack://./web/src/static/css/table/route_modal.scss","webpack://./web/src/static/css/table/comments_modal.scss","webpack://./web/src/static/css/table/planModal.scss"],"names":[],"mappings":"AAAA,gBAAgB;ACEhB;EACE,UAAA;EACA,SAAA;EACA,sBAAA;ADAF;;ACGA;;EAEE,8CAAA;EACA,wBAAA;EACA,SAAA,EAAA,uEAAA;ADAF;;ACGA;EACE,eAAA;ADAF;;ACGA;EACE,gBAAA;ADAF;;ACGA;EACE,wBAAA;EACA,6BAAA;ADAF;;ACGA;EACE,wBAAA;EACA,6BAAA;ADAF;;ACGA;EACE,cCjCa;EDkCb,mBAAA;ADAF;ACIE;EACE,YAAA;EACA,kBAAA;EACA,uBAAA;EACA,kBAAA;EACA,iBAAA;EACA,cC5CW;ED6CX,sBAAA;EACA,eAAA;EACA,YAAA;ADFJ;ACII;EACE,cCnDO;EDoDP,sBAAA;ADFN;ACME;EACE,YAAA;EACA,YAAA;EACA,uBAAA;EACA,kBAAA;EACA,cC5DW;AFwDf;ACOE;EACE,WAAA;EACA,YAAA;EACA,gBAAA;EACA,kBAAA;EACA,4BAAA;EACA,6BAAA;ADLJ;ACOI;EARF;IASI,YAAA;EDJJ;AACF;ACMI;EAZF;IAaI,YAAA;EDHJ;AACF;ACKI;EAhBF;IAiBI,YAAA;EDFJ;AACF;ACKE;EACE,6BAAA;ADFJ;ACCE;EAEE,WAAA;ADHJ;;ACOA;EACE,uBAAA;ADJF;;ACOA;EACE,qBAAA;ADJF;;ACOA;EACE,yBAAA;ADHF;;ACEA;EAEE,kBAAA;ADJF;;ACOA;;EAEE,0BAAA;ADJF;;ACOA;;;EAGE,6BAAA;EAAA,qBAAA;EACA,WAAA;ADJF;;ACOA;EACE,eAAA;EACA,gBAAA;EACA,WAAA;ADJF;ACME;EACE,WAAA;ADJJ;;ACQA;EACE,eAAA;ADLF;;ACQA;EACE,eAAA;EACA,WAAA;ADLF;ACOE;EACE,WAAA;ADLJ;;ACSA;EACE,mBAAA;EACA,YAAA;EACA,kBAAA;ADNF;;ACUE;EACE,aAAA;EACA,kBAAA;ADPJ;ACUE;EACE,gBAAA;ADRJ;ACWE;EACE,uBAAA;ADTJ;ACYE;EACE,uBAAA;EACA,aAAA;EACA,YAAA;ADVJ;;ACeE;EACE,YAAA;EACA,sBAAA;EACA,kBAAA;EACA,WAAA;ADZJ;ACcI;EACE,sBAAA;EACA,cC/KO;AFmKb;ACgBE;EACE,kBAAA;ADdJ;ACiBE;EACE,sBAAA;ADfJ;ACiBI;EACE,sBAAA;EACA,cC5LO;AF6Kb;;ACoBA;EACE,kBAAA;EACA,aAAA;ADjBF;;ACqBA;EACE,aAAA;EACA,mBAAA;ADlBF;ACoBE;EAJF;IAKI,aAAA;EDjBF;AACF;;ACoBA;EACE,kBAAA;ADjBF;;ACoBA;EACE,kBAAA;ADjBF;;ACoBA;EACE,kBAAA;EACA,UAAA;EACA,kBAAA;EACA,eAAA;EAEA,oCAAA,EAAA,6BAAA;EACA,8BAAA,EAAA,qBAAA;EACA,eAAA,EAAA,4BAAA;EACA,gBAAA,EAAA,SAAA;EACA,sBAAA;ADlBF;ACoBE;EACE,eAAA;ADlBJ;ACqBE;EACE,UAAA;EACA,YAAA;ADnBJ;;AGvNA;EACE,gBAAA;EACA,mBAAA;EACA,kBAAA;EAEA,uBAAA;EACA,kBAAA;EACA,iBAAA;EAEA,aAAA;EACA,sBAAA;AHwNF;AGtNE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AHwNJ;AGtNI;EACE,mBAAA;EACA,kBAAA;AHwNN;AGnNI;EACE,kBAAA;AHqNN;AGhNI;EACE,mBD7BI;EC8BJ,cDhCO;AFkPb;;AG5ME;EACE,gBAAA;EACA,8BAAA;AH+MJ;AG7ME;EACE,2BAAA;AH+MJ;AG5ME;EACE,YAAA;EACA,cAAA;EACA,kBAAA;AH8MJ;;AI7PA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBFJQ;EEKR,uBAAA;EACA,mBAAA;EACA,0BAAA;EACA,iBAAA;AJgQF;AI7PE;EACE,YAAA;EACA,cFdW;EEeX,kBAAA;EACA,eAAA;AJ+PJ;AI5PE;EACE,aAAA;EACA,mBAAA;EACA,YAAA;AJ8PJ;AI1PI;EACE,kBAAA;AJ4PN;;AIrPI;EACE,kBAAA;AJwPN;AInPI;EACE,YAAA;AJqPN;;AIhPA;EACE,uBAAA;AJoPF;;AIrPA;EAEE,iBAAA;AJmPF;;AIhPA;EACE,YAAA;EACA,iBAAA;AJmPF;;AIhPA;EAEE,cAAA;AJkPF;;AK7SA;EACE,aAAA;EACA,uBAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,SAAA;EACA,QAAA;EACA,YAAA;ALgTF;AK9SE;EACE,aAAA;EACA,sBAAA;EACA,YAAA;EACA,YAAA;EACA,iBAAA;EACA,uBAAA;EACA,kBAAA;ALgTJ;AK7SE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,YAAA;EACA,mBHvBM;EGwBN,cHzBW;EG0BX,YAAA;EACA,kBAAA;AL+SJ;AK5SE;EACE,aAAA;EACA,mBAAA;EACA,eAAA;EACA,uBAAA;EACA,WAAA;EACA,aAAA;EAEA,2BAAA;EACA,8BAAA;EACA,cHxCW;AFqVf;;AKzSA;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;AL4SF;;AKzSA;EACE,gBAAA;AL4SF;;AKxSA;EACE,aAAA;EACA,aAAA;EACA,YAAA;EACA,kBAAA;EACA,8BAAA;EACA,eAAA;EACA,mBAAA;AL2SF;AKzSE;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;AL2SJ;;AKvSA;EACE,cAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;AL0SF;;AKtSE;EACE,YAAA;EACA,aAAA;ALySJ;AKrSE;EAOE,yBAAA;ALwSJ;AK/SE;EACE,eAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,WAAA;EAEA,sBAAA;ALuSJ;AKrSI;EAEE,yBAAA;ALwSN;AK1SI;EACE,eAAA;EAEA,sBAAA;ALuSN;AKnSE;EAKE,yBAAA;ALwSJ;AK7SE;EACE,eAAA;EACA,QAAA;EACA,UAAA;EACA,kBAAA;EAEA,eAAA;EACA,wBAAA;EACA,sBAAA;ALqSJ;AKnSI;EAEE,qBAAA;ALsSN;AKxSI;EACE,eAAA;EAEA,sBAAA;ALqSN;AKhSE;EAIE,yBAAA;ALmSJ;AKvSE;EACE,kBAAA;EACA,QAAA;EACA,SAAA;EAEA,sBAAA;ALkSJ;AKhSI;EAEE,yBAAA;ALmSN;AKrSI;EACE,eAAA;EAEA,sBAAA;ALkSN;AK9RE;EACE,cHxIW;EGyIX,kBAAA;ALgSJ;AK7RE;EACE,kBAAA;EACA,YAAA;EACA,mBAAA;AL+RJ;;AM/aA;EACE,YAAA;EACA,YAAA;ANkbF;;AM9aE;EACE,eAAA;ANibJ;AM7aI;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AN+aN;AM3aE;EACE,aAAA;EACA,sBAAA;AN6aJ;AMzaI;EACE,eAAA;AN2aN;AMnaE;EACE,0BAAA;ANqaJ;AMlaE;EACE,kBAAA;ANoaJ;AMjaE;EACE,YAAA;ANmaJ;AMhaE;EACE,YAAA;EACA,mBAAA;ANkaJ;AM/ZE;EACE,YAAA;EACA,kBAAA;ANiaJ;AM/ZI;EACE,UAAA;ANiaN;AM/ZM;EACE,gBAAA;ANiaR;AM7ZI;EACE,kBAAA;EACA,mBAAA;EACA,YAAA;AN+ZN;AM3ZE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,mBAAA;AN6ZJ;;AMrZA;EACE,WAAA;EACA,mBJlFQ;EImFR,uBAAA;EACA,kBAAA;EACA,YAAA;EACA,mBAAA;ANwZF;AMtZE;EACE,kBAAA;EACA,mBAAA;EACA,cJ5FW;AFoff;AMrZE;EACE,mBAAA;EACA,YAAA;EACA,kBAAA;ANuZJ;AMpZE;EACE,cJvGS;EIwGT,kBAAA;ANsZJ;AMnZE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;ANqZJ;AMlZE;EACE,YAAA;ANoZJ;;AMhZA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;ANmZF;AMjZE;EACE,kBAAA;ANmZJ;AM/YI;EACE,qBAAA;ANiZN;;AM5YA;;;;;;EAOE,kBAAA;AN8YF;;AM3YA;;EAEE,YAAA;AN8YF;;AM3YA;EACE,YAAA;EACA,aAAA;AN8YF;;AM1YE;EACE,cJ5JW;EI6JX,kBAAA;EACA,mBAAA;AN6YJ;AM1YE;EACE,kBAAA;EACA,mBJlKM;EImKN,YAAA;AN4YJ;AMzYE;EACE,cJzKS;EI0KT,eAAA;AN2YJ;AMzYI;EACE,kBAAA;AN2YN;;AMrYE;EACE,gBAAA;EACA,kBAAA;EACA,cJrLW;EIsLX,mBAAA;ANwYJ;AMrYE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;ANuYJ;AMpYE;EAKE,mBAAA;ANkYJ;AMtYI;EACE,kBAAA;ANwYN;;AMjYA;EACE,YAAA;ANoYF;;AMjYA;EACE,aAAA;ANoYF;AMlYE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;ANoYJ;AMjYE;EACE,kBAAA;ANmYJ;AM5XE;EACE,kBAAA;EACA,kBAAA;EACA,WAAA;AN8XJ;;AMzXE;EACE,wBAAA;AN4XJ;AMzXE;EACE,qBAAA;AN2XJ;AMxXE;EACE,yBAAA;AN0XJ;AMvXE;EACE,uBAAA;ANyXJ;;AMrXA;EACE,eAAA;EACA,WAAA;ANwXF;AMtXE;EACE,sBAAA;ANwXJ;;AMpXA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;ANuXF;AMrXE;EACE,eAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;ANuXJ;AMpXE;EACE,gBAAA;EACA,mBAAA;ANsXJ;;AMlXA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;ANqXF;AMnXE;EACE,mBAAA;EACA,eAAA;ANqXJ;AMlXE;EACE,eAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;ANoXJ;AMjXE;EACE,gBAAA;EACA,mBAAA;ANmXJ;;AOvpBE;EACE,YAAA;EACA,aAAA;EACA,aAAA;AP0pBJ;;AOtpBA;EACE,aAAA;EACA,kBAAA;APypBF;AOvpBE;EACE,cLbS;EKcT,uBAAA;EACA,kBAAA;EACA,YAAA;EACA,gBAAA;EACA,kBAAA;EACA,aAAA;EACA,mBAAA;APypBJ;;AOrpBA;EACE,YAAA;EACA,kBAAA;EACA,mBAAA;APwpBF;;AOrpBA;EACE,mBAAA;APwpBF;;AOrpBA;EACE,mBAAA;APwpBF;;AQtrBE;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;ARyrBJ;AQvrBI;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,8BAAA;ARyrBN;AQtrBM;EACE,mBAAA;ARwrBR;AQprBI;EACE,aAAA;EAEA,8BAAA;EACA,mBAAA;ARqrBN;AQlrBI;EACE,YAAA;ARorBN;AQjrBI;EACE,aAAA;EAEA,8BAAA;EACA,mBAAA;ARkrBN;AQ/qBI;EACE,kBAAA;EACA,aAAA;ARirBN;AQ/qBM;EACE,kBAAA;EACA,YAAA;ARirBR;AQ/qBQ;EACE,eAAA;ARirBV;;AQ1qBA;EACE,mBAAA;AR6qBF;;AQ1qBA;EACE,gBAAA;AR6qBF;;AQ1qBA;EACE,aAAA;EACA,uBAAA;EACA,kBAAA;EACA,kBAAA;AR6qBF;;AAzuBE;EACE,aAAA;EACA,mBAAA;EACA,gBAAA;EACA,WAAA;EACA,MAAA;EACA,WAAA;AA4uBJ;AAvuBE;EACE,aAAA;EACA,mBAAA;AAyuBJ;;AAruBA;EACE,eAAA;AAwuBF;;AAruBA;EACE,UAAA;AAwuBF;;AApuBE;EACE,YAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,eAAA;EACA,eAAA;EACA,2BAAA;EACA,8BAAA;EACA,iBAAA;AAuuBJ;AAruBI;EACE,6BAAA;AAuuBN;AAnuBE;EACE,kBAAA;AAquBJ;AA1tBI;EACE,eAAA;EACA,sBAAA;AA4tBN;AA1tBM;EACE,cEpEK;EFqEL,sBAAA;AA4tBR;AAvtBE;EACE,YAAA;EACA,WAAA;EACA,kBAAA;EACA,kBAAA;EACA,YAAA;EACA,iBAAA;EACA,YAAA;EACA,sBAAA;EACA,kBAAA;AAytBJ;AAvtBI;EACE,eAAA;EACA,aAAA;AAytBN;AAttBI;EACE,eAAA;EACA,mBE1FI;EF2FJ,cE5FS;AFozBf;AArtBI;EACE,YAAA;EACA,8BAAA;EACA,eAAA;EACA,mBAAA;EACA,cAAA;AAutBN;AAptBI;EACE,cEzGO;EF0GP,kCAAA;EAAA,0BAAA;EACA,kBAAA;AAstBN;AAjtBE;EACE,aAAA;EACA,eAAA;EACA,eAAA;AAmtBJ;AAhtBE;EACE,gBAAA;EACA,gBAAA;AAktBJ;AA/sBE;EACE,eAAA;EACA,eAAA;EACA,kBAAA;AAitBJ;AA9sBE;EACE,eAAA;EACA,eAAA;AAgtBJ;AA7sBE;EACE,eAAA;EACA,eAAA;AA+sBJ;AA5sBE;EACE,gBAAA;EACA,gBAAA;AA8sBJ;AA3sBE;EACE,gBAAA;EACA,gBAAA;AA6sBJ;AA1sBE;EACE,gBAAA;EACA,gBAAA;AA4sBJ;AAzsBE;EACE,eAAA;EACA,eAAA;AA2sBJ;AAxsBE;EAGE,wCAAA;AA0sBJ;AA7sBE;EACE,eAAA;EACA,eAAA;AA2sBJ;AAxsBI;EACE,YAAA;EACA,mCAAA;AA0sBN;AAtsBE;EACE,6BAAA;AA0sBJ;AA3sBE;EAEE,2BAAA;EACA,8BAAA;AAwsBJ;AAtsBI;EACE,YAAA;AAwsBN;AApsBE;EACE,eAAA;EACA,eAAA;AAssBJ;AAnsBE;EACE,gBAAA;EACA,gBAAA;AAqsBJ;AAjsBI;EACE,wCAAA;AAmsBN;AA/rBE;EACE,gBAAA;EACA,gBAAA;AAisBJ;AA1rBE;EACE,eAAA;EACA,eAAA;AA4rBJ;AAzrBE;EAEE,wBAAA;EACA,qBAAA;EACA,gBAAA;EACA,eAAA;AA0rBJ;AAvrBE;EACE,YAAA;EACA,gBAAA;EACA,eAAA;AAyrBJ;AArrBI;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;AAurBN;;AAlrBA;EACE,WAAA;EACA,YAAA;AAqrBF;;AAvoBE;EACE,gBAAA;EACA,eAAA;EACA,6BAAA;EACA,8BAAA;EACA,kBAAA;AA0oBJ;AAxoBI;EACE,kBAAA;AA0oBN;AAvoBI;EACE,YAAA;AAyoBN;;AApoBA;EACE;IACE,iBAAA;IACA,YAAA;EAuoBF;EApoBA;IACE,iBAAA;IACA,YAAA;EAsoBF;EAnoBA;IACE,iBAAA;IACA,YAAA;EAqoBF;AACF;AAjoBE;EACE,iBAAA;AAmoBJ;AAhoBE;EACE,gBAAA;EACA,gBAAA;AAkoBJ;AAhoBI;EACE,6BAAA;AAkoBN;AA/nBI;EACE,iBAAA;AAioBN;AA9nBI;EACE,YAAA;AAgoBN;;AA3nBA;EACE,YAAA;AA8nBF;AA5nBE;EACE,kCAAA;EAAA,0BAAA;AA8nBJ;AA1nBE;EACE,kBAAA;AA4nBJ;AAznBE;EACE,mBAAA;AA2nBJ;AAxnBE;EACE,mBAAA;AA0nBJ;AAvnBE;EACE,mBAAA;AAynBJ;;AArnBA;EACE,aAAA;EACA,mBAAA;AAwnBF;;AArnBA;EACE,WAAA;EACA,YAAA;EACA,eAAA;EACA,sBAAA;AAwnBF;AAtnBE;EACE,eAAA;EACA,sBAAA;EACA,YAAA;AAwnBJ","sourcesContent":["@import \"../main\";\n@import \"top_filters\";\n@import \"table_nav\";\n@import \"files_modal\";\n@import \"route_modal\";\n@import \"comments_modal\";\n@import \"planModal\";\n\n.main-table {\n  &__header {\n    display: flex;\n    align-items: center;\n    position: sticky;\n    z-index: 10;\n    top: 0;\n    width: 100%;\n    //border: 1px solid black;\n    //border-top: none;\n  }\n\n  &__item {\n    display: flex;\n    align-items: center;\n  }\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table {\n  &__cell {\n    height: 28px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    font-size: 16px;\n    cursor: default;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    background: white;\n\n    &:not(:last-child) {\n      border-right: 1px solid black;\n    }\n  }\n\n  &:last-child {\n    border-right: none;\n  }\n\n  &-form {\n\n    input {\n      //color: $button_color;\n    }\n  }\n\n  &__use {\n    label {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $hover_aqua;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__data {\n    height: 28px;\n    width: 100%;\n    text-align: center;\n    border-radius: 1px;\n    border: none;\n    background: white;\n    color: black;\n    outline: 3.3px $button_color;\n    position: relative;\n\n    &--ro {\n      cursor: default;\n      outline: none;\n    }\n\n    &--chosen {\n      font-size: 15px;\n      background: $gray_bg;\n      color: $button_color;\n    }\n\n    &--opened {\n      height: 56px;\n      border-bottom: 1px solid black;\n      font-size: 15px;\n      background: #f3efef;\n      color: #447e9b;\n    }\n\n    &--current {\n      color: $hover_aqua;\n      text-decoration: underline;\n      font-style: italic;\n      //font-size: 16px;\n    }\n  }\n\n  &__db {\n    display: flex;\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__timestamp {\n    min-width: 100px;\n    max-width: 100px;\n  }\n\n  &__files {\n    min-width: 32px;\n    max-width: 32px;\n    position: relative;\n  }\n\n  &__number {\n    min-width: 80px;\n    max-width: 80px;\n  }\n\n  &__sample {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &__client {\n    min-width: 160px;\n    max-width: 160px;\n  }\n\n  &__name {\n    min-width: 260px;\n    max-width: 260px;\n  }\n\n  &__material {\n    min-width: 140px;\n    max-width: 140px;\n  }\n\n  &__quantity {\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__issued {\n    min-width: 70px;\n    max-width: 70px;\n    border-right: 1px solid black !important;\n\n    &--done {\n      color: green;\n      animation: issued-ready infinite 4s;\n    }\n  }\n\n  &__complete {\n    border-right: none !important;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n\n    input {\n      height: 26px;\n    }\n  }\n\n  &__m {\n    min-width: 36px;\n    max-width: 36px;\n  }\n\n  &__endtime {\n    min-width: 130px;\n    max-width: 130px;\n  }\n\n  &__route {\n    &:last-child {\n      border-right: 1px solid black !important;\n    }\n  }\n\n  &__routes {\n    min-width: 400px;\n    max-width: 400px;\n  }\n\n  &-routes__issued {\n    //border-top: 1px solid black;\n  }\n\n  &__p {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &-p-select,\n  &-m-select {\n    -webkit-appearance: none;\n    -moz-appearance: none;\n    appearance: none;\n    cursor: pointer;\n  }\n\n  &__comment {\n    flex-grow: 1;\n    min-width: 200px;\n    max-width: 100%;\n  }\n\n  &-routes {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n    }\n  }\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body {\n  //&__trattr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 260%;\n  //    width: auto;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n  //\n  //&__attr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 100%;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n\n\n  &_cell {\n    max-height: 56px;\n    font-size: 16px;\n    border-right: 1px solid black;\n    border-bottom: 1px solid black;\n    position: relative;\n\n    &:last-child {\n      border-right: none;\n    }\n\n    &--opened {\n      height: 56px;\n    }\n  }\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n\n  50% {\n    background: green;\n    color: white;\n  }\n\n  100% {\n    background: white;\n    color: black;\n  }\n}\n\n.table__route {\n  &:first-child {\n    border-left: none;\n  }\n\n  &--issued {\n    border-top: none;\n    max-height: 28px;\n\n    &:last-child {\n      border-right: 1px solid black;\n    }\n\n    &:first-child {\n      border-left: none;\n    }\n\n    input {\n      height: 26px;\n    }\n  }\n}\n\n.route {\n  color: black;\n\n  &--planned {\n    text-decoration: underline;\n    //font-style: italic;\n  }\n\n  &--paused {\n    background: orange;\n  }\n\n  &--started {\n    background: #ffff4e;\n  }\n\n  &--error {\n    background: #de1313;\n  }\n\n  &--completed {\n    background: #09d009;\n  }\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color .3s;\n\n  &:hover {\n    cursor: pointer;\n    transition: color .3s;\n    color: white;\n  }\n}\n\n","@import \"var\";\n\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\n.container {\n  padding: 0 15px;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: $button_color;\n  margin-bottom: 15px;\n  //border-left: 1px solid black;\n  //border-right: 1px solid black;\n\n  &__button {\n    height: 28px;\n    text-align: center;\n    border: 1px solid black;\n    border-radius: 5px;\n    background: white;\n    color: $button_color;\n    transition: color .3s;\n    cursor: pointer;\n    padding: 5px;\n\n    &:hover {\n      color: $hover_aqua;\n      transition: color .3s;\n    }\n  }\n\n  &__input {\n    padding: 5px;\n    cursor: text;\n    border: 1px solid black;\n    border-radius: 5px;\n    color: $button_color;\n  }\n\n  &-table__data {\n    width: 100%;\n    height: 68vh;\n    overflow: scroll;\n    margin-bottom: 5px;\n    border-left: 1px solid black;\n    border-right: 1px solid black;\n\n    @media screen and (max-width: 1200px) {\n      height: 65vh;\n    }\n\n    @media screen and (min-width: 1500px) {\n      height: 73vh;\n    }\n\n    @media screen and (min-width: 1920px) {\n      height: 77vh;\n    }\n  }\n\n  &__select {\n    text-align: center !important;\n    width: 100%;\n  }\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active, /* активная/посещенная ссылка */\na:hover, /* при наведении */\na {\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\ninput:disabled {\n  cursor: default;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test {\n  &__form {\n    display: none;\n    visibility: hidden;\n  }\n\n  &__list {\n    background: none;\n  }\n\n  &__item {\n    background: transparent;\n  }\n\n  &__input {\n    background: transparent;\n    outline: none;\n    border: none;\n  }\n}\n\n.admin-form {\n  &__button {\n    width: 130px;\n    transition: color .3s;\n    position: absolute;\n    right: 24px;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n\n  &__user {\n    margin-right: 10px;\n  }\n\n  &__exit {\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n\n.search {\n  display: flex;\n  align-items: center;\n\n  @media screen and (max-width: 1200px) {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 1;\n  position: absolute;\n  min-width: 100%;\n  //bottom: -33px;\n  background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border: 1px solid #333;\n\n  &--long {\n    min-width: 300%;\n  }\n\n  &--errored {\n    padding: 0;\n    color: black;\n  }\n}","$hover_aqua: #13d9d9;\n$button_color: #447e9b;\n$gray_bg: #f3efef;",".nav-filters {\n  margin-top: 10px;\n  margin-bottom: 15px;\n  position: relative;\n\n  border: 1px solid black;\n  border-radius: 5px;\n  padding: 5px 25px;\n\n  display: flex;\n  flex-direction: column;\n\n  &__list {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    &:not(:last-child) {\n      padding-bottom: 5px;\n      margin-bottom: 5px;\n    }\n  }\n\n  &__item {\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__button {\n    &--chosen {\n      background: $gray_bg;\n      color: $hover_aqua;\n    }\n  }\n}\n\n.nav-filters {\n  &__plots {\n    margin-top: 15px;\n    border-bottom: 1px solid black;\n  }\n  &__filters {\n    margin-bottom: 0 !important;\n  }\n\n  &__reset {\n    width: 131px;\n    display: block;\n    align-self: center;\n  }\n}","@import \"../var\";\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: $gray_bg;\n  border: 1px solid black;\n  border-bottom: none;\n  border-radius: 5px 5px 0 0;\n  padding: 5px 30px;\n  //margin-bottom: 30px;\n\n  &__title {\n    height: 34px;\n    color: $button_color;\n    margin-right: 20px;\n    font-size: 27px;\n  }\n\n  &__nav {\n    display: flex;\n    align-items: center;\n    width: 400px;\n  }\n\n  &__button {\n    &:not(:last-child) {\n      margin-right: 20px;\n    }\n  }\n}\n\n.header-routes {\n  &__filter {\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__planned {\n    &-date {\n      width: 120px;\n    }\n  }\n}\n\n#search__target {\n  width: 120px !important;\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  //background: #f3efef;\n  color: #13d9d9;\n}",".modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n\n  &_content {\n    display: flex;\n    flex-direction: column;\n    width: 900px;\n    height: auto;\n    background: white;\n    border: 1px solid black;\n    border-radius: 5px;\n  }\n\n  &-header {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 5px;\n    background: $gray_bg;\n    color: $button_color;\n    height: 30px;\n    text-align: center;\n  }\n\n  &__trigger {\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n    justify-content: center;\n    width: 100%;\n    height: 100px;\n    //background: ;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    color: $button_color;\n  }\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n  //margin-right: 15px;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 5px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n\n  &__file {\n    position: relative;\n    width: 280px;\n    height: 280px;\n    margin-bottom: 60px;\n  }\n}\n\n.link__preview {\n  display: block;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 10px;\n}\n\n.file {\n  &__preview {\n    width: 280px;\n    height: 280px;\n    //object-fit: cover;\n  }\n\n  &__download {\n    cursor: pointer;\n    position: absolute;\n    width: 30px;\n    height: 40px;\n    bottom: 5px;\n    right: 10px;\n    color: $button_color !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: $hover_aqua !important;\n      transition: color .3s;\n    }\n  }\n\n  &__remove {\n    cursor: pointer;\n    top: 0px;\n    right: 5px;\n    position: absolute;\n    color: $button_color !important;\n    font-size: 26px;\n    transform: rotate(45deg);\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: red !important;\n      transition: color .3s;\n    }\n  }\n\n\n  &__original {\n    position: absolute;\n    top: 5px;\n    left: 5px;\n    color: $button_color !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: $hover_aqua !important;\n      transition: color .3s;\n    }\n  }\n\n  &__name {\n    color: $button_color;\n    text-align: center;\n  }\n\n  &__all {\n    align-self: center;\n    width: 170px;\n    margin-bottom: 15px;\n  }\n}",".modal_content--route {\n  width: 615px;\n  height: auto;\n}\n\n.route {\n  &__config {\n    padding: 0 10px;\n  }\n\n  &-block {\n    &__wrapper {\n      display: flex;\n      justify-content: space-between;\n      align-items: center;\n      margin-bottom: 10px;\n    }\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n  }\n\n  &__input {\n    &:not(:disabled), {\n      cursor: pointer;\n    }\n\n    &:not(:read-only) {\n\n    }\n  }\n\n  &-plan__date {\n    margin-right: 0 !important;\n  }\n\n  &__label {\n    text-align: center;\n  }\n\n  &__btn {\n    width: 170px;\n  }\n\n  &__select {\n    width: 170px;\n    margin-bottom: 10px;\n  }\n\n  &__input {\n    width: 170px;\n    margin-right: 30px;\n\n    &--small {\n      width: 48%;\n\n      &:not(:last-child) {\n        margin-right: 2%;\n      }\n    }\n\n    &--top {\n      text-align: center;\n      margin-bottom: 10px;\n      height: 28px;\n    }\n  }\n\n  &__section {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    margin-bottom: 15px;\n  }\n}\n\n.report-route__btn {\n  //margin-right: 30px;\n}\n\n.section-logs {\n  width: 100%;\n  background: $gray_bg;\n  border: 1px solid black;\n  border-radius: 5px;\n  padding: 5px;\n  margin-bottom: 30px;\n\n  &__title {\n    text-align: center;\n    margin-bottom: 10px;\n    color: $button_color;\n  }\n\n  &__list {\n    margin-bottom: 30px;\n    height: 85px;\n    overflow-y: scroll;\n  }\n\n  &__item {\n    color: $hover_aqua;\n    margin-bottom: 5px;\n  }\n\n  &__comment {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n\n  &__input {\n    width: 350px;\n  }\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n\n  &__cancel {\n    margin-right: 30px;\n  }\n\n  &__delete {\n    &:hover {\n      color: red !important;\n    }\n  }\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued,\n{\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment {\n  &__title {\n    color: $button_color;\n    text-align: center;\n    margin-bottom: 30px;\n  }\n\n  &__prev {\n    overflow-y: scroll;\n    background: $gray_bg;\n    height: 100%;\n  }\n\n  &__item {\n    color: $hover_aqua;\n    font-size: 17px;\n\n    &:not(:last-child) {\n      margin-bottom: 6px;\n    }\n  }\n}\n\n.confirm {\n  &__title {\n    margin-top: 10px;\n    text-align: center;\n    color: $button_color;\n    margin-bottom: 25px;\n  }\n\n  &__section {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  &__button {\n    &--ok {\n      margin-right: 25px;\n    }\n\n    margin-bottom: 10px;\n  }\n}\n\n.progress-block {\n  width: 170px;\n}\n\n.quantity-block {\n  display: flex;\n\n  &__labels {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  &__label {\n    margin-right: 35px;\n  }\n\n  &__shifts {\n    //margin-right: 33px;\n  }\n\n  &__inshifts {\n    margin-right: 22px;\n    position: relative;\n    right: 13px;\n  }\n}\n\n.route-type {\n  &__paused {\n    border: 2px solid orange;\n  }\n\n  &__error {\n    border: 2px solid red;\n  }\n\n  &__start {\n    border: 2px solid #ffff4e;\n  }\n\n  &__finish {\n    border: 2px solid green;\n  }\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray !important;\n  }\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  &__input {\n    margin-right: 0;\n    width: 90%;\n    height: 50px;\n    margin-bottom: 15px;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  &__date {\n    margin-bottom: 10px;\n    margin-right: 0;\n  }\n\n  &__input {\n    margin-right: 0;\n    width: 20%;\n    height: 28px;\n    margin-bottom: 15px;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}",".modal--comment {\n  .modal_content {\n    width: 650px;\n    height: 450px;\n    padding: 10px;\n  }\n}\n\n.comments-list {\n  height: 250px;\n  overflow-y: scroll;\n\n  &__item {\n    color: $hover_aqua;\n    border: 1px solid black;\n    border-radius: 5px;\n    padding: 6px;\n    min-height: 28px;\n    margin-bottom: 5px;\n    display: flex;\n    align-items: center;\n  }\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n  margin-bottom: 25px;\n}\n\n.comments__prev {\n  margin-bottom: 25px;\n}\n\n.comments__yours {\n  margin-bottom: 25px;\n}",".modal {\n  &-plan__date {\n\n  }\n\n  &-plan {\n    padding: 5px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    &__section {\n      width: 250px;\n      display: flex;\n      flex-direction: column;\n      justify-content: space-between;\n      //align-items: center;\n\n      &:not(:last-child) {\n        margin-bottom: 10px;\n      }\n    }\n\n    &__data {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n    }\n\n    &__input {\n      width: 120px;\n    }\n\n    &__check {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n    }\n\n    &__exclude {\n      text-align: center;\n      height: 100px;\n\n      &-option {\n        text-align: center;\n        padding: 2px;\n\n        &:hover {\n          cursor: pointer;\n        }\n      }\n    }\n  }\n}\n\n.confirm__title--plan {\n  margin-bottom: 15px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}"],"sourceRoot":""}]);
// Exports
