...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "alertFilter": () => (/* binding */ alertFilter),
...
/* harmony import */ var _drawe_routesDraw__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../drawe/routesDraw */ "./web/src/static/js/modules/drawe/routesDraw.js");
...
const alertFilter = color => {
  _state__WEBPACK_IMPORTED_MODULE_0__.state.orders.forEach(order => {
    ...
    if (hiddenOrder !== null) {
      ...
      hiddenOrder.classList.add('showed-order');
      if (order.db_routes && order.db_routes.length) {
        (0,_drawe_routesDraw__WEBPACK_IMPORTED_MODULE_4__.colorRoutes)(order.db_routes, hiddenOrder);
      } else {
        (0,_drawe_drawOrders__WEBPACK_IMPORTED_MODULE_5__.drawOrders)(_drawe_drawOrders__WEBPACK_IMPORTED_MODULE_5__.table, `afterbegin`, order, _state__WEBPACK_IMPORTED_MODULE_0__.state.orders, _state__WEBPACK_IMPORTED_MODULE_0__.state.managers);
      }
    }
  });
};
