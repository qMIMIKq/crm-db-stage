...
const copyOrderHandler = e => {
  ...
  (0,_drawe_drawManagers__WEBPACK_IMPORTED_MODULE_2__.drawManagers)('.table-m-select', _state__WEBPACK_IMPORTED_MODULE_1__.state.managers, 'adfasdfsdfsdada');
  (0,_drawe_drawDeadlineP__WEBPACK_IMPORTED_MODULE_3__.drawDeadlineP)('.table-p-select', _state__WEBPACK_IMPORTED_MODULE_1__.state.deadlinesP, 'adfasdfsdfsdada');
...
/* harmony import */ var _drawDeadlineP__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./drawDeadlineP */ "./web/src/static/js/modules/drawe/drawDeadlineP.js");
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../state */ "./web/src/static/js/modules/state.js");
/* harmony import */ var _drawManagers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./drawManagers */ "./web/src/static/js/modules/drawe/drawManagers.js");
...
/* harmony import */ var _helpersDraw__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./helpersDraw */ "./web/src/static/js/modules/drawe/helpersDraw.js");
...
const drawOrders = async (d, data, users) => {
  ...
  if (!_state__WEBPACK_IMPORTED_MODULE_4__.state.isArchive) {
    ...
    if (routes) {
      (0,_routesDraw__WEBPACK_IMPORTED_MODULE_8__.colorRoutes)(routes);
    } else {
      (0,_deleteOrdersHandler__WEBPACK_IMPORTED_MODULE_7__.deleteOrdersHandler)(currentOrder, d.issued, false, d.id);
    }
  }
  (0,_helpersDraw__WEBPACK_IMPORTED_MODULE_9__.drawHelpers)(currentOrder);
...
/* harmony export */ });
/* harmony import */ var _state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../state */ "./web/src/static/js/modules/state.js");
/* harmony import */ var _drawe_drawOrders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../drawe/drawOrders */ "./web/src/static/js/modules/drawe/drawOrders.js");
...
const globalFilterOrders = (order, topFilters) => {
  ...
  if (flag) {
    (0,_drawe_drawOrders__WEBPACK_IMPORTED_MODULE_1__.drawOrders)(order, _state__WEBPACK_IMPORTED_MODULE_0__.state.filteredOrders, _state__WEBPACK_IMPORTED_MODULE_0__.state.managers);
  }
  return flag;
};
...
const checkDoFilter = (check, order, filters) => {
  if (check) {
    if (_state__WEBPACK_IMPORTED_MODULE_0__.state.filtered && filters.length) {
      ...
      (0,_drawe_drawOrders__WEBPACK_IMPORTED_MODULE_3__.drawOrders)(order, _state__WEBPACK_IMPORTED_MODULE_0__.state.filteredOrders, _state__WEBPACK_IMPORTED_MODULE_0__.state.managers);
    }
  }
  return check;
};
      ...
      switch (fileType) {
        ...
        case 'PNG':
          if (!fileNames.includes(fileNameWithoutType)) {
            data.insertAdjacentHTML(`beforeend`, `
              <div class='data__file'>
                    <a target='_blank' class='link__preview' href='${_appAddr__WEBPACK_IMPORTED_MODULE_4__.appAddr}/${file}'>
...
/* harmony import */ var _appAddr__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../../../../appAddr */ "./appAddr.js");
...
const addReportMsg = (report, selector) => {
...
/* harmony import */ var _drawe_drawOrders__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./drawe/drawOrders */ "./web/src/static/js/modules/drawe/drawOrders.js");
    ...
    (0,_getData__WEBPACK_IMPORTED_MODULE_3__.getData)('users/get-users').then(res => {
      ...
      data.data.forEach(d => {
        ...
        if (_state__WEBPACK_IMPORTED_MODULE_1__.state.filtered && filters.length) {
          ...
          (0,_drawe_drawOrders__WEBPACK_IMPORTED_MODULE_5__.drawOrders)(d, data, _state__WEBPACK_IMPORTED_MODULE_1__.state.managers);
        }
      });
      if (!filters.length) {
        if (_state__WEBPACK_IMPORTED_MODULE_1__.state.routesFilters.started) {
...
addOrder.addEventListener('click', e => {
  ...
  (0,_drawe_drawManagers__WEBPACK_IMPORTED_MODULE_9__.drawManagers)('.table-m-select', _state__WEBPACK_IMPORTED_MODULE_8__.state.managers, 'adfasdfsdfsdada');
  (0,_drawe_drawDeadlineP__WEBPACK_IMPORTED_MODULE_10__.drawDeadlineP)('.table-p-select', _state__WEBPACK_IMPORTED_MODULE_8__.state.deadlinesP, 'adfasdfsdfsdada');
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput, select {\n  outline: none;\n}\n\nhtml {\n  height: 100%;\n}\n\nbody {\n  font-family: Inter;\n  background: rgb(236, 236, 236);\n  height: 95%;\n}\n\n.container {\n  padding: 0 15px;\n  height: 98%;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: rgb(66, 66, 66);\n  height: 80%;\n}\n@media screen and (min-width: 1522px) {\n  .main--reports {\n    margin: 0 auto 15px;\n    width: 1492px;\n  }\n}\n.main__button {\n  height: 28px;\n  text-align: center;\n  border: 1px solid black;\n  border-radius: 5px;\n  background: white;\n  color: rgb(66, 66, 66);\n  transition: color 0.3s;\n  cursor: pointer;\n  padding: 5px;\n}\n.main__button:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.main__button--select {\n  background: rgb(217, 221, 220) !important;\n}\n.main__button--select {\n  outline: none;\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  letter-spacing: 0em;\n  text-align: center;\n  color: rgb(137, 175, 137);\n  cursor: pointer;\n  padding: 3px 7px;\n  border: none;\n}\n.main__button--click {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  letter-spacing: 0em;\n  text-align: center;\n  border-radius: 15px;\n  border: 1px solid rgb(203, 203, 203);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  background: white;\n  color: rgb(66, 66, 66);\n  cursor: pointer;\n  padding: 3px 7px;\n}\n.main__input {\n  padding: 5px;\n  cursor: text;\n  border: 1px solid black;\n  border-radius: 5px;\n  color: rgb(66, 66, 66);\n}\n.main-table__data {\n  width: 100%;\n  height: 100%;\n  overflow: scroll;\n  margin-bottom: 5px;\n  border-left: 1px solid black;\n  border-right: 1px solid black;\n  border-bottom: 1px solid black;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  background: white;\n}\n.main__select {\n  text-align: center !important;\n}\n.main__select {\n  width: 100%;\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n}\n\n.warning {\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active,\na:hover,\na {\n  -webkit-text-decoration: none;\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n}\nselect:disabled:hover {\n  color: gray;\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\n\nbutton {\n  border: none;\n  background: none;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n}\nbutton:disabled:hover {\n  color: gray;\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\ninput:disabled:hover {\n  color: gray;\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test__form {\n  display: none;\n  visibility: hidden;\n}\n.test__list {\n  background: none;\n}\n.test__item {\n  background: transparent;\n}\n.test__input {\n  background: transparent;\n  outline: none;\n  border: none;\n}\n\n.admin-form__button {\n  width: 130px;\n  transition: color 0.3s;\n  position: absolute;\n  right: 24px;\n}\n.admin-form__button:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n.admin-form__user {\n  margin-right: 10px;\n}\n.admin-form__exit {\n  transition: color 0.3s;\n}\n.admin-form__exit:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n.search {\n  display: flex;\n  align-items: center;\n}\n@media screen and (max-width: 1200px) {\n  .search {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 1;\n  position: absolute;\n  min-width: 100%;\n  background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border: 1px solid #333;\n}\n.check-helper--long {\n  min-width: 300%;\n}\n.check-helper--errored {\n  padding: 0;\n  color: black;\n}\n\n.routes-block {\n  display: flex;\n  align-items: center;\n}\n\n.archive-block {\n  display: flex;\n  align-items: center;\n}\n\n.header-routes {\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  position: relative;\n}\n\n.nav-filters {\n  width: 77%;\n  position: relative;\n  height: 113px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 5px 25px;\n  display: flex;\n  flex-direction: column;\n}\n@media screen and (min-width: 1920px) {\n  .nav-filters {\n    width: 82%;\n  }\n}\n.nav-filters__list {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.nav-filters__item {\n  margin-bottom: 7px;\n}\n.nav-filters__item:not(:last-child) {\n  margin-right: 10px;\n}\n.nav-filters__button--chosen {\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n}\n\n.nav-filters__button {\n  width: auto;\n  max-width: 100%;\n  height: 27px;\n  white-space: nowrap;\n}\n.nav-filters__plots {\n  margin-top: 10px;\n  border-bottom: 1px solid black;\n  margin-bottom: 6px;\n  padding-bottom: 8px;\n}\n.nav-filters__filters {\n  margin-bottom: 0 !important;\n}\n.nav-filters__filters {\n  flex-wrap: wrap;\n  height: 50px;\n  margin-top: 7px;\n  overflow-y: auto;\n}\n.nav-filters__reset {\n  position: absolute;\n  bottom: -28px;\n  width: 131px;\n  display: block;\n  align-self: center;\n}\n\n.nav {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  margin-top: 10px;\n}\n\n.nav-control {\n  position: relative;\n  width: 313px;\n  height: 113px;\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 20px 20px 10px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.nav-control__group {\n  margin-bottom: 5px;\n  font-size: 14px;\n  font-weight: 500;\n  line-height: 17px;\n  letter-spacing: 0em;\n}\n.nav-control--opened {\n  z-index: 1000;\n  height: auto;\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n.nav-control__nav {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  border-bottom: 2px solid black;\n  margin-bottom: 5px;\n}\n.nav-control__left {\n  width: 200px;\n}\n.nav-control__admin {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-control__admin:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.nav-control__user {\n  display: flex;\n  margin-bottom: 7px;\n}\n.nav-control__name {\n  font-size: 16px;\n  font-weight: 700;\n  line-height: 21px;\n  letter-spacing: 0em;\n  color: rgb(76, 88, 102);\n  margin-right: 7px;\n}\n.nav-control__exit a {\n  color: rgb(210, 66, 66);\n  font-size: 16px;\n  font-weight: 400;\n  line-height: 21px;\n  letter-spacing: 0em;\n}\n.nav-control__total {\n  font-size: 18px;\n  font-weight: 500;\n  line-height: 23px;\n  letter-spacing: 0em;\n  text-align: center;\n  color: rgb(137, 175, 137);\n}\n.nav-control__routes {\n  padding-bottom: 5px;\n  margin-bottom: 5px;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  border-bottom: 2px solid black;\n}\n.nav-control__route-link {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  cursor: pointer;\n}\n.nav-control__route-link:hover {\n  color: rgb(137, 175, 137);\n}\n.nav-control__route-link--current {\n  -webkit-text-decoration: underline;\n  text-decoration: underline;\n  color: rgb(137, 175, 137);\n}\n.nav-control__burger {\n  position: relative;\n  top: -5px;\n  cursor: pointer;\n}\n.nav-control__burger-item {\n  display: block;\n  width: 40px;\n  height: 5px;\n  background: rgb(66, 66, 66);\n  border-radius: 15px;\n}\n.nav-control__burger-item:not(:last-child) {\n  margin-bottom: 6px;\n}\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: rgb(137, 175, 137);\n  border: 1px solid black;\n  border-bottom: none;\n  border-radius: 15px 15px 0 0;\n  padding: 5px 30px;\n  height: 49px;\n}\n.main-header__title {\n  position: relative;\n  top: -1px;\n  font-size: 27px;\n  font-weight: 700;\n  line-height: 29px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(255, 255, 255);\n  margin-right: 20px;\n}\n.main-header__nav {\n  display: flex;\n  align-items: center;\n}\n.main-header__button:not(:last-child) {\n  margin-right: 20px;\n}\n\n.header-routes__filter:not(:last-child) {\n  margin-right: 10px;\n}\n.header-routes__planned-date {\n  width: 140px;\n}\n\n#search__target {\n  width: 120px !important;\n}\n\n#search__target {\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  border: 1px solid rgb(255, 255, 255);\n  color: rgb(255, 255, 255);\n  background: rgb(137, 175, 137);\n}\n\n.modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n}\n.modal_content {\n  display: flex;\n  flex-direction: column;\n  width: 900px;\n  height: auto;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n  background: rgb(236, 236, 236);\n}\n.modal-header {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 5px;\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n  text-align: center;\n  height: 35px;\n  border-radius: 15px 15px 0px 0px;\n}\n.modal__trigger {\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  justify-content: center;\n  width: 100%;\n  height: 100px;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  color: rgb(137, 175, 137);\n  background: rgb(255, 255, 255);\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 5px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n}\n.data__file {\n  position: relative;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 60px;\n}\n\n.link__preview {\n  display: block;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 10px;\n}\n\n.file__preview {\n  width: 280px;\n  height: 280px;\n}\n.file__download {\n  color: rgb(137, 175, 137) !important;\n}\n.file__download {\n  cursor: pointer;\n  position: absolute;\n  width: 30px;\n  height: 40px;\n  bottom: 5px;\n  right: 10px;\n  transition: color 0.3s;\n}\n.file__download:hover {\n  color: green !important;\n}\n.file__download:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__remove {\n  color: rgb(137, 175, 137) !important;\n}\n.file__remove {\n  cursor: pointer;\n  top: 0px;\n  right: 5px;\n  position: absolute;\n  font-size: 26px;\n  transform: rotate(45deg);\n  transition: color 0.3s;\n}\n.file__remove:hover {\n  color: red !important;\n}\n.file__remove:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__original {\n  color: rgb(137, 175, 137) !important;\n}\n.file__original {\n  position: absolute;\n  top: 5px;\n  left: 5px;\n  transition: color 0.3s;\n}\n.file__original:hover {\n  color: green !important;\n}\n.file__original:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__name {\n  color: rgb(66, 66, 66);\n  text-align: center;\n}\n.file__all {\n  align-self: center;\n  width: 170px;\n  margin-bottom: 15px;\n}\n\n.modal_content--route {\n  width: 619px;\n  height: auto;\n}\n\n.route__config {\n  padding: 13px 10px 0;\n  background: rgb(236, 236, 236);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.route__title {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  margin-bottom: 10px;\n}\n.route-block__wrapper {\n  display: flex;\n  align-items: center;\n  margin-bottom: 10px;\n}\n.route__block {\n  display: flex;\n  flex-direction: column;\n}\n.route__input:not(:disabled) {\n  cursor: pointer;\n}\n.route-plan__date {\n  border: 1px solid rgb(173, 173, 173) !important;\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n  margin-right: 0 !important;\n}\n.route-plan__date {\n  color: rgb(66, 66, 66);\n}\n.route__label {\n  text-align: center;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 17px;\n  letter-spacing: 0em;\n  margin-bottom: 7px;\n}\n.route__btn {\n  align-items: center;\n  width: 97px;\n  border: 1px solid rgb(173, 173, 173);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n.route__select {\n  width: 130px;\n  margin-bottom: 10px;\n  border: none;\n  border-radius: 7px;\n  box-shadow: 2px 2px 5px 0px rgba(0, 0, 0, 0.25);\n  background: rgb(255, 255, 255);\n}\n.route__select:disabled {\n  background: rgb(255, 255, 255);\n}\n.route__input {\n  width: 136px;\n  height: 28px;\n  margin-right: -40px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  border-radius: 15px;\n  border: none;\n  outline: none;\n}\n.route__input:not(:disabled):focus {\n  outline: 2px solid rgb(137, 175, 137);\n}\n.route__input--small {\n  width: 80px !important;\n}\n.route__input--top {\n  width: 136px;\n  text-align: center;\n  margin-bottom: 10px;\n  height: 28px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  border-radius: 15px;\n  border: none;\n}\n.route__input--middle {\n  width: 155px;\n}\n.route__section {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n\n.section-logs {\n  width: 100%;\n  background: white;\n  border-radius: 5px;\n  padding: 5px;\n  margin-bottom: 8px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.section-logs__title {\n  text-align: center;\n  margin-bottom: 10px;\n  color: #447e9b;\n}\n.section-logs__list {\n  height: 85px;\n  overflow-y: scroll;\n}\n.section-logs__input {\n  padding-left: 10px;\n}\n.section-logs__item {\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 18px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(87, 87, 87);\n  margin-bottom: 5px;\n}\n.section-logs__item--system {\n  color: rgb(137, 175, 137);\n}\n.section-logs__item--error {\n  color: rgb(210, 66, 66);\n}\n.section-logs__item--pause {\n  color: rgb(224, 108, 0);\n}\n.section-logs__comment {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 30px;\n}\n.section-logs__input {\n  width: 350px;\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n.section-finish__cancel {\n  margin-right: 30px;\n}\n.section-finish__delete:hover {\n  color: red !important;\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued {\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment__prev {\n  overflow-y: scroll;\n  background: rgb(255, 255, 255);\n  height: 100%;\n  width: 100%;\n}\n.comment__item {\n  color: rgb(66, 66, 66);\n  font-size: 17px;\n  border-bottom: 1px solid black;\n}\n\n.confirm__title {\n  font-size: 20px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  margin-top: 10px;\n  text-align: center;\n  color: rgb(66, 66, 66);\n  margin-bottom: 25px;\n}\n.confirm__section {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.confirm__button {\n  margin-bottom: 10px;\n}\n.confirm__button--ok {\n  margin-right: 25px;\n}\n\n.progress-block {\n  width: 180px;\n}\n\n.quantity-block {\n  display: flex;\n  justify-content: space-between;\n}\n.quantity-block__labels {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.quantity-block__label {\n  margin-right: 47px;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 17px;\n  letter-spacing: 0em;\n  text-align: center;\n}\n.quantity-block__issued {\n  position: relative;\n  right: -5px;\n}\n.quantity-block__inshifts {\n  margin-right: 44px;\n  position: relative;\n  right: 10px;\n}\n\n.route-type__paused {\n  border: 2px solid rgb(224, 108, 0);\n}\n.route-type__error {\n  border: 2px solid rgb(210, 66, 66);\n}\n.route-type__start {\n  border: 2px solid rgb(24, 136, 217);\n}\n.route-type__finish {\n  border: 2px solid rgb(0, 130, 29);\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n}\n#route__delete:disabled:hover {\n  color: gray !important;\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgb(236, 236, 236);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.modal-error__input {\n  text-align: left !important;\n}\n.modal-error__input {\n  padding-left: 10px;\n  margin-top: 20px;\n  height: 28px;\n  margin-right: 0;\n  width: 90%;\n  margin-bottom: 15px;\n  background: rgb(255, 255, 255);\n}\n.modal-error__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-issued__date {\n  margin-bottom: 10px;\n  margin-right: 0;\n}\n.modal-issued__input {\n  margin-right: 0;\n  width: 20%;\n  height: 28px;\n  margin-bottom: 15px;\n}\n.modal-issued__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.user__block {\n  margin-right: 40px;\n}\n\n.endtime__block {\n  margin-right: 107px;\n}\n\n.start-route__btn {\n  color: rgb(24, 136, 217);\n}\n\n.end-route__btn {\n  color: rgb(0, 130, 29);\n}\n\n.pause-route__btn {\n  color: rgb(224, 108, 0);\n}\n\n.error-route__btn {\n  color: rgb(210, 66, 66);\n}\n\n.section-report {\n  justify-content: left;\n}\n\n.issued-modal_trigger {\n  margin-right: 75px;\n}\n\n.send__comment {\n  width: 130px;\n  border: 2px solid rgb(105, 135, 105);\n  color: rgb(105, 135, 105);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n\n.section-finish__sub {\n  border-radius: 15px;\n  width: 130px;\n  height: 40px;\n  border: none;\n  background: rgb(105, 135, 105);\n  color: rgb(255, 255, 255);\n}\n.section-finish__delete {\n  border: none;\n  background: none;\n  color: rgb(210, 66, 66);\n  cursor: pointer;\n}\n\n.issued-top {\n  display: flex;\n  align-items: center;\n}\n.issued-top__item {\n  padding: 5px 0;\n  width: 39%;\n}\n.issued-top__item:not(:last-child) {\n  border-right: 1px solid black;\n}\n.issued-top__item--date {\n  width: 120px;\n}\n.issued-top__item--summary {\n  width: 80px;\n}\n\n.modal_content--comments {\n  width: 612px;\n}\n\n.comments__title {\n  font-size: 20px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(255, 255, 255);\n  margin-left: 31px;\n}\n.comments-content {\n  padding: 24px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  background: rgb(236, 236, 236);\n  border-radius: 15px;\n}\n.comments__add {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.comments-list {\n  height: 90px;\n  padding: 7px 10px;\n  overflow-y: scroll;\n  border-radius: 15px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  background: rgb(255, 255, 255);\n}\n.comments-list__item {\n  color: rgb(70, 70, 70);\n  margin-bottom: 5px;\n  display: flex;\n  align-items: center;\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n}\n\n.comments__prev {\n  margin-bottom: 10px;\n}\n\n.comments__yours {\n  cursor: text !important;\n}\n\n.comments__yours {\n  width: 350px;\n  padding-left: 10px;\n}\n\n.modal-plan {\n  position: relative;\n}\n.modal-plan .confirm__section {\n  position: absolute;\n  bottom: 0;\n}\n\n.modal-plan {\n  padding: 5px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-plan__today {\n  text-align: center;\n  align-self: center;\n}\n.modal-plan__section {\n  width: 250px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.modal-plan__section:not(:last-child) {\n  margin-bottom: 10px;\n}\n.modal-plan__data {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__data--center {\n  justify-content: center;\n}\n.modal-plan__input {\n  width: 120px;\n}\n.modal-plan__check {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__exclude {\n  text-align: center;\n  height: 100px;\n}\n.modal-plan__exclude-option {\n  text-align: center;\n  padding: 2px;\n}\n.modal-plan__exclude-option:hover {\n  cursor: pointer;\n}\n\n.confirm__title--plan {\n  margin-bottom: 5px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.plan-period {\n  margin-bottom: 10px;\n}\n.plan-period__btn:not(:last-child) {\n  margin-right: 5px;\n}\n\n.plan-dates {\n  display: flex;\n  overflow-y: scroll;\n  max-height: 72%;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-left: -2px;\n}\n.plan-dates__item {\n  width: 105px;\n  padding: 5px;\n  background: rgb(255, 255, 255);\n  margin-bottom: 7px;\n  transition: color 0.3s;\n  text-align: center;\n}\n.plan-dates__item:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: #09d009;\n}\n.plan-dates__item:not(:last-child) {\n  margin-right: 7px;\n}\n.plan-dates__item--inplan {\n  color: white;\n  background: rgb(137, 175, 137);\n}\n.plan-dates__item--busy {\n  border: 1px solid rgb(137, 175, 137);\n}\n\n.admin-panel {\n  min-width: 1200px;\n  height: 600px;\n  background: rgb(255, 255, 255);\n}\n\n.panel-nav {\n  margin-top: 10px;\n  color: rgb(70, 70, 70);\n  padding: 5px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav-navigation {\n  padding: 10px;\n  width: 350px;\n  height: 200px;\n  background: rgb(236, 236, 236);\n  border-radius: 15px;\n}\n.nav-navigation__item {\n  height: 28px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-navigation__item:not(:last-child) {\n  margin-bottom: 10px;\n}\n.nav-navigation__item--title {\n  width: 100%;\n  background: rgb(137, 175, 137);\n  border-radius: 15px;\n  text-align: center;\n  color: rgb(255, 255, 255);\n}\n.nav-navigation__text {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-navigation__text:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n\n.nav-content {\n  width: 70%;\n  min-height: 500px;\n  max-height: 500px;\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n}\n.nav-content__columns {\n  height: 40px;\n  padding: 10px;\n  border-radius: 15px 15px 0 0;\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-content__items {\n  padding: 10px;\n  background: rgb(236, 236, 236);\n}\n.nav-content__item {\n  min-height: 40px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-content__column {\n  min-width: 20%;\n  text-align: center;\n}\n.nav-content__column--left {\n  text-align: left !important;\n}\n.nav-content__column-name {\n  min-width: 45%;\n  width: 45%;\n}\n.nav-content__column-shortname {\n  min-width: 15%;\n  width: 15%;\n}\n.nav-content__column-hide {\n  min-width: 10%;\n  width: 10%;\n}\n\n.nav-item {\n  width: 100%;\n}\n.nav-item__column {\n  text-align: center;\n  min-width: 20%;\n}\n.nav-item__column--left {\n  text-align: left;\n}\n.nav-item__column-name {\n  min-width: 45%;\n  width: 45%;\n}\n.nav-item__column-shortname {\n  min-width: 15%;\n  width: 15%;\n}\n.nav-item__column-hide {\n  min-width: 10%;\n  width: 10%;\n}\n.nav-item__column--edit {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-item__column--edit:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.nav-item__pos {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-item__pos:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n\n.edit-form {\n  align-self: center;\n  width: 726px;\n  display: flex;\n  justify-content: space-between;\n  background: rgb(236, 236, 236);\n  padding: 25px;\n  border-radius: 15px;\n  position: relative;\n}\n.edit-form--group {\n  width: 300px;\n  height: 320px;\n}\n.edit-form--group .edit-form__user {\n  border-right: none;\n  width: 100%;\n  height: 100%;\n}\n.edit-form__text {\n  padding: 10px;\n  width: 250px;\n  height: 100px;\n  resize: none;\n  cursor: pointer;\n}\n.edit-form__user {\n  width: 50%;\n  border-right: 1px solid rgb(70, 70, 70);\n}\n.edit-form__block {\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 15px;\n}\n.edit-form__block--checker {\n  flex-direction: row;\n}\n.edit-form__label {\n  font-size: 18px;\n  font-weight: 400;\n  line-height: 30px;\n  letter-spacing: 0em;\n}\n.edit-form__label--checker {\n  flex-direction: row;\n  margin-right: 168px;\n}\n.edit-form__input {\n  width: 250px !important;\n  height: 28px !important;\n  margin-bottom: 0 !important;\n}\n.edit-form__input {\n  padding: 5px 5px 5px 10px;\n  cursor: text;\n}\n.edit-form__group {\n  cursor: pointer !important;\n}\n.edit-form__group {\n  transition: color 0.3s;\n}\n.edit-form__group:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.edit-form__plot {\n  cursor: pointer !important;\n}\n.edit-form__plot {\n  transition: color 0.3s;\n}\n.edit-form__plot:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.edit-form__submit {\n  cursor: pointer;\n  margin-top: 20px;\n  align-self: flex-end;\n}\n.edit-form__succ {\n  position: absolute;\n  color: rgb(137, 175, 137);\n}\n.edit-form__succ--user {\n  bottom: 70px;\n  left: 25px;\n}\n.edit-form__succ--filter {\n  bottom: 80px;\n  left: 27px;\n}\n.edit-form__succ--group {\n  bottom: 80px;\n  left: 27px;\n}\n\n.main-table__header {\n  display: flex;\n  align-items: center;\n  position: sticky;\n  z-index: 10;\n  top: 0;\n  width: 100%;\n}\n.main-table__item {\n  display: flex;\n  align-items: center;\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table__cell {\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 18px;\n  letter-spacing: 0em;\n  text-align: left;\n  height: 28px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  cursor: default;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  background: white;\n  color: rgb(0, 0, 0);\n}\n.table__cell:not(:last-child) {\n  border-right: 1px solid black;\n}\n.table__cell--top {\n  background: rgb(156, 156, 156) !important;\n}\n.table:last-child {\n  border-right: none;\n}\n.table__use label {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.table__use label:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.table__data {\n  font-size: 14px;\n  font-weight: 400;\n  height: 28px;\n  width: 100%;\n  text-align: center;\n  border-radius: 1px;\n  border: none;\n  background: white;\n  color: black;\n  outline: 3.3px #447e9b;\n  position: relative;\n}\n.table__data--ro {\n  cursor: default;\n  outline: none;\n}\n.table__data--chosen {\n  background: rgb(217, 221, 217);\n  color: rgb(0, 0, 0);\n}\n.table__data--opened {\n  height: 56px;\n  font-size: 15px;\n  background: rgb(217, 221, 217);\n  color: rgb(0, 0, 0);\n  border-bottom: 1px solid black;\n}\n.table__data--opened.table__data--current {\n  border-bottom: 2px solid black;\n}\n.table__data--current {\n  font-weight: 600;\n  color: rgb(0, 0, 0);\n  border: 1px solid black;\n}\n.table__db {\n  display: flex;\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__timestamp {\n  min-width: 100px;\n  max-width: 100px;\n}\n.table__files {\n  min-width: 32px;\n  max-width: 32px;\n  position: relative;\n}\n.table__number {\n  min-width: 80px;\n  max-width: 80px;\n}\n.table__sample {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table__client {\n  min-width: 160px;\n  max-width: 160px;\n}\n.table__name {\n  min-width: 260px;\n  max-width: 260px;\n}\n.table__material {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__quantity {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued {\n  border-right: 1px solid black !important;\n}\n.table__issued {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued--done {\n  color: green;\n  font-size: 16px;\n  font-weight: 600;\n}\n.table__complete {\n  border-right: none !important;\n}\n.table__complete {\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n}\n.table__complete input {\n  height: 26px;\n}\n.table__m {\n  min-width: 36px;\n  max-width: 36px;\n}\n.table__endtime {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__endtime--dead {\n  color: red;\n  font-size: 15px;\n}\n.table__route {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 29px;\n  width: 50px;\n}\n.table__route:last-child {\n  border-right: 1px solid black !important;\n}\n.table__routes {\n  min-width: 500px;\n  max-width: 500px;\n}\n.table__p {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table-p-select, .table-m-select {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  cursor: pointer;\n}\n.table__comment {\n  flex-grow: 1;\n  min-width: 200px;\n  max-width: 100%;\n}\n.table__comment--top {\n  flex-grow: 1;\n  min-width: 200px;\n  max-width: 100%;\n}\n.table-routes__wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 28px;\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body_cell {\n  max-height: 56px;\n  font-size: 16px;\n  border-right: 1px solid black;\n  border-bottom: 1px solid black;\n  position: relative;\n}\n.table-body_cell:last-child {\n  border-right: none;\n}\n.table-body_cell--opened {\n  height: 56px;\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n  50% {\n    background: green;\n    color: white;\n  }\n  100% {\n    background: white;\n    color: black;\n  }\n}\n.table__route:first-child {\n  border-left: none;\n}\n.table__route--issued {\n  border-top: none;\n  max-height: 28px;\n}\n.table__route--issued:last-child {\n  border-right: 1px solid black;\n}\n.table__route--issued:first-child {\n  border-left: none;\n}\n.table__route--issued input {\n  height: 26px;\n}\n\n.route {\n  color: black;\n  height: 24px;\n  width: 48px;\n}\n.route--inplan {\n  border-left: 1px solid black !important;\n}\n.route--inplan {\n  border-top: 1px solid black;\n  border-bottom: 2px solid black;\n  border-right: 2px solid black;\n}\n.route--paused {\n  color: white !important;\n}\n.route--paused {\n  background: rgb(224, 108, 0);\n  border-radius: 15px;\n}\n.route--error {\n  color: white !important;\n}\n.route--error {\n  background: rgb(210, 66, 66);\n  border-radius: 15px;\n}\n.route--started {\n  background: white !important;\n}\n.route--started {\n  border: 2px solid rgb(81, 165, 227);\n  border-radius: 15px;\n}\n.route--completed {\n  background: white !important;\n}\n.route--completed {\n  border: 2px solid rgb(0, 130, 29);\n  border-radius: 15px;\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__copy {\n  background: rgb(156, 156, 156) !important;\n}\n\n.order__copy {\n  width: 10px;\n  border: none;\n  transition: color 0.3s;\n}\n.order__copy:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: white;\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color 0.3s;\n}\n.order__delete:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: white;\n}\n\n.table__issued--report {\n  min-width: 105px;\n  max-width: 105px;\n}\n.table__plan--report {\n  min-width: 105px;\n  max-width: 105px;\n}\n.table__route--report {\n  min-width: 65px;\n  max-width: 65px;\n}\n.table__operator--report {\n  min-width: 95px;\n  max-width: 95px;\n}\n.table__issued-plan--report {\n  min-width: 120px;\n  max-width: 120px;\n}", "",{"version":3,"sources":["webpack://./web/src/static/css/table/table.scss","webpack://./web/src/static/css/main.scss","webpack://./web/src/static/css/var.scss","webpack://./web/src/static/css/table/top_filters.scss","webpack://./web/src/static/css/table/table_nav.scss","webpack://./web/src/static/css/table/files_modal.scss","webpack://./web/src/static/css/table/route_modal.scss","webpack://./web/src/static/css/table/comments_modal.scss","webpack://./web/src/static/css/table/planModal.scss","webpack://./web/src/static/css/table/adminPanel.scss"],"names":[],"mappings":"AAAA,gBAAgB;ACEhB;EACE,UAAA;EACA,SAAA;EACA,sBAAA;ADAF;;ACGA;;EAEE,8CAAA;EACA,wBAAA;EACA,SAAA,EAAA,uEAAA;ADAF;;ACGA;EACE,aAAA;ADAF;;ACGA;EACE,YAAA;ADAF;;ACGA;EACE,kBAAA;EACA,8BAAA;EACA,WAAA;ADAF;;ACGA;EACE,eAAA;EACA,WAAA;ADAF;;ACGA;EACE,gBAAA;ADAF;;ACGA;EACE,wBAAA;EACA,6BAAA;ADAF;;ACGA;EACE,wBAAA;EACA,6BAAA;ADAF;;ACGA;EACE,sBCrCW;EDsCX,WAAA;ADAF;ACKI;EADF;IAEI,mBAAA;IACA,aAAA;EDFJ;AACF;ACKE;EACE,YAAA;EACA,kBAAA;EACA,uBAAA;EACA,kBAAA;EACA,iBAAA;EACA,sBCvDS;EDwDT,sBAAA;EACA,eAAA;EACA,YAAA;ADHJ;ACKI;EACE,yBCzEO;ED0EP,sBAAA;ADHN;ACMI;EAQE,yCAAA;ADDN;ACPI;EACE,aAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EAGA,yBCtFO;EDuFP,eAAA;EACA,gBAAA;EACA,YAAA;ADLN;ACQI;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EACA,mBAAA;EACA,oCChGO;EDiGP,+CClGO;EDmGP,iBAAA;EACA,sBC1FO;ED2FP,eAAA;EACA,gBAAA;ADNN;ACUE;EACE,YAAA;EACA,YAAA;EACA,uBAAA;EACA,kBAAA;EACA,sBCrGS;AF6Fb;ACWE;EACE,WAAA;EACA,YAAA;EACA,gBAAA;EACA,kBAAA;EACA,4BAAA;EACA,6BAAA;EACA,8BAAA;EACA,gDAAA;EACA,iBAAA;ADTJ;ACwBE;EACE,6BAAA;ADrBJ;ACoBE;EAEE,WAAA;ADtBJ;;AC0BA;EACE,uBAAA;ADvBF;;AC0BA;EACE,qBAAA;ADvBF;;AC0BA;EACE,yBAAA;ADtBF;;ACqBA;EAEE,kBAAA;ADvBF;;AC0BA;;EAEE,0BAAA;ADvBF;;AC0BA;;;EAGE,6BAAA;EAAA,qBAAA;EACA,WAAA;ADvBF;;AC0BA;EACE,eAAA;EACA,gBAAA;EACA,WAAA;ADvBF;ACyBE;EACE,WAAA;ADvBJ;;AC2BA;EACE,eAAA;EACA,WAAA;ADxBF;;AC2BA;EACE,YAAA;EACA,gBAAA;ADxBF;;AC2BA;EACE,eAAA;EACA,WAAA;ADxBF;AC0BE;EACE,WAAA;ADxBJ;;AC4BA;EACE,eAAA;EACA,WAAA;ADzBF;AC2BE;EACE,WAAA;ADzBJ;;AC6BA;EACE,mBAAA;EACA,YAAA;EACA,kBAAA;AD1BF;;AC8BE;EACE,aAAA;EACA,kBAAA;AD3BJ;AC8BE;EACE,gBAAA;AD5BJ;AC+BE;EACE,uBAAA;AD7BJ;ACgCE;EACE,uBAAA;EACA,aAAA;EACA,YAAA;AD9BJ;;ACmCE;EACE,YAAA;EACA,sBAAA;EACA,kBAAA;EACA,WAAA;ADhCJ;ACkCI;EACE,sBAAA;EACA,cCjOO;AFiMb;ACoCE;EACE,kBAAA;ADlCJ;ACqCE;EACE,sBAAA;ADnCJ;ACqCI;EACE,sBAAA;EACA,cC9OO;AF2Mb;;ACwCA;EACE,kBAAA;EACA,aAAA;ADrCF;;ACyCA;EACE,aAAA;EACA,mBAAA;ADtCF;ACwCE;EAJF;IAKI,aAAA;EDrCF;AACF;;ACwCA;EACE,kBAAA;ADrCF;;ACwCA;EACE,kBAAA;ADrCF;;ACwCA;EACE,kBAAA;EACA,UAAA;EACA,kBAAA;EACA,eAAA;EAEA,oCAAA,EAAA,6BAAA;EACA,8BAAA,EAAA,qBAAA;EACA,eAAA,EAAA,4BAAA;EACA,gBAAA,EAAA,SAAA;EACA,sBAAA;ADtCF;ACwCE;EACE,eAAA;ADtCJ;ACyCE;EACE,UAAA;EACA,YAAA;ADvCJ;;AC2CA;EACE,aAAA;EACA,mBAAA;ADxCF;;AC2CA;EACE,aAAA;EACA,mBAAA;ADxCF;;AC2CA;EACE,aAAA;EACA,mBAAA;ADxCF;;AC2CA;EACE,kBAAA;ADxCF;;AG5RA;EACE,UAAA;EACA,kBAAA;EACA,aAAA;EACA,iBAAA;EACA,gDAAA;EAEA,uBAAA;EACA,mBAAA;EACA,iBAAA;EAEA,aAAA;EACA,sBAAA;AH6RF;AG3RE;EAdF;IAeI,UAAA;EH8RF;AACF;AG5RE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AH8RJ;AGtRE;EACE,kBAAA;AHwRJ;AGtRI;EACE,kBAAA;AHwRN;AGnRI;EACE,8BDvCO;ECwCP,yBD3BO;AFgTb;;AGzQE;EACE,WAAA;EACA,eAAA;EACA,YAAA;EACA,mBAAA;AH4QJ;AGzQE;EACE,gBAAA;EACA,8BAAA;EACA,kBAAA;EACA,mBAAA;AH2QJ;AGvQE;EAIE,2BAAA;AH0QJ;AG9QE;EACE,eAAA;EACA,YAAA;EACA,eAAA;EAEA,gBAAA;AHyQJ;AGtQE;EACE,kBAAA;EACA,aAAA;EACA,YAAA;EACA,cAAA;EACA,kBAAA;AHwQJ;;AGpQA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;EACA,gBAAA;AHuQF;;AGpQA;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,uBAAA;EACA,iBAAA;EACA,gDAAA;AHuQF;AGrQE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AHuQJ;AGpQE;EACE,aAAA;EACA,YAAA;EACA,kBAAA;EACA,QAAA;EACA,MAAA;AHsQJ;AGnQE;EACE,aAAA;EAEA,mBAAA;EACA,8BAAA;EACA,8BAAA;EACA,kBAAA;AHoQJ;AGjQE;EACE,YAAA;AHmQJ;AGhQE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,eAAA;EACA,sBAAA;AHkQJ;AGhQI;EACE,sBAAA;EACA,yBD7IO;AF+Yb;AG9PE;EACE,aAAA;EACA,kBAAA;AHgQJ;AG7PE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,uBAAA;EACA,iBAAA;AH+PJ;AG3PI;EACE,uBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AH6PN;AGzPE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EACA,yBD/KS;AF0ab;AGxPE;EACE,mBAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,qBAAA;EACA,8BAAA;AH0PJ;AGrPI;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,eAAA;AHuPN;AGrPM;EACE,yBDrMK;AF4bb;AGpPM;EACE,kCAAA;EAAA,0BAAA;EACA,yBD1MK;AFgcb;AGjPE;EACE,kBAAA;EACA,SAAA;EACA,eAAA;AHmPJ;AGjPI;EACE,cAAA;EACA,WAAA;EACA,WAAA;EACA,2BD5MO;EC6MP,mBAAA;AHmPN;AGjPM;EACE,kBAAA;AHmPR;;AI7cA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,8BFNW;EEOX,uBAAA;EACA,mBAAA;EACA,4BAAA;EACA,iBAAA;EACA,YAAA;AJgdF;AI7cE;EACE,kBAAA;EACA,SAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,yBFTS;EEUT,kBAAA;AJ+cJ;AI5cE;EACE,aAAA;EACA,mBAAA;AJ8cJ;AIzcI;EACE,kBAAA;AJ2cN;;AIpcI;EACE,kBAAA;AJucN;AIlcI;EACE,YAAA;AJocN;;AI/bA;EACE,uBAAA;AJmcF;;AIpcA;EAEE,iBAAA;AJkcF;;AI/bA;EACE,YAAA;EACA,iBAAA;AJkcF;;AI/bA;EACE,oCAAA;EACA,yBFpDW;EEqDX,8BFlEW;AFogBb;;AKpgBA;EACE,aAAA;EACA,uBAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,SAAA;EACA,QAAA;EACA,YAAA;ALugBF;AKrgBE;EACE,aAAA;EACA,sBAAA;EACA,YAAA;EACA,YAAA;EACA,gDAAA;EACA,mBAAA;EACA,8BAAA;ALugBJ;AKpgBE;EACE,WAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,YAAA;EACA,8BH1BS;EG2BT,yBHdS;EGeT,kBAAA;EACA,YAAA;EACA,gCAAA;ALsgBJ;AKngBE;EACE,aAAA;EACA,mBAAA;EACA,eAAA;EACA,uBAAA;EACA,WAAA;EACA,aAAA;EAEA,2BAAA;EACA,8BAAA;EACA,yBH3CS;EG4CT,8BH/BS;AFmiBb;;AKhgBA;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;ALmgBF;;AKhgBA;EACE,gBAAA;ALmgBF;;AK/fA;EACE,aAAA;EACA,aAAA;EACA,YAAA;EACA,kBAAA;EACA,8BAAA;EACA,eAAA;EACA,mBAAA;ALkgBF;AKhgBE;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;ALkgBJ;;AK9fA;EACE,cAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;ALigBF;;AK7fE;EACE,YAAA;EACA,aAAA;ALggBJ;AK5fE;EAOE,oCAAA;AL+fJ;AKtgBE;EACE,eAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,WAAA;EAEA,sBAAA;AL8fJ;AK5fI;EAEE,uBAAA;AL+fN;AKjgBI;EACE,eAAA;EAEA,sBAAA;AL8fN;AK1fE;EAKE,oCAAA;AL+fJ;AKpgBE;EACE,eAAA;EACA,QAAA;EACA,UAAA;EACA,kBAAA;EAEA,eAAA;EACA,wBAAA;EACA,sBAAA;AL4fJ;AK1fI;EAEE,qBAAA;AL6fN;AK/fI;EACE,eAAA;EAEA,sBAAA;AL4fN;AKvfE;EAIE,oCAAA;AL0fJ;AK9fE;EACE,kBAAA;EACA,QAAA;EACA,SAAA;EAEA,sBAAA;ALyfJ;AKvfI;EAEE,uBAAA;AL0fN;AK5fI;EACE,eAAA;EAEA,sBAAA;ALyfN;AKrfE;EACE,sBHhIS;EGiIT,kBAAA;ALufJ;AKpfE;EACE,kBAAA;EACA,YAAA;EACA,mBAAA;ALsfJ;;AMzoBA;EACE,YAAA;EACA,YAAA;AN4oBF;;AMxoBE;EACE,oBAAA;EACA,8BAAA;EACA,gDAAA;AN2oBJ;AMxoBE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AN0oBJ;AMtoBI;EACE,aAAA;EACA,mBAAA;EACA,mBAAA;ANwoBN;AMpoBE;EACE,aAAA;EACA,sBAAA;ANsoBJ;AMloBI;EACE,eAAA;ANooBN;AM5nBE;EACE,+CAAA;EACA,0DAAA;EACA,0BAAA;AN+nBJ;AMloBE;EAIE,sBJlCS;AFgqBb;AM3nBE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;AN6nBJ;AM1nBE;EACE,mBAAA;EACA,WAAA;EACA,oCAAA;EACA,+CAAA;EACA,mBAAA;AN4nBJ;AMznBE;EACE,YAAA;EACA,mBAAA;EACA,YAAA;EACA,kBAAA;EACA,+CAAA;EACA,8BAAA;AN2nBJ;AMznBI;EACE,8BAAA;AN2nBN;AMvnBE;EACE,YAAA;EACA,YAAA;EACA,mBAAA;EACA,qDAAA;EACA,mBAAA;EACA,YAAA;EACA,aAAA;ANynBJ;AMtnBM;EACE,qCAAA;ANwnBR;AMpnBI;EACE,sBAAA;ANsnBN;AM/mBI;EACE,YAAA;EACA,kBAAA;EACA,mBAAA;EACA,YAAA;EACA,qDAAA;EACA,mBAAA;EACA,YAAA;ANinBN;AM9mBI;EACE,YAAA;ANgnBN;AM5mBE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AN8mBJ;;AMtmBA;EACE,WAAA;EACA,iBAAA;EACA,kBAAA;EACA,YAAA;EACA,kBAAA;EACA,gDAAA;ANymBF;AMvmBE;EACE,kBAAA;EACA,mBAAA;EACA,cJvHW;AFguBf;AMtmBE;EACE,YAAA;EACA,kBAAA;ANwmBJ;AMrmBE;EACE,kBAAA;ANumBJ;AMpmBE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,sBAAA;EACA,kBAAA;ANsmBJ;AMpmBI;EACE,yBJlKO;AFwwBb;AMnmBI;EACE,uBAAA;ANqmBN;AMlmBI;EACE,uBAAA;ANomBN;AMhmBE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;ANkmBJ;AM/lBE;EACE,YAAA;ANimBJ;;AM7lBA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;ANgmBF;AM9lBE;EACE,kBAAA;ANgmBJ;AM5lBI;EACE,qBAAA;AN8lBN;;AMzlBA;;;;;;EAOE,kBAAA;AN2lBF;;AMxlBA;;EAEE,YAAA;AN2lBF;;AMxlBA;EACE,YAAA;EACA,aAAA;AN2lBF;;AMvlBE;EAEE,kBAAA;EACA,8BJtNS;EIuNT,YAAA;EACA,WAAA;ANylBJ;AMrlBE;EACE,sBJ9NS;EI+NT,eAAA;EAGA,8BAAA;ANqlBJ;;AMhlBE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,kBAAA;EACA,sBJ9OS;EI+OT,mBAAA;ANmlBJ;AMhlBE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;ANklBJ;AM/kBE;EAKE,mBAAA;AN6kBJ;AMjlBI;EACE,kBAAA;ANmlBN;;AM5kBA;EACE,YAAA;AN+kBF;;AM5kBA;EACE,aAAA;EACA,8BAAA;AN+kBF;AM7kBE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AN+kBJ;AM5kBE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;AN8kBJ;AM3kBE;EACE,kBAAA;EACA,WAAA;AN6kBJ;AMtkBE;EACE,kBAAA;EACA,kBAAA;EACA,WAAA;ANwkBJ;;AMnkBE;EAEE,kCAAA;ANqkBJ;AMlkBE;EAEE,kCAAA;ANmkBJ;AMhkBE;EAEE,mCAAA;ANikBJ;AM9jBE;EAEE,iCAAA;AN+jBJ;;AM3jBA;EACE,eAAA;EACA,WAAA;AN8jBF;AM5jBE;EACE,sBAAA;AN8jBJ;;AM1jBA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,8BAAA;EACA,gDAAA;AN6jBF;AM3jBE;EAIE,2BAAA;ANikBJ;AMrkBE;EACE,kBAAA;EACA,gBAAA;EACA,YAAA;EAEA,eAAA;EACA,UAAA;EACA,mBAAA;EACA,8BJrVS;AFk5Bb;AM1jBE;EACE,gBAAA;EACA,mBAAA;AN4jBJ;;AMxjBA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;AN2jBF;AMzjBE;EACE,mBAAA;EACA,eAAA;AN2jBJ;AMvjBE;EACE,eAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;ANyjBJ;AMtjBE;EACE,gBAAA;EACA,mBAAA;ANwjBJ;;AMpjBA;EACE,kBAAA;ANujBF;;AMpjBA;EACE,mBAAA;ANujBF;;AMpjBA;EACE,wBAAA;ANujBF;;AMpjBA;EACE,sBAAA;ANujBF;;AMpjBA;EACE,uBAAA;ANujBF;;AMpjBA;EACE,uBAAA;ANujBF;;AMpjBA;EACE,qBAAA;ANujBF;;AMpjBA;EACE,kBAAA;ANujBF;;AMpjBA;EACE,YAAA;EACA,oCAAA;EACA,yBAAA;EACA,+CAAA;EACA,mBAAA;ANujBF;;AMnjBE;EACE,mBAAA;EACA,YAAA;EACA,YAAA;EACA,YAAA;EACA,8BAAA;EACA,yBJraS;AF29Bb;AMnjBE;EACE,YAAA;EACA,gBAAA;EACA,uBAAA;EACA,eAAA;ANqjBJ;;AMjjBA;EACE,aAAA;EACA,mBAAA;ANojBF;AMljBE;EACE,cAAA;EACA,UAAA;ANojBJ;AMljBI;EACE,6BAAA;ANojBN;AMjjBI;EACE,YAAA;ANmjBN;AMhjBI;EACE,WAAA;ANkjBN;;AOhgCA;EACE,YAAA;APmgCF;;AO9/BE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,yBLCS;EKAT,iBAAA;APigCJ;AO9/BE;EACE,aAAA;EACA,gDAAA;EACA,8BAAA;EACA,mBAAA;APggCJ;AO7/BE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;AP+/BJ;;AO3/BA;EACE,YAAA;EACA,iBAAA;EACA,kBAAA;EACA,mBAAA;EACA,qDAAA;EACA,8BLvBW;AFqhCb;AO5/BE;EACE,sBL5BQ;EK6BR,kBAAA;EACA,aAAA;EACA,mBAAA;AP8/BJ;;AO1/BA;EACE,YAAA;EACA,kBAAA;AP6/BF;;AO1/BA;EACE,mBAAA;AP6/BF;;AO1/BA;EAEE,uBAAA;AP8/BF;;AOhgCA;EACE,YAAA;EAEA,kBAAA;AP6/BF;;AQvjCA;EACE,kBAAA;AR0jCF;AQxjCE;EACE,kBAAA;EACA,SAAA;AR0jCJ;;AQjjCE;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;ARojCJ;AQljCI;EACE,kBAAA;EACA,kBAAA;ARojCN;AQjjCI;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,8BAAA;ARmjCN;AQhjCM;EACE,mBAAA;ARkjCR;AQ9iCI;EACE,aAAA;EAEA,8BAAA;EACA,mBAAA;AR+iCN;AQ7iCM;EACE,uBAAA;AR+iCR;AQ3iCI;EACE,YAAA;AR6iCN;AQ1iCI;EACE,aAAA;EAEA,8BAAA;EACA,mBAAA;AR2iCN;AQxiCI;EACE,kBAAA;EACA,aAAA;AR0iCN;AQxiCM;EACE,kBAAA;EACA,YAAA;AR0iCR;AQxiCQ;EACE,eAAA;AR0iCV;;AQniCA;EACE,kBAAA;ARsiCF;;AQniCA;EACE,gBAAA;ARsiCF;;AQniCA;EACE,aAAA;EACA,uBAAA;EACA,kBAAA;EACA,kBAAA;ARsiCF;;AQniCA;EAOE,mBAAA;ARgiCF;AQriCI;EACE,iBAAA;ARuiCN;;AQhiCA;EACE,aAAA;EACA,kBAAA;EACA,eAAA;EAEA,mBAAA;EACA,eAAA;EACA,iBAAA;ARkiCF;AQ/hCE;EACE,YAAA;EACA,YAAA;EACA,8BNpGS;EMqGT,kBAAA;EACA,sBAAA;EACA,kBAAA;ARiiCJ;AQ/hCI;EACE,eAAA;EACA,sBAAA;EACA,cAAA;ARiiCN;AQ9hCI;EACE,iBAAA;ARgiCN;AQ7hCI;EACE,YAAA;EACA,8BNlIO;AFiqCb;AQ5hCI;EACE,oCAAA;AR8hCN;;ASpqCA;EACE,iBAAA;EACA,aAAA;EACA,8BPUW;AF6pCb;;ASpqCA;EACE,gBAAA;EACA,sBPGU;EODV,YAAA;EACA,WAAA;EACA,aAAA;EACA,8BAAA;ATsqCF;;ASnqCA;EACE,aAAA;EACA,YAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;ATsqCF;ASpqCE;EACE,YAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;ATsqCJ;ASpqCI;EACE,mBAAA;ATsqCN;ASnqCI;EACE,WAAA;EACA,8BPnCO;EOoCP,mBAAA;EACA,kBAAA;EACA,yBPzBO;AF8rCb;ASjqCE;EACE,eAAA;EACA,sBAAA;ATmqCJ;ASjqCI;EACE,yBP/CO;EOgDP,sBAAA;ATmqCN;;AS9pCA;EACE,UAAA;EACA,iBAAA;EACA,iBAAA;EACA,aAAA;EACA,sBAAA;EAEA,gBAAA;ATgqCF;AS9pCE;EACE,YAAA;EACA,aAAA;EACA,4BAAA;EACA,8BPlES;EOmET,yBPtDS;EOuDT,aAAA;EACA,8BAAA;EACA,mBAAA;ATgqCJ;AS5pCE;EACE,aAAA;EACA,8BAAA;AT8pCJ;AS3pCE;EACE,gBAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;AT6pCJ;AS1pCE;EACE,cAAA;EACA,kBAAA;AT4pCJ;AS1pCI;EACE,2BAAA;AT4pCN;ASzpCI;EACE,cAAA;EACA,UAAA;AT2pCN;ASxpCI;EACE,cAAA;EACA,UAAA;AT0pCN;ASvpCI;EACE,cAAA;EACA,UAAA;ATypCN;;ASnpCA;EACE,WAAA;ATspCF;ASppCE;EACE,kBAAA;EACA,cAAA;ATspCJ;ASppCI;EACE,gBAAA;ATspCN;ASnpCI;EACE,cAAA;EACA,UAAA;ATqpCN;ASlpCI;EACE,cAAA;EACA,UAAA;ATopCN;ASjpCI;EACE,cAAA;EACA,UAAA;ATmpCN;AShpCI;EACE,eAAA;EACA,sBAAA;ATkpCN;AShpCM;EACE,yBP/IK;EOgJL,sBAAA;ATkpCR;AS7oCE;EACE,eAAA;EACA,sBAAA;AT+oCJ;AS7oCI;EACE,sBAAA;EACA,yBP3JO;AF0yCb;;AS1oCA;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EACA,8BAAA;EACA,8BAAA;EACA,aAAA;EACA,mBAAA;EACA,kBAAA;AT6oCF;AS3oCE;EACE,YAAA;EACA,aAAA;AT6oCJ;AS3oCI;EACE,kBAAA;EACA,WAAA;EACA,YAAA;AT6oCN;ASzoCE;EACE,aAAA;EACA,YAAA;EACA,aAAA;EACA,YAAA;EACA,eAAA;AT2oCJ;ASxoCE;EAEE,UAAA;EAEA,uCAAA;ATwoCJ;ASroCE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;ATuoCJ;ASroCI;EACE,mBAAA;ATuoCN;ASnoCE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;ATqoCJ;ASnoCI;EACE,mBAAA;EACA,mBAAA;ATqoCN;ASjoCE;EAEE,uBAAA;EACA,uBAAA;EAEA,2BAAA;ATmoCJ;ASxoCE;EACE,yBAAA;EAGA,YAAA;ATooCJ;AShoCE;EACE,0BAAA;ATmoCJ;ASpoCE;EAEE,sBAAA;ATkoCJ;AShoCI;EACE,sBAAA;EACA,yBPxOO;AF02Cb;AS9nCE;EACE,0BAAA;ATioCJ;ASloCE;EAEE,sBAAA;ATgoCJ;AS9nCI;EACE,sBAAA;EACA,yBPlPO;AFk3Cb;AS5nCE;EACE,eAAA;EACA,gBAAA;EACA,oBAAA;AT8nCJ;AS3nCE;EACE,kBAAA;EACA,yBP9PS;AF23Cb;AS3nCI;EACE,YAAA;EACA,UAAA;AT6nCN;AS1nCI;EACE,YAAA;EACA,UAAA;AT4nCN;ASznCI;EACE,YAAA;EACA,UAAA;AT2nCN;;AA73CE;EACE,aAAA;EACA,mBAAA;EACA,gBAAA;EACA,WAAA;EACA,MAAA;EACA,WAAA;AAg4CJ;AA33CE;EACE,aAAA;EACA,mBAAA;AA63CJ;;AAz3CA;EACE,eAAA;AA43CF;;AAz3CA;EACE,UAAA;AA43CF;;AAx3CE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,eAAA;EACA,2BAAA;EACA,8BAAA;EACA,iBAAA;EACA,mBEnCS;AF85Cb;AAz3CI;EACE,6BAAA;AA23CN;AAx3CI;EACE,yCAAA;AA03CN;AAp3CE;EACE,kBAAA;AAs3CJ;AA32CI;EACE,eAAA;EACA,sBAAA;AA62CN;AA32CM;EACE,yBEhFK;EFiFL,sBAAA;AA62CR;AAx2CE;EACE,eAAA;EACA,gBAAA;EACA,YAAA;EACA,WAAA;EACA,kBAAA;EACA,kBAAA;EACA,YAAA;EACA,iBAAA;EACA,YAAA;EACA,sBAAA;EACA,kBAAA;AA02CJ;AAx2CI;EACE,eAAA;EACA,aAAA;AA02CN;AAv2CI;EAEE,8BEzFU;EF0FV,mBE5FO;AFo8Cb;AAr2CI;EACE,YAAA;EACA,eAAA;EACA,8BEhGU;EFiGV,mBEnGO;EFoGP,8BAAA;AAu2CN;AAp2CI;EACE,8BAAA;AAs2CN;AAn2CI;EACE,gBAAA;EACA,mBE7GO;EF8GP,uBAAA;AAq2CN;AAh2CE;EACE,aAAA;EACA,eAAA;EACA,eAAA;AAk2CJ;AA/1CE;EACE,gBAAA;EACA,gBAAA;AAi2CJ;AA91CE;EACE,eAAA;EACA,eAAA;EACA,kBAAA;AAg2CJ;AA71CE;EACE,eAAA;EACA,eAAA;AA+1CJ;AA51CE;EACE,eAAA;EACA,eAAA;AA81CJ;AA31CE;EACE,gBAAA;EACA,gBAAA;AA61CJ;AA11CE;EACE,gBAAA;EACA,gBAAA;AA41CJ;AAz1CE;EACE,gBAAA;EACA,gBAAA;AA21CJ;AAx1CE;EACE,eAAA;EACA,eAAA;AA01CJ;AAv1CE;EAGE,wCAAA;AAy1CJ;AA51CE;EACE,eAAA;EACA,eAAA;AA01CJ;AAv1CI;EACE,YAAA;EACA,eAAA;EACA,gBAAA;AAy1CN;AAp1CE;EACE,6BAAA;AAw1CJ;AAz1CE;EAEE,2BAAA;EACA,8BAAA;AAs1CJ;AAp1CI;EACE,YAAA;AAs1CN;AAl1CE;EACE,eAAA;EACA,eAAA;AAo1CJ;AAj1CE;EACE,gBAAA;EACA,gBAAA;AAm1CJ;AAj1CI;EACE,UAAA;EACA,eAAA;AAm1CN;AA/0CE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,YAAA;EACA,WAAA;AAi1CJ;AA/0CI;EACE,wCAAA;AAi1CN;AA70CE;EACE,gBAAA;EACA,gBAAA;AA+0CJ;AAx0CE;EACE,eAAA;EACA,eAAA;AA00CJ;AAv0CE;EAEE,wBAAA;EACA,qBAAA;EACA,gBAAA;EACA,eAAA;AAw0CJ;AAr0CE;EACE,YAAA;EACA,gBAAA;EACA,eAAA;AAu0CJ;AAr0CI;EACE,YAAA;EACA,gBAAA;EACA,eAAA;AAu0CN;AAl0CI;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,YAAA;AAo0CN;;AA/zCA;EACE,WAAA;EACA,YAAA;AAk0CF;;AApxCE;EACE,gBAAA;EACA,eAAA;EACA,6BAAA;EACA,8BAAA;EACA,kBAAA;AAuxCJ;AArxCI;EACE,kBAAA;AAuxCN;AApxCI;EACE,YAAA;AAsxCN;;AAjxCA;EACE;IACE,iBAAA;IACA,YAAA;EAoxCF;EAjxCA;IACE,iBAAA;IACA,YAAA;EAmxCF;EAhxCA;IACE,iBAAA;IACA,YAAA;EAkxCF;AACF;AA9wCE;EACE,iBAAA;AAgxCJ;AA7wCE;EACE,gBAAA;EACA,gBAAA;AA+wCJ;AA7wCI;EACE,6BAAA;AA+wCN;AA5wCI;EACE,iBAAA;AA8wCN;AA3wCI;EACE,YAAA;AA6wCN;;AAxwCA;EACE,YAAA;EACA,YAAA;EACA,WAAA;AA2wCF;AAzwCE;EAIE,uCAAA;AA2wCJ;AA/wCE;EACE,2BAAA;EACA,8BAAA;EACA,6BAAA;AA4wCJ;AAnwCE;EAEE,uBAAA;AAswCJ;AAxwCE;EACE,4BAAA;EAEA,mBAAA;AAqwCJ;AAlwCE;EACE,uBAAA;AAswCJ;AAvwCE;EAEE,4BAAA;EACA,mBAAA;AAowCJ;AAjwCE;EACE,4BAAA;AAqwCJ;AAtwCE;EAEE,mCAAA;EACA,mBAAA;AAmwCJ;AAhwCE;EACE,4BAAA;AAowCJ;AArwCE;EAEE,iCAAA;EACA,mBAAA;AAkwCJ;;AA9vCA;EACE,aAAA;EACA,mBAAA;AAiwCF;;AA9vCA;EAGE,yCAAA;AAkwCF;;AArwCA;EACE,WAAA;EACA,YAAA;EAEA,sBAAA;AAiwCF;AA/vCE;EACE,eAAA;EACA,sBAAA;EACA,YAAA;AAiwCJ;;AA7vCA;EACE,WAAA;EACA,YAAA;EACA,eAAA;EACA,sBAAA;AAgwCF;AA9vCE;EACE,eAAA;EACA,sBAAA;EACA,YAAA;AAgwCJ;;AA3vCE;EACE,gBAAA;EACA,gBAAA;AA8vCJ;AA3vCE;EACE,gBAAA;EACA,gBAAA;AA6vCJ;AA1vCE;EACE,eAAA;EACA,eAAA;AA4vCJ;AAzvCE;EACE,eAAA;EACA,eAAA;AA2vCJ;AAxvCE;EACE,gBAAA;EACA,gBAAA;AA0vCJ","sourcesContent":["@import \"../main\";\n@import \"top_filters\";\n@import \"table_nav\";\n@import \"files_modal\";\n@import \"route_modal\";\n@import \"comments_modal\";\n@import \"planModal\";\n@import \"adminPanel\";\n\n.main-table {\n  &__header {\n    display: flex;\n    align-items: center;\n    position: sticky;\n    z-index: 10;\n    top: 0;\n    width: 100%;\n    //border: 1px solid black;\n    //border-top: none;\n  }\n\n  &__item {\n    display: flex;\n    align-items: center;\n  }\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table {\n  &__cell {\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 18px;\n    letter-spacing: 0em;\n    text-align: left;\n    height: 28px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    cursor: default;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    background: white;\n    color: $table_text;\n\n    &:not(:last-child) {\n      border-right: 1px solid black;\n    }\n\n    &--top {\n      background: rgba(156, 156, 156, 1) !important;\n      //color: white;\n      //background: $table_bg !important;\n    }\n  }\n\n  &:last-child {\n    border-right: none;\n  }\n\n  &-form {\n\n    input {\n      //color: $button_color;\n    }\n  }\n\n  &__use {\n    label {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $main_green;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__data {\n    font-size: 14px;\n    font-weight: 400;\n    height: 28px;\n    width: 100%;\n    text-align: center;\n    border-radius: 1px;\n    border: none;\n    background: white;\n    color: black;\n    outline: 3.3px $button_color;\n    position: relative;\n\n    &--ro {\n      cursor: default;\n      outline: none;\n    }\n\n    &--chosen {\n      //font-size: 15px;\n      background: $table_bg_main;\n      color: $table_text;\n    }\n\n    &--opened {\n      height: 56px;\n      font-size: 15px;\n      background: $table_bg_main;\n      color: $table_text;\n      border-bottom: 1px solid black;\n    }\n\n    &--opened.table__data--current {\n      border-bottom: 2px solid black;\n    }\n\n    &--current {\n      font-weight: 600;\n      color: $table_text;\n      border: 1px solid black;\n      //font-size: 16px;\n    }\n  }\n\n  &__db {\n    display: flex;\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__timestamp {\n    min-width: 100px;\n    max-width: 100px;\n  }\n\n  &__files {\n    min-width: 32px;\n    max-width: 32px;\n    position: relative;\n  }\n\n  &__number {\n    min-width: 80px;\n    max-width: 80px;\n  }\n\n  &__sample {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &__client {\n    min-width: 160px;\n    max-width: 160px;\n  }\n\n  &__name {\n    min-width: 260px;\n    max-width: 260px;\n  }\n\n  &__material {\n    min-width: 140px;\n    max-width: 140px;\n  }\n\n  &__quantity {\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__issued {\n    min-width: 70px;\n    max-width: 70px;\n    border-right: 1px solid black !important;\n\n    &--done {\n      color: green;\n      font-size: 16px;\n      font-weight: 600;\n      //animation: issued-ready infinite 4s;\n    }\n  }\n\n  &__complete {\n    border-right: none !important;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n\n    input {\n      height: 26px;\n    }\n  }\n\n  &__m {\n    min-width: 36px;\n    max-width: 36px;\n  }\n\n  &__endtime {\n    min-width: 140px;\n    max-width: 140px;\n\n    &--dead {\n      color: red;\n      font-size: 15px;\n    }\n  }\n\n  &__route {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: 29px;\n    width: 50px;\n\n    &:last-child {\n      border-right: 1px solid black !important;\n    }\n  }\n\n  &__routes {\n    min-width: 500px;\n    max-width: 500px;\n  }\n\n  &-routes__issued {\n    //border-top: 1px solid black;\n  }\n\n  &__p {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &-p-select,\n  &-m-select {\n    -webkit-appearance: none;\n    -moz-appearance: none;\n    appearance: none;\n    cursor: pointer;\n  }\n\n  &__comment {\n    flex-grow: 1;\n    min-width: 200px;\n    max-width: 100%;\n\n    &--top {\n      flex-grow: 1;\n      min-width: 200px;\n      max-width: 100%;\n    }\n  }\n\n  &-routes {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      height: 28px;\n    }\n  }\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body {\n  //&__trattr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 260%;\n  //    width: auto;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n  //\n  //&__attr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 100%;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n\n\n  &_cell {\n    max-height: 56px;\n    font-size: 16px;\n    border-right: 1px solid black;\n    border-bottom: 1px solid black;\n    position: relative;\n\n    &:last-child {\n      border-right: none;\n    }\n\n    &--opened {\n      height: 56px;\n    }\n  }\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n\n  50% {\n    background: green;\n    color: white;\n  }\n\n  100% {\n    background: white;\n    color: black;\n  }\n}\n\n.table__route {\n  &:first-child {\n    border-left: none;\n  }\n\n  &--issued {\n    border-top: none;\n    max-height: 28px;\n\n    &:last-child {\n      border-right: 1px solid black;\n    }\n\n    &:first-child {\n      border-left: none;\n    }\n\n    input {\n      height: 26px;\n    }\n  }\n}\n\n.route {\n  color: black;\n  height: 24px;\n  width: 48px;\n\n  &--inplan {\n    border-top: 1px solid black;\n    border-bottom: 2px solid black;\n    border-right: 2px solid black;\n    border-left: 1px solid black !important;\n  }\n\n  &--planned {\n    //text-decoration: underline;\n    //font-style: italic;\n  }\n\n  &--paused {\n    background: rgba(224, 108, 0, 1);\n    color: white !important;\n    border-radius: 15px;\n  }\n\n  &--error {\n    color: white !important;\n    background: rgba(210, 66, 66, 1);\n    border-radius: 15px;\n  }\n\n  &--started {\n    background: white !important;\n    border: 2px solid rgba(81, 165, 227, 1);\n    border-radius: 15px;\n  }\n\n  &--completed {\n    background: white !important;\n    border: 2px solid rgba(0, 130, 29, 1);\n    border-radius: 15px;\n  }\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__copy {\n  width: 10px;\n  border: none;\n  background: rgb(156, 156, 156) !important;\n  transition: color .3s;\n\n  &:hover {\n    cursor: pointer;\n    transition: color .3s;\n    color: white;\n  }\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color .3s;\n\n  &:hover {\n    cursor: pointer;\n    transition: color .3s;\n    color: white;\n  }\n}\n\n.table {\n  &__issued--report {\n    min-width: 105px;\n    max-width: 105px;\n  }\n\n  &__plan--report {\n    min-width: 105px;\n    max-width: 105px;\n  }\n\n  &__route--report {\n    min-width: 65px;\n    max-width: 65px;\n  }\n\n  &__operator--report {\n    min-width: 95px;\n    max-width: 95px;\n  }\n\n  &__issued-plan--report {\n    min-width: 120px;\n    max-width: 120px;\n  }\n}","@import \"var\";\n\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput, select {\n  outline: none;\n}\n\nhtml {\n  height: 100%;\n}\n\nbody {\n  font-family: Inter;\n  background: rgba(236, 236, 236, 1);\n  height: 95%;\n}\n\n.container {\n  padding: 0 15px;\n  height: 98%;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: $text_black;\n  height: 80%;\n  //border-left: 1px solid black;\n  //border-right: 1px solid black;\n\n  &--reports {\n    @media screen and (min-width: 1522px) {\n      margin: 0 auto 15px;\n      width: 1492px;\n    }\n  }\n\n  &__button {\n    height: 28px;\n    text-align: center;\n    border: 1px solid black;\n    border-radius: 5px;\n    background: white;\n    color: $text_black;\n    transition: color .3s;\n    cursor: pointer;\n    padding: 5px;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s;\n    }\n\n    &--select {\n      outline: none;\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 19px;\n      letter-spacing: 0em;\n      text-align: center;\n      //border-radius: 15px;\n      background: $table_bg !important;\n      color: $main_green;\n      cursor: pointer;\n      padding: 3px 7px;\n      border: none;\n    }\n\n    &--click {\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 19px;\n      letter-spacing: 0em;\n      text-align: center;\n      border-radius: 15px;\n      border: $btn_border;\n      box-shadow: $btn_shadow;\n      background: white;\n      color: $text_black;\n      cursor: pointer;\n      padding: 3px 7px;\n    }\n  }\n\n  &__input {\n    padding: 5px;\n    cursor: text;\n    border: 1px solid black;\n    border-radius: 5px;\n    color: $text_black;\n  }\n\n  &-table__data {\n    width: 100%;\n    height: 100%;\n    overflow: scroll;\n    margin-bottom: 5px;\n    border-left: 1px solid black;\n    border-right: 1px solid black;\n    border-bottom: 1px solid black;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    background: white;\n\n    //@media screen and (max-width: 1200px) {\n    //  height: 75vh;\n    //}\n    //\n    //@media screen and (min-width: 1500px) {\n    //  height: 86vh;\n    //}\n    //\n    //@media screen and (min-width: 1920px) {\n    //  height: 86vh;\n    //}\n  }\n\n  &__select {\n    text-align: center !important;\n    width: 100%;\n  }\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active, /* активная/посещенная ссылка */\na:hover, /* при наведении */\na {\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\n\nbutton {\n  border: none;\n  background: none;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test {\n  &__form {\n    display: none;\n    visibility: hidden;\n  }\n\n  &__list {\n    background: none;\n  }\n\n  &__item {\n    background: transparent;\n  }\n\n  &__input {\n    background: transparent;\n    outline: none;\n    border: none;\n  }\n}\n\n.admin-form {\n  &__button {\n    width: 130px;\n    transition: color .3s;\n    position: absolute;\n    right: 24px;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n\n  &__user {\n    margin-right: 10px;\n  }\n\n  &__exit {\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n\n.search {\n  display: flex;\n  align-items: center;\n\n  @media screen and (max-width: 1200px) {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 1;\n  position: absolute;\n  min-width: 100%;\n  //bottom: -33px;\n  background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border: 1px solid #333;\n\n  &--long {\n    min-width: 300%;\n  }\n\n  &--errored {\n    padding: 0;\n    color: black;\n  }\n}\n\n.routes-block {\n  display: flex;\n  align-items: center;\n}\n\n.archive-block {\n  display: flex;\n  align-items: center;\n}\n\n.header-routes {\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  position: relative;\n}","$main_green: rgba(137, 175, 137, 1);\n\n$btn_shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n$btn_border: 1px solid rgba(203, 203, 203, 1);\n\n$input_shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.27) inset;\n\n$filter_green: linear-gradient(0deg, #698769, #698769);\n$filter_border: 1px solid rgba(130, 130, 130, 1);\n$current_filter_border: 2px solid rgba(217, 221, 220, 1);\n\n$text_gray: rgba(70, 70, 70, 1);\n$text_black: rgba(66, 66, 66, 1);\n$text_white: rgba(255, 255, 255, 1);\n\n$table_text: rgba(0, 0, 0, 1);\n$table_bg: rgba(217, 221, 220, 1);\n$table_bg_main: rgba(217, 221, 217, 1);\n\n\n$hover_aqua: #13d9d9;\n$button_color: #447e9b;\n$gray_bg: #f3efef;",".nav-filters {\n  width: 77%;\n  position: relative;\n  height: 113px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 5px 25px;\n\n  display: flex;\n  flex-direction: column;\n\n  @media screen and (min-width: 1920px) {\n    width: 82%;\n  }\n\n  &__list {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    //&:not(:last-child) {\n    //  padding-bottom: 15px;\n    //  margin-bottom: 5px;\n    //}\n  }\n\n  &__item {\n    margin-bottom: 7px;\n\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__button {\n    &--chosen {\n      background: $main_green;\n      color: $text_white;\n    }\n  }\n}\n\n.nav-filters {\n  //&__item {\n  //  min-width: 70px;\n  //  width: auto;\n  //  height: 27px;\n  //}\n\n  &__button {\n    width: auto;\n    max-width: 100%;\n    height: 27px;\n    white-space: nowrap;\n  }\n\n  &__plots {\n    margin-top: 10px;\n    border-bottom: 1px solid black;\n    margin-bottom: 6px;\n    padding-bottom: 8px;\n      //margin-bottom: 5px;\n  }\n\n  &__filters {\n    flex-wrap: wrap;\n    height: 50px;\n    margin-top: 7px;\n    margin-bottom: 0 !important;\n    overflow-y: auto;\n  }\n\n  &__reset {\n    position: absolute;\n    bottom: -28px;\n    width: 131px;\n    display: block;\n    align-self: center;\n  }\n}\n\n.nav {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  margin-top: 10px;\n}\n\n.nav-control {\n  position: relative;\n  width: 313px;\n  height: 113px;\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 20px 20px 10px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__group {\n    margin-bottom: 5px;\n    font-size: 14px;\n    font-weight: 500;\n    line-height: 17px;\n    letter-spacing: 0em;\n  }\n\n  &--opened {\n    z-index: 1000;\n    height: auto;\n    position: absolute;\n    right: 0;\n    top: 0;\n  }\n\n  &__nav {\n    display: flex;\n    //flex-direction: column;\n    align-items: center;\n    justify-content: space-between;\n    border-bottom: 2px solid black;\n    margin-bottom: 5px;\n  }\n\n  &__left {\n    width: 200px;\n  }\n\n  &__admin {\n    font-size: 16px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__user {\n    display: flex;\n    margin-bottom: 7px;\n  }\n\n  &__name {\n    font-size: 16px;\n    font-weight: 700;\n    line-height: 21px;\n    letter-spacing: 0em;\n    color: rgba(76, 88, 102, 1);\n    margin-right: 7px;\n  }\n\n  &__exit {\n    a {\n      color: rgba(210, 66, 66, 1);\n      font-size: 16px;\n      font-weight: 400;\n      line-height: 21px;\n      letter-spacing: 0em;\n    }\n  }\n\n  &__total {\n    font-size: 18px;\n    font-weight: 500;\n    line-height: 23px;\n    letter-spacing: 0em;\n    text-align: center;\n    color: $main_green;\n  }\n\n  &__routes {\n    padding-bottom: 5px;\n    margin-bottom: 5px;\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n    border-bottom: 2px solid black;\n  }\n\n  &__route {\n\n    &-link {\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 26px;\n      letter-spacing: 0em;\n      cursor: pointer;\n\n      &:hover {\n        color: $main_green;\n      }\n\n      &--current {\n        text-decoration: underline;\n        color: $main_green;\n      }\n    }\n  }\n\n  &__burger {\n    position: relative;\n    top: -5px;\n    cursor: pointer;\n\n    &-item {\n      display: block;\n      width: 40px;\n      height: 5px;\n      background: $text_black;\n      border-radius: 15px;\n\n      &:not(:last-child) {\n        margin-bottom: 6px;\n      }\n    }\n  }\n}","@import \"../var\";\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: $main_green;\n  border: 1px solid black;\n  border-bottom: none;\n  border-radius: 15px 15px 0 0;\n  padding: 5px 30px;\n  height: 49px;\n  //margin-bottom: 30px;\n\n  &__title {\n    position: relative;\n    top: -1px;\n    font-size: 27px;\n    font-weight: 700;\n    line-height: 29px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: $text_white;\n    margin-right: 20px;\n  }\n\n  &__nav {\n    display: flex;\n    align-items: center;\n    //width: 400px;\n  }\n\n  &__button {\n    &:not(:last-child) {\n      margin-right: 20px;\n    }\n  }\n}\n\n.header-routes {\n  &__filter {\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__planned {\n    &-date {\n      width: 140px;\n    }\n  }\n}\n\n#search__target {\n  width: 120px !important;\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  border: 1px solid $text_white;\n  color: $text_white;\n  background: $main_green;\n}",".modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n\n  &_content {\n    display: flex;\n    flex-direction: column;\n    width: 900px;\n    height: auto;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    border-radius: 15px;\n    background: rgba(236, 236, 236, 1);\n  }\n\n  &-header {\n    width: 100%;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 5px;\n    background: $main_green;\n    color: $text_white;\n    text-align: center;\n    height: 35px;\n    border-radius: 15px 15px 0px 0px;\n  }\n\n  &__trigger {\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n    justify-content: center;\n    width: 100%;\n    height: 100px;\n    //background: ;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    color: $main_green;\n    background: $text_white;\n  }\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n  //margin-right: 15px;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 5px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n\n  &__file {\n    position: relative;\n    width: 280px;\n    height: 280px;\n    margin-bottom: 60px;\n  }\n}\n\n.link__preview {\n  display: block;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 10px;\n}\n\n.file {\n  &__preview {\n    width: 280px;\n    height: 280px;\n    //object-fit: cover;\n  }\n\n  &__download {\n    cursor: pointer;\n    position: absolute;\n    width: 30px;\n    height: 40px;\n    bottom: 5px;\n    right: 10px;\n    color: $main_green !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: green !important;\n      transition: color .3s;\n    }\n  }\n\n  &__remove {\n    cursor: pointer;\n    top: 0px;\n    right: 5px;\n    position: absolute;\n    color: $main_green !important;\n    font-size: 26px;\n    transform: rotate(45deg);\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: red !important;\n      transition: color .3s;\n    }\n  }\n\n\n  &__original {\n    position: absolute;\n    top: 5px;\n    left: 5px;\n    color: $main_green !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: green !important;\n      transition: color .3s;\n    }\n  }\n\n  &__name {\n    color: $text_black;\n    text-align: center;\n  }\n\n  &__all {\n    align-self: center;\n    width: 170px;\n    margin-bottom: 15px;\n  }\n}",".modal_content--route {\n  width: 619px;\n  height: auto;\n}\n\n.route {\n  &__config {\n    padding: 13px 10px 0;\n    background: rgba(236, 236, 236, 1);\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  }\n\n  &__title {\n    font-size: 16px;\n    font-weight: 500;\n    line-height: 19px;\n    margin-bottom: 10px;\n  }\n\n  &-block {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      margin-bottom: 10px;\n    }\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n  }\n\n  &__input {\n    &:not(:disabled), {\n      cursor: pointer;\n    }\n\n    &:not(:read-only) {\n\n    }\n  }\n\n  &-plan__date {\n    border: 1px solid rgba(173, 173, 173, 1) !important;\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n    margin-right: 0 !important;\n    color: $text_black;\n  }\n\n  &__label {\n    text-align: center;\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 17px;\n    letter-spacing: 0em;\n    margin-bottom: 7px;\n  }\n\n  &__btn {\n    align-items: center;\n    width: 97px;\n    border: 1px solid rgba(173, 173, 173, 1);\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n    border-radius: 15px;\n  }\n\n  &__select {\n    width: 130px;\n    margin-bottom: 10px;\n    border: none;\n    border-radius: 7px;\n    box-shadow: 2px 2px 5px 0px rgba(0, 0, 0, 0.25);\n    background: rgba(255, 255, 255, 1);\n\n    &:disabled {\n      background: rgba(255, 255, 255, 1);\n    }\n  }\n\n  &__input {\n    width: 136px;\n    height: 28px;\n    margin-right: -40px;\n    box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n    border-radius: 15px;\n    border: none;\n    outline: none;\n\n    &:not(:disabled) {\n      &:focus {\n        outline: 2px solid $main_green;\n      }\n    }\n\n    &--small {\n      width: 80px !important;\n\n      &:not(:last-child) {\n        //margin-right: 20px;\n      }\n    }\n\n    &--top {\n      width: 136px;\n      text-align: center;\n      margin-bottom: 10px;\n      height: 28px;\n      box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n      border-radius: 15px;\n      border: none;\n    }\n\n    &--middle {\n      width: 155px;\n    }\n  }\n\n  &__section {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 15px;\n  }\n}\n\n.report-route__btn {\n  //margin-right: 30px;\n}\n\n.section-logs {\n  width: 100%;\n  background: white;\n  border-radius: 5px;\n  padding: 5px;\n  margin-bottom: 8px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__title {\n    text-align: center;\n    margin-bottom: 10px;\n    color: $button_color;\n  }\n\n  &__list {\n    height: 85px;\n    overflow-y: scroll;\n  }\n\n  &__input {\n    padding-left: 10px;\n  }\n\n  &__item {\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 18px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: rgba(87, 87, 87, 1);\n    margin-bottom: 5px;\n\n    &--system {\n      color: $main_green;\n    }\n\n    &--error {\n      color: rgba(210, 66, 66, 1);\n    }\n\n    &--pause {\n      color: rgb(224, 108, 0);\n    }\n  }\n\n  &__comment {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 30px;\n  }\n\n  &__input {\n    width: 350px;\n  }\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n\n  &__cancel {\n    margin-right: 30px;\n  }\n\n  &__delete {\n    &:hover {\n      color: red !important;\n    }\n  }\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued,\n{\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment {\n  &__prev {\n    //margin: 12px auto 0;\n    overflow-y: scroll;\n    background: $text_white;\n    height: 100%;\n    width: 100%;\n    //border-radius: 15px;\n  }\n\n  &__item {\n    color: $text_black;\n    font-size: 17px;\n    //padding: 10px 13px;\n    //padding: 5px 0;\n    border-bottom: 1px solid black;\n  }\n}\n\n.confirm {\n  &__title {\n    font-size: 20px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    margin-top: 10px;\n    text-align: center;\n    color: $text_black;\n    margin-bottom: 25px;\n  }\n\n  &__section {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  &__button {\n    &--ok {\n      margin-right: 25px;\n    }\n\n    margin-bottom: 10px;\n  }\n}\n\n.progress-block {\n  width: 180px;\n}\n\n.quantity-block {\n  display: flex;\n  justify-content: space-between;\n\n  &__labels {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  &__label {\n    margin-right: 47px;\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 17px;\n    letter-spacing: 0em;\n    text-align: center;\n  }\n\n  &__issued {\n    position: relative;\n    right: -5px;\n  }\n\n  &__shifts {\n    //margin-right: 33px;\n  }\n\n  &__inshifts {\n    margin-right: 44px;\n    position: relative;\n    right: 10px;\n  }\n}\n\n.route-type {\n  &__paused {\n    //color: rgba(224, 108, 0, 1) !important;\n    border: 2px solid rgba(224, 108, 0, 1);\n  }\n\n  &__error {\n    //color: rgba(210, 66, 66, 1) !important;\n    border: 2px solid rgba(210, 66, 66, 1);\n  }\n\n  &__start {\n    //color: rgba(24, 136, 217, 1) !important;\n    border: 2px solid rgba(24, 136, 217, 1);\n  }\n\n  &__finish {\n    //color: rgba(0, 130, 29, 1) !important;\n    border: 2px solid rgba(0, 130, 29, 1);\n  }\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray !important;\n  }\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgba(236, 236, 236, 1);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__input {\n    padding-left: 10px;\n    margin-top: 20px;\n    height: 28px;\n    text-align: left !important;\n    margin-right: 0;\n    width: 90%;\n    margin-bottom: 15px;\n    background: $text_white;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  &__date {\n    margin-bottom: 10px;\n    margin-right: 0;\n\n  }\n\n  &__input {\n    margin-right: 0;\n    width: 20%;\n    height: 28px;\n    margin-bottom: 15px;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.user__block {\n  margin-right: 40px;\n}\n\n.endtime__block {\n  margin-right: 107px;\n}\n\n.start-route__btn {\n  color: rgba(24, 136, 217, 1);\n}\n\n.end-route__btn {\n  color: rgba(0, 130, 29, 1);\n}\n\n.pause-route__btn {\n  color: rgba(224, 108, 0, 1);\n}\n\n.error-route__btn {\n  color: rgba(210, 66, 66, 1);\n}\n\n.section-report {\n  justify-content: left;\n}\n\n.issued-modal_trigger {\n  margin-right: 75px;\n}\n\n.send__comment {\n  width: 130px;\n  border: 2px solid rgba(105, 135, 105, 1);\n  color: rgba(105, 135, 105, 1);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n\n.section-finish {\n  &__sub {\n    border-radius: 15px;\n    width: 130px;\n    height: 40px;\n    border: none;\n    background: rgba(105, 135, 105, 1);\n    color: $text_white;\n  }\n\n  &__delete {\n    border: none;\n    background: none;\n    color: rgba(210, 66, 66, 1);\n    cursor: pointer;\n  }\n}\n\n.issued-top {\n  display: flex;\n  align-items: center;\n\n  &__item {\n    padding: 5px 0;\n    width: 39%;\n\n    &:not(:last-child) {\n      border-right: 1px solid black;\n    }\n\n    &--date {\n      width: 120px;\n    }\n\n    &--summary {\n      width: 80px;\n    }\n  }\n}\n",".modal_content--comments {\n  width: 612px;\n}\n\n\n.comments {\n  &__title {\n    font-size: 20px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: $text_white;\n    margin-left: 31px;\n  }\n\n  &-content {\n    padding: 24px;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    background: rgba(236, 236, 236, 1);\n    border-radius: 15px;\n  }\n\n  &__add {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n}\n\n.comments-list {\n  height: 90px;\n  padding: 7px 10px;\n  overflow-y: scroll;\n  border-radius: 15px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  background: $text_white;\n\n  &__item {\n    color: $text_gray;\n    margin-bottom: 5px;\n    display: flex;\n    align-items: center;\n  }\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n}\n\n.comments__prev {\n  margin-bottom: 10px;\n}\n\n.comments__yours {\n  width: 350px;\n  cursor: text !important;\n  padding-left: 10px;\n}",".modal-plan {\n  position: relative;\n\n  .confirm__section {\n    position: absolute;\n    bottom: 0;\n  }\n}\n\n.modal {\n  &-plan__date {\n\n  }\n\n  &-plan {\n    padding: 5px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    &__today {\n      text-align: center;\n      align-self: center;\n    }\n\n    &__section {\n      width: 250px;\n      display: flex;\n      flex-direction: column;\n      justify-content: space-between;\n      //align-items: center;\n\n      &:not(:last-child) {\n        margin-bottom: 10px;\n      }\n    }\n\n    &__data {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n\n      &--center {\n        justify-content: center;\n      }\n    }\n\n    &__input {\n      width: 120px;\n    }\n\n    &__check {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n    }\n\n    &__exclude {\n      text-align: center;\n      height: 100px;\n\n      &-option {\n        text-align: center;\n        padding: 2px;\n\n        &:hover {\n          cursor: pointer;\n        }\n      }\n    }\n  }\n}\n\n.confirm__title--plan {\n  margin-bottom: 5px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.plan-period {\n  &__btn {\n    &:not(:last-child) {\n      margin-right: 5px;\n    }\n  }\n\n  margin-bottom: 10px;\n}\n\n.plan-dates {\n  display: flex;\n  overflow-y: scroll;\n  max-height: 72%;\n  //justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-left: -2px;\n  //min-height: 308px;\n\n  &__item {\n    width: 105px;\n    padding: 5px;\n    background: $text_white;\n    margin-bottom: 7px;\n    transition: color .3s;\n    text-align: center;\n\n    &:hover {\n      cursor: pointer;\n      transition: color .3s;\n      color: #09d009;\n    }\n\n    &:not(:last-child) {\n      margin-right: 7px;\n    }\n\n    &--inplan {\n      color: white;\n      background: $main_green;\n    }\n\n    &--busy {\n      border: 1px solid $main_green;\n    }\n  }\n}",".admin-panel {\n  min-width: 1200px;\n  height: 600px;\n  background: $text_white;\n}\n\n.panel-nav {\n  margin-top: 10px;\n  color: $text_gray;\n\n  padding: 5px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav-navigation {\n  padding: 10px;\n  width: 350px;\n  height: 200px;\n  background: rgba(236, 236, 236, 1);\n  border-radius: 15px;\n\n  &__item {\n    height: 28px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n\n    &:not(:last-child) {\n      margin-bottom: 10px;\n    }\n\n    &--title {\n      width: 100%;\n      background: $main_green;\n      border-radius: 15px;\n      text-align: center;\n      color: $text_white;\n    }\n  }\n\n  &__text {\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s;\n    }\n  }\n}\n\n.nav-content {\n  width: 70%;\n  min-height: 500px;\n  max-height: 500px;\n  display: flex;\n  flex-direction: column;\n\n  overflow-y: auto;\n\n  &__columns {\n    height: 40px;\n    padding: 10px;\n    border-radius: 15px 15px 0 0;\n    background: $main_green;\n    color: $text_white;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    //height: 28px;\n  }\n\n  &__items {\n    padding: 10px;\n    background: rgba(236, 236, 236, 1);\n  }\n\n  &__item {\n    min-height: 40px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n\n  &__column {\n    min-width: 20%;\n    text-align: center;\n\n    &--left {\n      text-align: left !important;\n    }\n\n    &-name {\n      min-width: 45%;\n      width: 45%;\n    }\n\n    &-shortname {\n      min-width: 15%;\n      width: 15%;\n    }\n\n    &-hide {\n      min-width: 10%;\n      width: 10%;\n    }\n  }\n\n}\n\n.nav-item {\n  width: 100%;\n\n  &__column {\n    text-align: center;\n    min-width: 20%;\n\n    &--left {\n      text-align: left;\n    }\n\n    &-name {\n      min-width: 45%;\n      width: 45%;\n    }\n\n    &-shortname {\n      min-width: 15%;\n      width: 15%;\n    }\n\n    &-hide {\n      min-width: 10%;\n      width: 10%;\n    }\n\n    &--edit {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $main_green;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__pos {\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n}\n\n.edit-form {\n  align-self: center;\n  width: 726px;\n  display: flex;\n  justify-content: space-between;\n  background: rgba(236, 236, 236, 1);\n  padding: 25px;\n  border-radius: 15px;\n  position: relative;\n\n  &--group {\n    width: 300px;\n    height: 320px;\n\n    .edit-form__user {\n      border-right: none;\n      width: 100%;\n      height: 100%;\n    }\n  }\n\n  &__text {\n    padding: 10px;\n    width: 250px;\n    height: 100px;\n    resize: none;\n    cursor: pointer;\n  }\n\n  &__user {\n    //margin-top: 13px;\n    width: 50%;\n    //height: 284px;\n    border-right: 1px solid $text_gray;\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 15px;\n\n    &--checker {\n      flex-direction: row;\n    }\n  }\n\n  &__label {\n    font-size: 18px;\n    font-weight: 400;\n    line-height: 30px;\n    letter-spacing: 0em;\n\n    &--checker {\n      flex-direction: row;\n      margin-right: 168px;\n    }\n  }\n\n  &__input {\n    padding: 5px 5px 5px 10px;\n    width: 250px !important;\n    height: 28px !important;\n    cursor: text;\n    margin-bottom: 0 !important;\n  }\n\n  &__group {\n    cursor: pointer !important;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__plot {\n    cursor: pointer !important;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__submit {\n    cursor: pointer;\n    margin-top: 20px;\n    align-self: flex-end;\n  }\n\n  &__succ {\n    position: absolute;\n    color: $main_green;\n\n    &--user {\n      bottom: 70px;\n      left: 25px;\n    }\n\n    &--filter {\n      bottom: 80px;\n      left: 27px;\n    }\n\n    &--group {\n      bottom: 80px;\n      left: 27px;\n    }\n  }\n}"],"sourceRoot":""}]);
// Exports
