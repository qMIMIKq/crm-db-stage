...
/* harmony export */ });
/* harmony import */ var _submitOrdersData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./submitOrdersData */ "./web/src/static/js/modules/submitOrdersData.js");
...
const changeElemHandler = e => {
  ...
  if (parent !== null) {
    parent.classList.remove('table-form--old');
    parent.classList.add('table-form--upd');
    (0,_submitOrdersData__WEBPACK_IMPORTED_MODULE_0__.submitData)();
    // submitSingleOrder(parent.getAttribute('id'))
  } else {
    ...
    switch (action) {
      case 'add':
        ...
        if (!label.classList.contains('table__data--opened')) {
          ...
          _state__WEBPACK_IMPORTED_MODULE_2__.state.currentOrder = parent.querySelector('#db_id').value;
        }
        break;
      case 'show-current':
        // state['inWork'] = true
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "issuedHandlerModal": () => (/* binding */ issuedHandlerModal)
/* harmony export */ });
/* harmony import */ var _showModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./showModal */ "./web/src/static/js/modules/modals/showModal.js");
/* harmony import */ var _routesModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./routesModal */ "./web/src/static/js/modules/modals/routesModal.js");
/* harmony import */ var _table__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../table */ "./web/src/static/js/table/index.js");
...
`;
const issuedHandlerModal = (e, issuedInput, issuedTodayInput, plotI, userI, updateData, shift) => {
  ...
  okBtn.addEventListener('click', () => {
    ...
    shift.value = '';
    if (check) {
      (0,_routesModal__WEBPACK_IMPORTED_MODULE_1__.addLog)(_table__WEBPACK_IMPORTED_MODULE_2__.user.nickname, `${plot.value} За смену ${date.value === today ? '' : date.value} ${userData.value} Наладка ${modalAdjustmentInput.value} Выдал ${modalIssuedInput.value}`, '#visible__comments');
...
const triggerRoutesModal = function (e) {
  let page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'main';
  ...
  modalElem.querySelector('.section-finish__sub').addEventListener('click', () => {
    ...
    if (page === 'main') {
      ...
      (0,_sendData__WEBPACK_IMPORTED_MODULE_4__.sendData)(`${_appAddr__WEBPACK_IMPORTED_MODULE_10__.appAddr}/api/routes/update-route`, 'POST', JSON.stringify(obj)).then(resp => {
        console.log(resp.ok);
      });
    }
...
/***/ "./web/src/static/js/plan/autoShiftHandler.js":
/*!****************************************************!*\
  !*** ./web/src/static/js/plan/autoShiftHandler.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "autoShiftHandler": () => (/* binding */ autoShiftHandler)
/* harmony export */ });
...
/* harmony import */ var _modules_modals_routesModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/modals/routesModal */ "./web/src/static/js/modules/modals/routesModal.js");
...
`;
const autoShiftHandler = (shifter, moveTo, addedDates, currentOrder) => {
...
/***/ "./web/src/static/js/plan/drawPlan.js":
/*!********************************************!*\
  !*** ./web/src/static/js/plan/drawPlan.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const planningHandler = (currentOrder, d, addedDates) => {
  let newBusy = [];
  (0,_modules_sendData__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${_appAddr__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/plans/get-busy`, 'POST', JSON.stringify({
    "plot": d.route_plot,
    "route_id": d.route_id
  })).then(res => {
    return res.json();
    ...
    let currentDate;
    let today = (0,_modules_getTime__WEBPACK_IMPORTED_MODULE_2__.getTime)();
    let todayStr = today.substring(0, today.length - 5).trim();
    let modalAddedDates = addedDates ? addedDates : [];
    let resObj = {};
    let flag = !!Object.keys(modalAddedDates).length;
    ...
    const addHandlers = () => {
      currentOrder.querySelectorAll('.plan-dates__item').forEach(dateItem => {
        dateItem.addEventListener('click', e => {
          ...
          const addingModal = (0,_modules_modals_showModal__WEBPACK_IMPORTED_MODULE_3__.showModal)(planDateModalAdd);
          ...
          okBtn.addEventListener('click', () => {
            ...
            (0,_modules_sendData__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${_appAddr__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/plans/update`, 'POST', JSON.stringify(createDataObject())).then(res => {
              addingModal.click();
              (0,_getPlans__WEBPACK_IMPORTED_MODULE_4__.getPlans)(false);
            });
            deleteData();
            drawData();
            addingModal.click();
...
/***/ "./web/src/static/js/plan/filters/controlPlanFilterReset.js":
/*!******************************************************************!*\
  !*** ./web/src/static/js/plan/filters/controlPlanFilterReset.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "controlPlanFiltersReset": () => (/* binding */ controlPlanFiltersReset)
/* harmony export */ });
...
/* harmony import */ var _modules_filters_newAllFilter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../modules/filters/newAllFilter */ "./web/src/static/js/modules/filters/newAllFilter.js");
  ...
  if (_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.filtered) {
    ...
    if (resetBtn === null) {
      ...
      nav.querySelector('.header-button__reset').addEventListener('click', e => {
        ...
        (0,_getPlans__WEBPACK_IMPORTED_MODULE_3__.getPlans)('get-all', true);
        (0,_newAllPlanFilter__WEBPACK_IMPORTED_MODULE_4__.newAllPlanFilter)();
      });
    }
  } else {
    const resetBtn = document.querySelector('.header-button__reset');
...
/***/ "./web/src/static/js/plan/filters/newAllPlanFilter.js":
/*!************************************************************!*\
  !*** ./web/src/static/js/plan/filters/newAllPlanFilter.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "newAllPlanFilter": () => (/* binding */ newAllPlanFilter)
/* harmony export */ });
/* harmony import */ var _modules_state__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../modules/state */ "./web/src/static/js/modules/state.js");
/* harmony import */ var _modules_getOrders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../modules/getOrders */ "./web/src/static/js/modules/getOrders.js");
/* harmony import */ var _controlPlanFilterReset__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controlPlanFilterReset */ "./web/src/static/js/plan/filters/controlPlanFilterReset.js");
/* harmony import */ var _drawPlan__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../drawPlan */ "./web/src/static/js/plan/drawPlan.js");
...
const newAllPlanFilter = async init => {
  ...
  const hideNotIncluded = _modules_state__WEBPACK_IMPORTED_MODULE_0__.state.hideNotIncluded;
  ...
  const isTopRoutesFiltered = !!topRouteFilters.length;
  (0,_controlPlanFilterReset__WEBPACK_IMPORTED_MODULE_2__.controlPlanFiltersReset)();
    ...
    _modules_state__WEBPACK_IMPORTED_MODULE_0__.state.orders.forEach(order => {
      ...
      if (flag) {
        ...
        if (hiddenOrder !== null) {
          ...
          (0,_drawPlan__WEBPACK_IMPORTED_MODULE_3__.drawPlan)(order);
        }
      }
      flag = true;
    });
      ...
      if (tableFilters['every']) {
        ...
        if (flag) {
          if (isTopRoutesFiltered) {
            ...
            if (topRouteFilters.includes(order.route_plot)) {} else {
              flag = false;
            }
          }
          if (hideNotIncluded) {
  ...
  if (!searched && !isTopRoutesFiltered && !hideNotIncluded) {
    if (init) {
      ...
      _modules_state__WEBPACK_IMPORTED_MODULE_0__.state.orders.forEach(order => {
        (0,_drawPlan__WEBPACK_IMPORTED_MODULE_3__.drawPlan)(order, _modules_state__WEBPACK_IMPORTED_MODULE_0__.state.orders);
        // console.log(order.id)
        // document.querySelector(`#form-${order.id}`).classList.remove('hidden__input')
        // order.classList.remove('hidden__input')
      });
...
/***/ "./web/src/static/js/plan/filters/newPlanCheck.js":
/*!********************************************************!*\
  !*** ./web/src/static/js/plan/filters/newPlanCheck.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const reportPlanningDatesFilter = () => {
  ...
  planHider.addEventListener('click', () => {
    ...
    _modules_state__WEBPACK_IMPORTED_MODULE_1__.state.hideNotIncluded = planHider.classList.contains('plan-hider--chosen');
    (0,_newAllPlanFilter__WEBPACK_IMPORTED_MODULE_4__.newAllPlanFilter)();
  });
  planDivider.addEventListener('click', () => {
    planDivider.classList.toggle('route__filter--chosen');
...
/***/ "./web/src/static/js/plan/filters/searchPlansHandler.js":
/*!**************************************************************!*\
  !*** ./web/src/static/js/plan/filters/searchPlansHandler.js ***!
  \**************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "searchPlansHandler": () => (/* binding */ searchPlansHandler)
/* harmony export */ });
/* harmony import */ var _modules_modals_showModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../modules/modals/showModal */ "./web/src/static/js/modules/modals/showModal.js");
/* harmony import */ var _modules_state__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../modules/state */ "./web/src/static/js/modules/state.js");
/* harmony import */ var _newAllPlanFilter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./newAllPlanFilter */ "./web/src/static/js/plan/filters/newAllPlanFilter.js");
...
const searchPlansHandler = () => {
  ...
  searchBtn.addEventListener('click', () => {
    ...
    searchModal.click();
    (0,_newAllPlanFilter__WEBPACK_IMPORTED_MODULE_2__.newAllPlanFilter)();
  });
};

/***/ }),

/***/ "./web/src/static/js/plan/filters/topPlansFilters.js":
/*!***********************************************************!*\
  !*** ./web/src/static/js/plan/filters/topPlansFilters.js ***!
  \***********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _searchPlansHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./searchPlansHandler */ "./web/src/static/js/plan/filters/searchPlansHandler.js");
/* harmony import */ var _newAllPlanFilter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./newAllPlanFilter */ "./web/src/static/js/plan/filters/newAllPlanFilter.js");
/* harmony import */ var _getPlans__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../getPlans */ "./web/src/static/js/plan/getPlans.js");
...
const topPlansFilters = () => {
  ...
  const searchBtn = document.querySelector('.nav-control__search-btn');
  searchBtn.addEventListener('click', () => {
    (0,_searchPlansHandler__WEBPACK_IMPORTED_MODULE_4__.searchPlansHandler)();
  });
  const links = navControl.querySelectorAll('.nav-control__route-link');
  links.forEach(link => {
    link.addEventListener('click', () => {
    ...
    btns.forEach(btn => {
      btn.addEventListener('click', e => {
        ...
        if (_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.currentTopFilters.length) {
          ...
          (0,_getPlans__WEBPACK_IMPORTED_MODULE_6__.getPlans)(true);
          filtered = false;
          controlFilterReset();
        }
      });
      ...
      btn.addEventListener('click', e => {
        ...
        if (_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.currentTopFilters.length) {
          ...
          if (_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.currentTopPlots.length) {
            filterByPlots();
            (0,_getPlans__WEBPACK_IMPORTED_MODULE_6__.getPlans)();
          } else {
            filtered = false;
            (0,_getPlans__WEBPACK_IMPORTED_MODULE_6__.getPlans)();
            controlFilterReset();
...
const filterRouteReports = () => {
  ...
  (0,_newAllPlanFilter__WEBPACK_IMPORTED_MODULE_5__.newAllPlanFilter)();
...
/***/ "./web/src/static/js/plan/getPlans.js":
/*!********************************************!*\
  !*** ./web/src/static/js/plan/getPlans.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const getPlans = updateOnly => {
  ...
  (0,_modules_sendData__WEBPACK_IMPORTED_MODULE_1__.sendData)(`${_appAddr__WEBPACK_IMPORTED_MODULE_2__.appAddr}/api/planning/get-all`, 'POST', JSON.stringify(params)).then(res => res.json()).then(data => {
    ...
    if (data.data) {
      _modules_state__WEBPACK_IMPORTED_MODULE_0__.state.orders = data.data;
      title.textContent = `Планирование (${_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.orders.length})`;
      // data.data.forEach(d => {
      //   drawPlan(d, data, from, to)
      // })

      (0,_filters_newAllPlanFilter__WEBPACK_IMPORTED_MODULE_4__.newAllPlanFilter)(true);
      loader.classList.add('hidden__input');
      // console.log()
...
/***/ "./web/src/static/js/plan/planShowCurrentLine.js":
/*!*******************************************************!*\
  !*** ./web/src/static/js/plan/planShowCurrentLine.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "planShowCurrentLine": () => (/* binding */ planShowCurrentLine)
/* harmony export */ });
const planShowCurrentLine = () => {
  const mainTable = document.querySelector('.main__table');
  const forms = mainTable.querySelectorAll('form');
  forms.forEach(form => {
    form.addEventListener('click', e => {
...
/***/ "./web/src/static/js/plan/shiftHandler.js":
/*!************************************************!*\
  !*** ./web/src/static/js/plan/shiftHandler.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "shiftHandler": () => (/* binding */ shiftHandler)
/* harmony export */ });
/* harmony import */ var _modules_modals_showModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/modals/showModal */ "./web/src/static/js/modules/modals/showModal.js");
/* harmony import */ var _modules_modals_routesModal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/modals/routesModal */ "./web/src/static/js/modules/modals/routesModal.js");
/* harmony import */ var _modules_sendData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/sendData */ "./web/src/static/js/modules/sendData.js");
...
const shiftHandler = (shifter, moveTo, addedDates, currentOrder) => {
  ...
  okBtn.addEventListener('click', () => {
    ...
    (0,_modules_sendData__WEBPACK_IMPORTED_MODULE_2__.sendData)(`${_appAddr__WEBPACK_IMPORTED_MODULE_3__.appAddr}/api/plans/shift`, 'POST', JSON.stringify(shifter)).then(resp => {
      return resp.json();
    }).then(res => {
      console.log(res);
      handleClose();
...
/* harmony import */ var _modules_addTriggers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/addTriggers */ "./web/src/static/js/modules/addTriggers.js");
/* harmony import */ var _modules_modals_routesModal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../modules/modals/routesModal */ "./web/src/static/js/modules/modals/routesModal.js");
...
const drawReport = async d => {
  ...
  // addTriggers(".table__route", triggerRoutesModal)
  // addTriggers(".table__comment", triggerCommentsModal)
  (0,_modules_addTriggers__WEBPACK_IMPORTED_MODULE_2__.addTriggers)(currentOrder, '.order__plot-report', e => (0,_modules_modals_routesModal__WEBPACK_IMPORTED_MODULE_3__.triggerRoutesModal)(e, 'report'));
  try {} catch {}
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  font-family: \"Nunito\", sans-serif;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  display: none;\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput[type=number] {\n  -moz-appearance: textfield;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput, select {\n  outline: none;\n  font-family: \"Nunito\", sans-serif;\n}\n\nhtml {\n  height: 100%;\n  font-family: \"Nunito\", sans-serif;\n}\n\nbody {\n  font-family: \"Nunito\", sans-serif;\n  background: rgb(236, 236, 236);\n  height: 95%;\n}\n\n.container {\n  padding: 0 15px;\n  height: 98%;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: rgb(66, 66, 66);\n  height: 80%;\n}\n@media screen and (min-width: 2025px) {\n  .main--reports {\n    margin: 0 auto 15px;\n    width: 2025px;\n  }\n}\n.main__button {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  height: 28px;\n  text-align: center;\n  border: 1px solid black;\n  border-radius: 5px;\n  background: white;\n  color: rgb(66, 66, 66);\n  transition: color 0.3s;\n  cursor: pointer;\n  padding: 5px;\n}\n.main__button:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.main__button--select {\n  background: rgb(217, 221, 220) !important;\n}\n.main__button--select {\n  outline: none;\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  letter-spacing: 0em;\n  text-align: center;\n  color: rgb(137, 175, 137);\n  cursor: pointer;\n  padding: 3px 7px;\n  border: none;\n}\n.main__button--click {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  letter-spacing: 0em;\n  text-align: center;\n  border-radius: 15px;\n  border: 1px solid rgb(203, 203, 203);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  background: white;\n  color: rgb(66, 66, 66);\n  cursor: pointer;\n  padding: 3px 7px;\n}\n.main__input {\n  padding: 5px;\n  cursor: text;\n  border: 1px solid black;\n  border-radius: 5px;\n  color: rgb(66, 66, 66);\n}\n.main-table__data {\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  margin-bottom: 5px;\n  border-left: 1px solid rgb(203, 203, 203);\n  border-right: 1px solid rgb(203, 203, 203);\n  border-bottom: 1px solid rgb(203, 203, 203);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  background: white;\n}\n.main-table__data--reports {\n  overflow-y: scroll;\n  overflow-x: auto;\n}\n.main__select {\n  text-align: center !important;\n}\n.main__select {\n  width: 100%;\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n}\n\n.warning {\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active,\na:hover,\na {\n  -webkit-text-decoration: none;\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n}\nselect:disabled:hover {\n  color: gray;\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\n\nbutton {\n  border: none;\n  background: none;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n}\nbutton:disabled:hover {\n  color: gray;\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\ninput:disabled:hover {\n  color: gray;\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test__form {\n  display: none;\n  visibility: hidden;\n}\n.test__list {\n  background: none;\n}\n.test__item {\n  background: transparent;\n}\n.test__input {\n  background: transparent;\n  outline: none;\n  border: none;\n}\n\n.admin-form__button {\n  width: 130px;\n  transition: color 0.3s;\n  position: absolute;\n  right: 24px;\n}\n.admin-form__button:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n.admin-form__user {\n  margin-right: 10px;\n}\n.admin-form__exit {\n  transition: color 0.3s;\n}\n.admin-form__exit:hover {\n  transition: color 0.3s;\n  color: rgb(66, 66, 66);\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n.search {\n  display: flex;\n  align-items: center;\n}\n@media screen and (max-width: 1200px) {\n  .search {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 100000;\n  position: absolute;\n  min-width: 100%;\n  color: black;\n  background: rgba(236, 236, 236, 0.9); /* Полупрозрачный цвет фона */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border-radius: 5px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.check-helper--long {\n  min-width: 300%;\n}\n.check-helper--errored {\n  padding: 0;\n  color: black;\n}\n\n.routes-block {\n  display: flex;\n  align-items: center;\n}\n\n.archive-block {\n  display: flex;\n  align-items: center;\n}\n\n.header-routes {\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  position: relative;\n}\n\n.loupe {\n  width: 10px;\n  transition: fill 0.3s;\n}\n.planned__label {\n  margin-right: 7px;\n}\n\n.plan-divider {\n  margin-right: 15px;\n}\n.plan-divider--modal {\n  position: absolute;\n  bottom: 55px;\n  left: 19px;\n}\n\n.plan-auto--modal {\n  position: absolute;\n  bottom: 55px;\n  left: 170px;\n}\n\n.plan-hider {\n  margin-right: 15px;\n}\n.plan-hider--chosen {\n  border: 1px solid rgb(255, 255, 255);\n  color: rgb(255, 255, 255);\n  background: rgb(137, 175, 137);\n}\n\n.spinner-loader {\n  background: transparent !important;\n}\n\n.spinner-loader {\n  z-index: 2;\n  width: 50px;\n  height: 50px;\n  fill: none;\n}\n\n@keyframes rotate {\n  100% {\n    transform: rotate(360deg);\n  }\n}\n@keyframes dash {\n  0% {\n    stroke-dasharray: 1, 150;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 90, 150;\n    stroke-dashoffset: -35;\n  }\n  100% {\n    stroke-dasharray: 90, 150;\n    stroke-dashoffset: -124;\n  }\n}\n.bg-red {\n  background: rgb(210, 66, 66) !important;\n  color: white !important;\n}\n\n.report-complete {\n  color: #0be50b !important;\n  font-size: 16px !important;\n  font-weight: 600 !important;\n}\n\n.not-planned {\n  color: #d4d421 !important;\n}\n\n.report-refresh {\n  margin-right: 10px;\n}\n\n.order__plot-report {\n  cursor: pointer !important;\n}\n\n.order__plot-report {\n  transition: color 0.3s linear;\n}\n.order__plot-report:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s linear;\n}\n\n.nav-filters {\n  width: 77%;\n  position: relative;\n  height: 113px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  border: 1px solid rgb(203, 203, 203);\n  border-radius: 15px;\n  padding: 5px 25px;\n  display: flex;\n  flex-direction: column;\n}\n@media screen and (min-width: 1920px) {\n  .nav-filters {\n    width: 82%;\n  }\n}\n.nav-filters__list {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.nav-filters__item {\n  margin-bottom: 7px;\n}\n.nav-filters__item:not(:last-child) {\n  margin-right: 10px;\n}\n.nav-filters__button--chosen {\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n}\n\n.nav-filters__button {\n  width: auto;\n  max-width: 100%;\n  height: 27px;\n  white-space: nowrap;\n}\n.nav-filters__plots {\n  margin-top: 10px;\n  border-bottom: 1px solid rgb(203, 203, 203);\n  margin-bottom: 6px;\n  padding-bottom: 8px;\n}\n.nav-filters__filters {\n  margin-bottom: 0 !important;\n}\n.nav-filters__filters {\n  flex-wrap: wrap;\n  height: 50px;\n  margin-top: 7px;\n  overflow-y: auto;\n}\n.nav-filters__reset {\n  position: absolute;\n  bottom: -28px;\n  width: 161px;\n  display: block;\n  align-self: center;\n}\n\n.nav {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  margin-top: 10px;\n}\n\n.nav-control {\n  position: relative;\n  width: 313px;\n  height: 113px;\n  border: 1px solid rgb(203, 203, 203);\n  border-radius: 15px;\n  padding: 20px 20px 10px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.nav-control__group {\n  margin-bottom: 5px;\n  font-size: 15px;\n  font-weight: 500;\n  line-height: 17px;\n  letter-spacing: 0em;\n}\n.nav-control--opened {\n  z-index: 1000;\n  height: auto;\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n.nav-control__nav {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  border-bottom: 2px solid rgb(203, 203, 203);\n  margin-bottom: 5px;\n}\n.nav-control__left {\n  width: 200px;\n}\n.nav-control__admin {\n  font-size: 16px;\n  font-weight: 600;\n  line-height: 26px;\n  letter-spacing: 0em;\n  cursor: pointer;\n  transition: color 0.3s;\n  color: rgb(107, 102, 102);\n}\n.nav-control__admin:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.nav-control__user {\n  display: flex;\n  margin-bottom: 7px;\n}\n.nav-control__name {\n  font-size: 17px;\n  font-weight: 700;\n  line-height: 21px;\n  letter-spacing: 0em;\n  color: rgb(76, 88, 102);\n  margin-right: 7px;\n}\n.nav-control__exit a {\n  color: rgb(210, 66, 66);\n  font-size: 16px;\n  font-weight: 400;\n  line-height: 21px;\n  letter-spacing: 0em;\n}\n.nav-control__search {\n  font-size: 18px;\n  font-weight: 500;\n  line-height: 23px;\n  letter-spacing: 0em;\n  text-align: center;\n  color: rgb(137, 175, 137);\n}\n.nav-control__search-btn:hover svg {\n  fill: green;\n}\n.nav-control__routes {\n  padding-bottom: 5px;\n  margin-bottom: 5px;\n  display: flex;\n  flex-direction: column;\n  align-items: flex-end;\n  border-bottom: 2px solid rgb(203, 203, 203);\n}\n.nav-control__route-link {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  cursor: pointer;\n  color: rgb(107, 102, 102);\n}\n.nav-control__route-link:hover {\n  color: rgb(137, 175, 137);\n}\n.nav-control__route-link--current {\n  -webkit-text-decoration: underline;\n  text-decoration: underline;\n  color: rgb(137, 175, 137);\n}\n.nav-control__burger {\n  position: relative;\n  top: -5px;\n  cursor: pointer;\n}\n.nav-control__burger-item {\n  display: block;\n  width: 40px;\n  height: 5px;\n  background: rgb(107, 102, 102);\n  border-radius: 15px;\n}\n.nav-control__burger-item:not(:last-child) {\n  margin-bottom: 6px;\n}\n\n.search-orders__input {\n  margin-right: 0 !important;\n  width: 170px !important;\n  cursor: text !important;\n}\n\n.search-orders__input {\n  padding-left: 9px;\n}\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: rgb(137, 175, 137);\n  border: 1px solid rgb(203, 203, 203);\n  border-bottom: none;\n  border-radius: 15px 15px 0 0;\n  padding: 5px 30px;\n  height: 49px;\n}\n.main-header__title {\n  position: relative;\n  font-size: 27px;\n  font-weight: 700;\n  line-height: 29px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(255, 255, 255);\n  margin-right: 10px;\n}\n.main-header__nav {\n  display: flex;\n  align-items: center;\n}\n.main-header__button {\n  transition: color 0.3s;\n}\n.main-header__button:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.main-header__button:not(:last-child) {\n  margin-right: 10px;\n}\n\n.header-routes__filter:not(:last-child) {\n  margin-right: 10px;\n}\n.header-routes__planned-date {\n  width: 140px;\n}\n\n#search__target {\n  width: 120px !important;\n}\n\n#search__target {\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  border: 1px solid rgb(255, 255, 255);\n  color: rgb(255, 255, 255);\n  background: rgb(137, 175, 137);\n}\n\n.modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n}\n.modal_content {\n  display: flex;\n  flex-direction: column;\n  width: 900px;\n  height: auto;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n  background: rgb(236, 236, 236);\n}\n.modal_content-block {\n  padding: 5px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  width: 100%;\n}\n.modal-header {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 5px;\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n  text-align: center;\n  height: 35px;\n  border-radius: 15px 15px 0px 0px;\n}\n.modal__trigger {\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  justify-content: center;\n  width: 100%;\n  height: 100px;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  color: rgb(137, 175, 137);\n  background: rgb(255, 255, 255);\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 15px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n}\n.data__file {\n  position: relative;\n  width: 260px;\n  height: 260px;\n  margin-bottom: 100px;\n}\n\n.link__preview {\n  display: block;\n  width: 260px;\n  height: 260px;\n  margin-bottom: 10px;\n}\n\n.file__preview {\n  width: 260px;\n  height: 260px;\n}\n.file__download {\n  color: rgb(137, 175, 137) !important;\n}\n.file__download {\n  cursor: pointer;\n  position: absolute;\n  width: 30px;\n  height: 40px;\n  bottom: 5px;\n  right: 10px;\n  transition: color 0.3s;\n}\n.file__download:hover {\n  color: green !important;\n}\n.file__download:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__remove {\n  color: rgb(137, 175, 137) !important;\n}\n.file__remove {\n  cursor: pointer;\n  top: 0px;\n  right: 5px;\n  position: absolute;\n  font-size: 26px;\n  transform: rotate(45deg);\n  transition: color 0.3s;\n}\n.file__remove:hover {\n  color: red !important;\n}\n.file__remove:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__original {\n  color: rgb(137, 175, 137) !important;\n}\n.file__original {\n  position: absolute;\n  top: 5px;\n  left: 5px;\n  transition: color 0.3s;\n}\n.file__original:hover {\n  color: green !important;\n}\n.file__original:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__name {\n  color: rgb(66, 66, 66);\n  word-wrap: break-word;\n  text-align: center;\n}\n.file__all {\n  align-self: center;\n  width: 170px;\n  margin-bottom: 15px;\n}\n\n.modal_content--route {\n  width: 619px;\n  height: auto;\n}\n\n.route__config {\n  padding: 13px 10px 0;\n  background: rgb(236, 236, 236);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.route__title {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  margin-bottom: 10px;\n  color: rgb(66, 66, 66);\n}\n.route-block__wrapper {\n  display: flex;\n  align-items: center;\n  margin-bottom: 10px;\n}\n.route__block {\n  display: flex;\n  flex-direction: column;\n}\n.route__input:not(:disabled) {\n  cursor: pointer;\n}\n.route-plan__date {\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n  margin-right: 0 !important;\n}\n.route-plan__date {\n  border: 1px solid rgb(173, 173, 173);\n  color: rgb(66, 66, 66);\n}\n.route__label {\n  text-align: center;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 17px;\n  letter-spacing: 0em;\n  margin-bottom: 7px;\n}\n.route__btn {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 97px;\n  border: 1px solid rgb(173, 173, 173);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n.route__select {\n  width: 130px;\n  margin-bottom: 10px;\n  border: none;\n  border-radius: 7px;\n  box-shadow: 2px 2px 5px 0px rgba(0, 0, 0, 0.25);\n  background: rgb(255, 255, 255);\n}\n.route__select:disabled {\n  background: rgb(255, 255, 255);\n}\n.route-day__quantity {\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n  margin-right: 0 !important;\n  cursor: pointer !important;\n}\n.route-day__quantity {\n  border: 1px solid rgb(173, 173, 173);\n  color: rgb(66, 66, 66);\n  transition: color 0.3s linear;\n}\n.route-day__quantity:hover {\n  transition: color 0.3s linear;\n  cursor: pointer;\n  color: rgb(137, 175, 137);\n}\n.route__input {\n  width: 136px;\n  height: 28px;\n  margin-right: -40px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  border-radius: 15px;\n  border: none;\n  outline: none;\n}\n.route__input:not(:disabled):focus {\n  outline: 2px solid rgb(137, 175, 137);\n}\n.route__input--small {\n  width: 80px !important;\n}\n.route__input--top {\n  width: 136px;\n  text-align: center;\n  margin-bottom: 10px;\n  height: 28px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  border-radius: 15px;\n  border: none;\n}\n.route__input--middle {\n  width: 155px;\n}\n.route__section {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n\n.section-logs {\n  width: 100%;\n  background: white;\n  border-radius: 0 5px 5px 5px;\n  padding: 5px;\n  margin-bottom: 8px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.section-logs__title {\n  text-align: center;\n  margin-bottom: 10px;\n  color: #447e9b;\n}\n.section-logs__list {\n  height: 85px;\n  overflow-y: scroll;\n}\n.section-logs__input {\n  padding-left: 10px;\n}\n.section-logs__item {\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 18px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(87, 87, 87);\n  margin-bottom: 5px;\n}\n.section-logs__item--system {\n  color: rgb(137, 175, 137);\n}\n.section-logs__item--error {\n  color: rgb(210, 66, 66);\n}\n.section-logs__item--pause {\n  color: #51a5e3;\n}\n.section-logs__comment {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 30px;\n}\n.section-logs__input {\n  width: 350px;\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n.section-finish__cancel {\n  margin-right: 30px;\n}\n.section-finish__delete:hover {\n  color: red !important;\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued {\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment__prev {\n  overflow-y: scroll;\n  background: rgb(255, 255, 255);\n  height: 100%;\n  width: 100%;\n}\n.comment__item {\n  color: rgb(66, 66, 66);\n  font-size: 17px;\n  border-bottom: 1px solid black;\n}\n\n.confirm__title {\n  font-size: 20px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  margin-top: 10px;\n  text-align: center;\n  color: rgb(66, 66, 66);\n  margin-bottom: 25px;\n}\n.confirm__section {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.confirm__button {\n  margin-bottom: 10px;\n}\n.confirm__button--ok {\n  margin-right: 25px;\n}\n.confirm__button--search {\n  margin-top: 20px;\n}\n\n.progress-block {\n  width: 180px;\n}\n\n.quantity-block {\n  display: flex;\n  justify-content: space-between;\n}\n.quantity-block--rel {\n  position: relative;\n}\n.quantity-block__labels {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.quantity-block__label {\n  margin-right: 47px;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 17px;\n  letter-spacing: 0em;\n  text-align: center;\n}\n.quantity-block__issued {\n  position: relative;\n  right: -5px;\n}\n.quantity-block__inshifts {\n  margin-right: 44px;\n  position: relative;\n  right: 10px;\n}\n\n.route-type__paused {\n  border: 2px solid #51a5e3;\n}\n.route-type__error {\n  border: 2px solid rgb(210, 66, 66);\n}\n.route-type__start {\n  border: 2px solid #e06c00;\n}\n.route-type__finish {\n  border: 2px solid rgb(0, 130, 29);\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n}\n#route__delete:disabled:hover {\n  color: gray !important;\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgb(236, 236, 236);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.modal-error__input {\n  text-align: left !important;\n}\n.modal-error__input {\n  padding-left: 10px;\n  margin-top: 20px;\n  height: 28px;\n  margin-right: 0;\n  width: 90%;\n  margin-bottom: 15px;\n  background: rgb(255, 255, 255);\n}\n.modal-error__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-issued__date {\n  margin-bottom: 10px;\n  margin-right: 0;\n}\n.modal-issued__input {\n  margin-right: 0;\n  width: 20%;\n  height: 28px;\n  margin-bottom: 15px;\n}\n.modal-issued__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.user__block {\n  margin-right: 40px;\n}\n\n.endtime__block {\n  margin-right: 107px;\n}\n\n.start-route__btn {\n  color: rgb(224, 108, 0);\n}\n\n.end-route__btn {\n  color: rgb(0, 130, 29);\n}\n\n.pause-route__btn {\n  color: #51a5e3;\n}\n\n.error-route__btn {\n  color: rgb(210, 66, 66);\n}\n\n.section-report {\n  justify-content: left;\n}\n\n.issued-modal_trigger {\n  margin-right: 75px;\n}\n\n.send__comment {\n  width: 130px;\n  border: 2px solid rgb(105, 135, 105);\n  color: rgb(105, 135, 105);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n\n.section-finish__sub {\n  border-radius: 15px;\n  width: 130px;\n  height: 40px;\n  border: none;\n  background: rgb(105, 135, 105);\n  color: rgb(255, 255, 255);\n}\n.section-finish__sub--route:disabled {\n  color: black;\n}\n.section-finish__delete {\n  border: none;\n  background: none;\n  color: rgb(210, 66, 66);\n  cursor: pointer;\n}\n\n.issued-top {\n  display: flex;\n  align-items: center;\n}\n.issued-top__item {\n  padding: 5px 0;\n  width: 39%;\n}\n.issued-top__item:not(:last-child) {\n  border-right: 1px solid black;\n}\n.issued-top__item--date {\n  width: 120px;\n}\n.issued-top__item--summary {\n  width: 80px;\n}\n\n.logs-filter {\n  border-radius: 15px;\n  display: flex;\n}\n.logs-filter__button {\n  padding: 3px;\n  background-color: rgb(255, 255, 255);\n  transition: color 0.3s linear;\n  cursor: pointer;\n}\n.logs-filter__button:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s linear;\n}\n.logs-filter__button--current {\n  color: rgb(137, 175, 137);\n}\n\n.modal__shift-block {\n  width: 130px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n}\n\n.modal_content--comments {\n  width: 612px;\n}\n\n.comments__title {\n  font-size: 20px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(255, 255, 255);\n  margin-left: 31px;\n}\n.comments-content {\n  padding: 24px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  background: rgb(236, 236, 236);\n  border-radius: 15px;\n}\n.comments__add {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.comments-list {\n  height: 90px;\n  padding: 7px 10px;\n  overflow-y: scroll;\n  border-radius: 15px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  background: rgb(255, 255, 255);\n}\n.comments-list__item {\n  color: rgb(107, 102, 102);\n  margin-bottom: 5px;\n  display: flex;\n  align-items: center;\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n}\n\n.comments__prev {\n  margin-bottom: 10px;\n}\n\n.comments__yours {\n  cursor: text !important;\n}\n\n.comments__yours {\n  width: 350px;\n  padding-left: 10px;\n}\n\n.modal-plan {\n  position: relative;\n}\n.modal-plan .confirm__section {\n  position: absolute;\n  bottom: 0;\n}\n\n.modal-plan {\n  padding: 5px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-plan__today {\n  text-align: center;\n  align-self: center;\n}\n.modal-plan__section {\n  width: 250px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.modal-plan__section:not(:last-child) {\n  margin-bottom: 10px;\n}\n.modal-plan__data {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__data--center {\n  justify-content: center;\n}\n.modal-plan__input {\n  width: 120px;\n}\n.modal-plan__check {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__exclude {\n  text-align: center;\n  height: 100px;\n}\n.modal-plan__exclude-option {\n  text-align: center;\n  padding: 2px;\n}\n.modal-plan__exclude-option:hover {\n  cursor: pointer;\n}\n\n.confirm__title--plan {\n  margin-bottom: 5px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.plan-period {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n}\n.plan-period__btn:not(:last-child) {\n  margin-right: 5px;\n}\n\n.plan-dates {\n  display: flex;\n  overflow-y: auto;\n  max-height: 60%;\n  margin-left: 15px;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-bottom: 10px;\n}\n.plan-dates .plan-dates__item {\n  margin-bottom: 4px;\n}\n.plan-dates__item {\n  background: rgb(255, 255, 255);\n  width: 95px;\n  transition: color 0.3s;\n  text-align: center;\n  height: 28px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.plan-dates__item--small {\n  font-size: 13px;\n  width: 34px;\n  box-shadow: none;\n  padding-bottom: 1px;\n}\n.plan-dates__item--small:not(:last-child) {\n  margin-right: 3px;\n}\n.plan-dates__item:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: #09d009;\n}\n.plan-dates__item--inplan {\n  color: white;\n  background: rgb(137, 175, 137);\n}\n.plan-dates__item--busy {\n  cursor: default !important;\n}\n.plan-dates__item--busy {\n  color: blue;\n}\n.plan-dates__item--busy:hover {\n  color: rgb(66, 66, 66);\n}\n\n.admin-panel {\n  min-width: 1200px;\n  height: 600px;\n  background: rgb(255, 255, 255);\n}\n\n.panel-nav {\n  margin-top: 10px;\n  color: rgb(107, 102, 102);\n  padding: 5px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav-navigation {\n  padding: 10px;\n  width: 350px;\n  height: 200px;\n  background: rgb(236, 236, 236);\n  border-radius: 15px;\n}\n.nav-navigation__item {\n  height: 28px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-navigation__item:not(:last-child) {\n  margin-bottom: 10px;\n}\n.nav-navigation__item--title {\n  width: 100%;\n  background: rgb(137, 175, 137);\n  border-radius: 15px;\n  text-align: center;\n  color: rgb(255, 255, 255);\n}\n.nav-navigation__text {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-navigation__text:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n\n.nav-content {\n  width: 70%;\n  min-height: 500px;\n  max-height: 500px;\n  display: flex;\n  flex-direction: column;\n  overflow-y: auto;\n}\n.nav-content__columns {\n  height: 40px;\n  padding: 10px;\n  border-radius: 15px 15px 0 0;\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-content__items {\n  padding: 10px;\n  background: rgb(236, 236, 236);\n}\n.nav-content__item {\n  min-height: 40px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-content__column {\n  min-width: 20%;\n  text-align: center;\n}\n.nav-content__column--left {\n  text-align: left !important;\n}\n.nav-content__column-name {\n  min-width: 45%;\n  width: 45%;\n}\n.nav-content__column-shortname {\n  min-width: 15%;\n  width: 15%;\n}\n.nav-content__column-hide {\n  min-width: 10%;\n  width: 10%;\n}\n\n.nav-item {\n  width: 100%;\n}\n.nav-item__column {\n  text-align: center;\n  min-width: 20%;\n}\n.nav-item__column--left {\n  text-align: left;\n}\n.nav-item__column-name {\n  min-width: 45%;\n  width: 45%;\n}\n.nav-item__column-shortname {\n  min-width: 15%;\n  width: 15%;\n}\n.nav-item__column-hide {\n  min-width: 10%;\n  width: 10%;\n}\n.nav-item__column--edit {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-item__column--edit:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.nav-item__pos {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-item__pos:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n\n.edit-form {\n  align-self: center;\n  width: 726px;\n  display: flex;\n  justify-content: space-between;\n  background: rgb(236, 236, 236);\n  padding: 25px;\n  border-radius: 15px;\n  position: relative;\n}\n.edit-form--group {\n  width: 300px;\n  height: 320px;\n}\n.edit-form--group .edit-form__user {\n  border-right: none;\n  width: 100%;\n  height: 100%;\n}\n.edit-form__text {\n  padding: 10px;\n  width: 250px;\n  height: 100px;\n  resize: none;\n  cursor: pointer;\n}\n.edit-form__user {\n  width: 50%;\n  border-right: 1px solid rgb(107, 102, 102);\n}\n.edit-form__block {\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 15px;\n  width: 251px;\n}\n.edit-form__block--do {\n  margin-top: 20px;\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n}\n.edit-form__block--checker {\n  flex-direction: row;\n  justify-content: space-between;\n}\n.edit-form__label {\n  font-size: 18px;\n  font-weight: 400;\n  line-height: 30px;\n  letter-spacing: 0em;\n}\n.edit-form__label--checker {\n  flex-direction: row;\n  margin-right: 168px;\n}\n.edit-form__input {\n  width: 250px !important;\n  height: 28px !important;\n  margin-bottom: 0 !important;\n}\n.edit-form__input {\n  padding: 5px 5px 5px 10px;\n  cursor: text;\n}\n.edit-form__group {\n  cursor: pointer !important;\n}\n.edit-form__group {\n  transition: color 0.3s;\n}\n.edit-form__group:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.edit-form__plot {\n  cursor: pointer !important;\n}\n.edit-form__plot {\n  transition: color 0.3s;\n}\n.edit-form__plot:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.edit-form__submit {\n  cursor: pointer;\n}\n.edit-form__succ {\n  position: absolute;\n  color: rgb(137, 175, 137);\n}\n.edit-form__succ--user {\n  bottom: 70px;\n  left: 25px;\n}\n.edit-form__succ--filter {\n  bottom: 80px;\n  left: 27px;\n}\n.edit-form__succ--group {\n  bottom: 80px;\n  left: 27px;\n}\n\n.main-table__header {\n  display: flex;\n  align-items: center;\n  position: sticky;\n  z-index: 10;\n  top: 0;\n  width: 100%;\n}\n.main-table__item {\n  display: flex;\n  align-items: center;\n}\n.main-table__item-form {\n  color: rgb(107, 102, 102);\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\ninput.table__data--compl {\n  background: green;\n  color: white;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table__cell {\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 18px;\n  letter-spacing: 0em;\n  text-align: left;\n  height: 28px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  cursor: default;\n  border-top: 1px solid rgb(203, 203, 203);\n  border-bottom: 1px solid rgb(203, 203, 203);\n  background: white;\n  color: rgb(0, 0, 0);\n}\n.table__cell:not(:last-child) {\n  border-right: 1px solid rgb(203, 203, 203);\n}\n.table__cell--top {\n  background: rgb(156, 156, 156) !important;\n}\n.table:last-child {\n  border-right: none;\n}\n.table__use label {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.table__use label:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.table__data {\n  font-size: 14px;\n  font-weight: 400;\n  height: 28px;\n  width: 100%;\n  text-align: center;\n  border-radius: 1px;\n  border: none;\n  background: transparent;\n  color: inherit;\n  outline: 3.3px #447e9b;\n  position: relative;\n}\n.table__data--ro {\n  cursor: default;\n  outline: none;\n}\n.table__data--chosen {\n  background: rgb(217, 221, 217);\n  color: rgb(0, 0, 0);\n}\n.table__data--opened {\n  height: 56px;\n  font-size: 15px;\n  background: rgb(217, 221, 217);\n  color: rgb(0, 0, 0);\n  border-bottom: 1px solid rgb(203, 203, 203);\n}\n.table__data--current {\n  font-weight: 600;\n  color: rgb(0, 0, 0);\n  border: 2px solid black;\n}\n.table__db {\n  display: flex;\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__timestamp {\n  min-width: 110px;\n  max-width: 110px;\n}\n.table__files {\n  min-width: 45px;\n  max-width: 45px;\n  position: relative;\n}\n.table__number {\n  min-width: 120px;\n  max-width: 120px;\n}\n.table__sample {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table__client {\n  min-width: 160px;\n  max-width: 160px;\n}\n.table__name {\n  min-width: 260px;\n  max-width: 260px;\n}\n.table__material {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__quantity {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued {\n  border-right: 1px solid rgb(203, 203, 203) !important;\n}\n.table__issued {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued--done {\n  color: green;\n  font-size: 16px;\n  font-weight: 600;\n}\n.table__complete {\n  border-right: none !important;\n}\n.table__complete {\n  border-top: 1px solid rgb(203, 203, 203);\n  border-bottom: 1px solid rgb(203, 203, 203);\n}\n.table__complete input {\n  height: 26px;\n}\n.table__m {\n  min-width: 36px;\n  max-width: 36px;\n}\n.table__endtime {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__endtime--dead {\n  color: red;\n  font-size: 15px;\n}\n.table__route {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 29px;\n  width: 50px;\n}\n.table__route:last-child {\n  border-right: 1px solid rgb(203, 203, 203) !important;\n}\n.table__routes {\n  min-width: 500px;\n  max-width: 500px;\n}\n.table__p {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table-p-select, .table-m-select {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  cursor: pointer;\n}\n.table__comment {\n  flex-grow: 1;\n  min-width: 200px;\n  max-width: 100%;\n}\n.table__comment--top {\n  flex-grow: 1;\n  min-width: 200px;\n  max-width: 100%;\n}\n.table-routes__wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 28px;\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body_cell {\n  max-height: 56px;\n  font-size: 16px;\n  border-right: 1px solid rgb(203, 203, 203);\n  border-bottom: 1px solid rgb(203, 203, 203);\n  position: relative;\n}\n.table-body_cell:last-child {\n  border-right: none;\n}\n.table-body_cell--opened {\n  height: 56px;\n}\n.table-body_cell--flex {\n  display: flex;\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n  50% {\n    background: green;\n    color: white;\n  }\n  100% {\n    background: white;\n    color: black;\n  }\n}\n.table__route:first-child {\n  border-left: none;\n}\n.table__route--date {\n  flex-grow: 1;\n}\n.table__route--issued {\n  border-top: none;\n  max-height: 28px;\n}\n.table__route--issued:last-child {\n  border-right: 1px solid rgb(203, 203, 203);\n}\n.table__route--issued:first-child {\n  border-left: none;\n}\n.table__route--issued input {\n  height: 26px;\n}\n\n.route {\n  color: rgb(107, 102, 102);\n  height: 24px;\n  width: 48px;\n  border-radius: 15px;\n  border: 2px solid transparent;\n}\n.route--inplan {\n  background: rgb(181, 173, 173);\n}\n.route--inplan .route {\n  background: white;\n  border-radius: 15px;\n}\n.route--paused {\n  border: 2px solid #51a5e3;\n  background: white;\n}\n.route--error {\n  color: white !important;\n  background: rgb(210, 66, 66) !important;\n}\n.route--started {\n  background: white !important;\n}\n.route--started {\n  border: 2px solid #e06c00;\n}\n.route--completed {\n  background: white !important;\n}\n.route--completed {\n  border: 2px solid rgb(0, 130, 29);\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__copy {\n  background: rgb(156, 156, 156) !important;\n}\n\n.order__copy {\n  width: 10px;\n  border: none;\n  color: rgb(66, 66, 66);\n  transition: color 0.3s;\n}\n.order__copy:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: white;\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color 0.3s;\n}\n.order__delete:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: white;\n}\n\n.table__issued--report {\n  min-width: 105px;\n  max-width: 105px;\n}\n.table__plan--report {\n  min-width: 105px;\n  max-width: 105px;\n}\n.table__plan--shift {\n  min-width: 73px;\n  max-width: 73px;\n}\n.table__plan--need-shift {\n  min-width: 100px;\n  max-width: 100px;\n}\n.table__plan--adj {\n  min-width: 90px;\n  max-width: 90px;\n}\n.table__plan--theoradj {\n  min-width: 100px;\n  max-width: 100px;\n}\n.table__plan--percent {\n  min-width: 80px;\n  max-width: 80px;\n}\n.table__shift--report {\n  min-width: 75px;\n  max-width: 75px;\n}\n.table__route--report {\n  min-width: 75px;\n  max-width: 75px;\n}\n.table__route--date__list {\n  display: flex;\n  align-items: center;\n}\n.table__route--date__item {\n  margin-right: 5px;\n  height: 28px;\n}\n.table__operator--report {\n  min-width: 95px;\n  max-width: 95px;\n}\n.table__issued-plan--report {\n  min-width: 120px;\n  max-width: 120px;\n}", "",{"version":3,"sources":["webpack://./web/src/static/css/table/table.scss","webpack://./web/src/static/css/main.scss","webpack://./web/src/static/css/var.scss","webpack://./web/src/static/css/table/top_filters.scss","webpack://./web/src/static/css/table/table_nav.scss","webpack://./web/src/static/css/table/files_modal.scss","webpack://./web/src/static/css/table/route_modal.scss","webpack://./web/src/static/css/table/comments_modal.scss","webpack://./web/src/static/css/table/planModal.scss","webpack://./web/src/static/css/table/adminPanel.scss"],"names":[],"mappings":"AAAA,gBAAgB;ACEhB;EACE,UAAA;EACA,SAAA;EACA,sBAAA;EAEA,iCAAA;ADDF;;ACIA;;EAEE,aAAA;EACA,wBAAA;EACA,SAAA,EAAA,uEAAA;ADDF;;ACIA;EACE,0BAAA;ADDF;;ACIA;;EAEE,8CAAA;EACA,wBAAA;EACA,SAAA,EAAA,uEAAA;ADDF;;ACIA;EACE,aAAA;EAEA,iCAAA;ADFF;;ACKA;EACE,YAAA;EAEA,iCAAA;ADHF;;ACMA;EAGE,iCAAA;EACA,8BAAA;EACA,WAAA;ADLF;;ACQA;EACE,eAAA;EACA,WAAA;ADLF;;ACQA;EACE,gBAAA;ADLF;;ACQA;EACE,wBAAA;EACA,6BAAA;ADLF;;ACQA;EACE,wBAAA;EACA,6BAAA;ADLF;;ACQA;EACE,sBCtDW;EDuDX,WAAA;ADLF;ACUI;EADF;IAEI,mBAAA;IACA,aAAA;EDPJ;AACF;ACUE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,YAAA;EACA,kBAAA;EACA,uBAAA;EACA,kBAAA;EACA,iBAAA;EACA,sBC3ES;ED4ET,sBAAA;EACA,eAAA;EACA,YAAA;ADRJ;ACUI;EACE,yBC/FO;EDgGP,sBAAA;ADRN;ACWI;EAQE,yCAAA;ADNN;ACFI;EACE,aAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EAGA,yBC5GO;ED6GP,eAAA;EACA,gBAAA;EACA,YAAA;ADVN;ACaI;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EACA,mBAAA;EACA,oCCtHO;EDuHP,+CCxHO;EDyHP,iBAAA;EACA,sBC9GO;ED+GP,eAAA;EACA,gBAAA;ADXN;ACeE;EACE,YAAA;EACA,YAAA;EACA,uBAAA;EACA,kBAAA;EACA,sBCzHS;AF4Gb;ACgBE;EACE,WAAA;EACA,YAAA;EACA,cAAA;EACA,kBAAA;EAIA,yCC/IS;EDgJT,0CChJS;EDiJT,2CCjJS;EDkJT,gDAAA;EACA,iBAAA;ADjBJ;AC+BI;EACE,kBAAA;EACA,gBAAA;AD7BN;ACiCE;EACE,6BAAA;AD9BJ;AC6BE;EAEE,WAAA;AD/BJ;;ACmCA;EACE,uBAAA;ADhCF;;ACmCA;EACE,qBAAA;ADhCF;;ACmCA;EACE,yBAAA;AD/BF;;AC8BA;EAEE,kBAAA;ADhCF;;ACmCA;;EAEE,0BAAA;ADhCF;;ACmCA;;;EAGE,6BAAA;EAAA,qBAAA;EACA,WAAA;ADhCF;;ACmCA;EACE,eAAA;EACA,gBAAA;EACA,WAAA;ADhCF;ACkCE;EACE,WAAA;ADhCJ;;ACoCA;EACE,eAAA;EACA,WAAA;ADjCF;;ACqCA;EACE,YAAA;EACA,gBAAA;ADlCF;;ACqCA;EACE,eAAA;EACA,WAAA;ADlCF;ACoCE;EACE,WAAA;ADlCJ;;ACsCA;EACE,eAAA;EACA,WAAA;ADnCF;ACqCE;EACE,WAAA;ADnCJ;;ACuCA;EACE,mBAAA;EACA,YAAA;EACA,kBAAA;ADpCF;;ACwCE;EACE,aAAA;EACA,kBAAA;ADrCJ;ACwCE;EACE,gBAAA;ADtCJ;ACyCE;EACE,uBAAA;ADvCJ;AC0CE;EACE,uBAAA;EACA,aAAA;EACA,YAAA;ADxCJ;;AC6CE;EACE,YAAA;EACA,sBAAA;EACA,kBAAA;EACA,WAAA;AD1CJ;AC4CI;EACE,sBAAA;EACA,cC9PO;AFoNb;AC8CE;EACE,kBAAA;AD5CJ;AC+CE;EACE,sBAAA;AD7CJ;AC+CI;EACE,sBAAA;EACA,sBCnRO;AFsOb;;ACkDA;EACE,kBAAA;EACA,aAAA;AD/CF;;ACmDA;EACE,aAAA;EACA,mBAAA;ADhDF;ACkDE;EAJF;IAKI,aAAA;ED/CF;AACF;;ACkDA;EACE,kBAAA;AD/CF;;ACkDA;EACE,kBAAA;AD/CF;;ACkDA;EACE,kBAAA;EACA,eAAA;EACA,kBAAA;EACA,eAAA;EAEA,YAAA;EAGA,oCAAA,EAAA,6BAAA;EACA,eAAA,EAAA,4BAAA;EACA,gBAAA,EAAA,SAAA;EACA,kBAAA;EAEA,gDAAA;ADnDF;ACsDE;EACE,eAAA;ADpDJ;ACuDE;EACE,UAAA;EACA,YAAA;ADrDJ;;ACyDA;EACE,aAAA;EACA,mBAAA;ADtDF;;ACyDA;EACE,aAAA;EACA,mBAAA;ADtDF;;ACyDA;EACE,aAAA;EACA,mBAAA;ADtDF;;ACyDA;EACE,kBAAA;ADtDF;;ACyDA;EACE,WAAA;EACA,qBAAA;ADtDF;AC8DA;EACE,iBAAA;AD5DF;;AC+DA;EACE,kBAAA;AD5DF;AC8DE;EACE,kBAAA;EACA,YAAA;EACA,UAAA;AD5DJ;;ACkEA;EACE,kBAAA;EACA,YAAA;EACA,WAAA;AD/DF;;ACkEA;EACE,kBAAA;AD/DF;ACiEE;EACE,oCAAA;EACA,yBAAA;EACA,8BAAA;AD/DJ;;ACmEA;EAME,kCAAA;ADjEF;;AC2DA;EAEE,UAAA;EACA,WAAA;EACA,YAAA;EACA,UAAA;ADhEF;;AC2EA;EACE;IACE,yBAAA;EDxEF;AACF;AC2EA;EACE;IACE,wBAAA;IACA,oBAAA;EDzEF;EC2EA;IACE,yBAAA;IACA,sBAAA;EDzEF;EC2EA;IACE,yBAAA;IACA,uBAAA;EDzEF;AACF;AC4EA;EACE,uCAAA;EACA,uBAAA;AD1EF;;AC6EA;EACE,yBAAA;EACA,0BAAA;EACA,2BAAA;AD1EF;;AC6EA;EACE,yBAAA;AD1EF;;AC6EA;EACE,kBAAA;AD1EF;;AC6EA;EACE,0BAAA;ADzEF;;ACwEA;EAEE,6BAAA;AD1EF;AC4EE;EACE,yBCldS;EDmdT,6BAAA;AD1EJ;;AGzYA;EACE,UAAA;EACA,kBAAA;EACA,aAAA;EACA,iBAAA;EACA,gDAAA;EAGA,oCDLW;ECMX,mBAAA;EACA,iBAAA;EAEA,aAAA;EACA,sBAAA;AHyYF;AGvYE;EAfF;IAgBI,UAAA;EH0YF;AACF;AGxYE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;AH0YJ;AGlYE;EACE,kBAAA;AHoYJ;AGlYI;EACE,kBAAA;AHoYN;AG/XI;EACE,8BDxCO;ECyCP,yBD1BO;AF2Zb;;AGrXE;EACE,WAAA;EACA,eAAA;EACA,YAAA;EACA,mBAAA;AHwXJ;AGrXE;EACE,gBAAA;EACA,2CD3DS;EC4DT,kBAAA;EACA,mBAAA;AHuXJ;AGnXE;EAIE,2BAAA;AHsXJ;AG1XE;EACE,eAAA;EACA,YAAA;EACA,eAAA;EAEA,gBAAA;AHqXJ;AGlXE;EACE,kBAAA;EACA,aAAA;EACA,YAAA;EACA,cAAA;EACA,kBAAA;AHoXJ;;AGhXA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;EACA,gBAAA;AHmXF;;AGhXA;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EAEA,oCD/FW;ECgGX,mBAAA;EACA,uBAAA;EACA,iBAAA;EACA,gDAAA;AHkXF;AGhXE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AHkXJ;AG/WE;EACE,aAAA;EACA,YAAA;EACA,kBAAA;EACA,QAAA;EACA,MAAA;AHiXJ;AG9WE;EACE,aAAA;EAEA,mBAAA;EACA,8BAAA;EACA,2CAAA;EACA,kBAAA;AH+WJ;AG5WE;EACE,YAAA;AH8WJ;AG3WE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,eAAA;EACA,sBAAA;EACA,yBDhIQ;AF6eZ;AG3WI;EACE,sBAAA;EACA,yBDhJO;AF6fb;AGzWE;EACE,aAAA;EACA,kBAAA;AH2WJ;AGxWE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,uBAAA;EACA,iBAAA;AH0WJ;AGtWI;EACE,uBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AHwWN;AGpWE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;EACA,yBDlLS;AFwhBb;AGlWQ;EACE,WAAA;AHoWV;AG9VE;EACE,mBAAA;EACA,kBAAA;EACA,aAAA;EACA,sBAAA;EACA,qBAAA;EACA,2CAAA;AHgWJ;AG3VI;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,eAAA;EACA,yBDlMM;AF+hBZ;AG3VM;EACE,yBDjNK;AF8iBb;AG1VM;EACE,kCAAA;EAAA,0BAAA;EACA,yBDtNK;AFkjBb;AGvVE;EACE,kBAAA;EACA,SAAA;EACA,eAAA;AHyVJ;AGvVI;EACE,cAAA;EACA,WAAA;EACA,WAAA;EACA,8BDxNM;ECyNN,mBAAA;AHyVN;AGvVM;EACE,kBAAA;AHyVR;;AG9UE;EACE,0BAAA;EAEA,uBAAA;EACA,uBAAA;AHiVJ;;AGrVE;EAEE,iBAAA;AHmVJ;;AItkBA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,8BFNW;EEQX,oCFLW;EEMX,mBAAA;EACA,4BAAA;EACA,iBAAA;EACA,YAAA;AJwkBF;AIrkBE;EAEE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,yBFRS;EEST,kBAAA;AJskBJ;AI3jBE;EACE,aAAA;EACA,mBAAA;AJ6jBJ;AIzjBE;EACE,sBAAA;AJ2jBJ;AIzjBI;EACE,sBAAA;EACA,yBF9CO;AFymBb;AIxjBI;EACE,kBAAA;AJ0jBN;;AInjBI;EACE,kBAAA;AJsjBN;AIjjBI;EACE,YAAA;AJmjBN;;AI9iBA;EACE,uBAAA;AJkjBF;;AInjBA;EAEE,iBAAA;AJijBF;;AI9iBA;EACE,YAAA;EACA,iBAAA;AJijBF;;AI9iBA;EACE,oCAAA;EACA,yBFlEW;EEmEX,8BFlFW;AFmoBb;;AKnoBA;EACE,aAAA;EACA,uBAAA;EACA,eAAA;EACA,MAAA;EACA,OAAA;EACA,SAAA;EACA,QAAA;EACA,YAAA;ALsoBF;AKpoBE;EACE,aAAA;EACA,sBAAA;EACA,YAAA;EACA,YAAA;EACA,gDAAA;EACA,mBAAA;EACA,8BAAA;ALsoBJ;AKpoBI;EACE,YAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,WAAA;ALsoBN;AKloBE;EACE,WAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,YAAA;EACA,8BHlCS;EGmCT,yBHpBS;EGqBT,kBAAA;EACA,YAAA;EACA,gCAAA;ALooBJ;AKjoBE;EACE,aAAA;EACA,mBAAA;EACA,eAAA;EACA,uBAAA;EACA,WAAA;EACA,aAAA;EAEA,2BAAA;EACA,8BAAA;EACA,yBHnDS;EGoDT,8BHrCS;AFuqBb;;AK9nBA;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;ALioBF;;AK9nBA;EACE,gBAAA;ALioBF;;AK7nBA;EACE,aAAA;EACA,aAAA;EACA,aAAA;EACA,kBAAA;EACA,8BAAA;EACA,eAAA;EACA,mBAAA;ALgoBF;AK9nBE;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EACA,oBAAA;ALgoBJ;;AK5nBA;EACE,cAAA;EACA,YAAA;EACA,aAAA;EACA,mBAAA;AL+nBF;;AK3nBE;EACE,YAAA;EACA,aAAA;AL8nBJ;AK1nBE;EAOE,oCAAA;AL6nBJ;AKpoBE;EACE,eAAA;EACA,kBAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,WAAA;EAEA,sBAAA;AL4nBJ;AK1nBI;EAEE,uBAAA;AL6nBN;AK/nBI;EACE,eAAA;EAEA,sBAAA;AL4nBN;AKxnBE;EAKE,oCAAA;AL6nBJ;AKloBE;EACE,eAAA;EACA,QAAA;EACA,UAAA;EACA,kBAAA;EAEA,eAAA;EACA,wBAAA;EACA,sBAAA;AL0nBJ;AKxnBI;EAEE,qBAAA;AL2nBN;AK7nBI;EACE,eAAA;EAEA,sBAAA;AL0nBN;AKrnBE;EAIE,oCAAA;ALwnBJ;AK5nBE;EACE,kBAAA;EACA,QAAA;EACA,SAAA;EAEA,sBAAA;ALunBJ;AKrnBI;EAEE,uBAAA;ALwnBN;AK1nBI;EACE,eAAA;EAEA,sBAAA;ALunBN;AKnnBE;EACE,sBHtIS;EGuIT,qBAAA;EACA,kBAAA;ALqnBJ;AKlnBE;EACE,kBAAA;EACA,YAAA;EACA,mBAAA;ALonBJ;;AMhxBA;EACE,YAAA;EACA,YAAA;ANmxBF;;AM/wBE;EACE,oBAAA;EACA,8BAAA;EACA,gDAAA;ANkxBJ;AM/wBE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,sBJHS;AFoxBb;AM7wBI;EACE,aAAA;EACA,mBAAA;EACA,mBAAA;AN+wBN;AM3wBE;EACE,aAAA;EACA,sBAAA;AN6wBJ;AMzwBI;EACE,eAAA;AN2wBN;AMnwBE;EAEE,0DAAA;EACA,0BAAA;ANswBJ;AMzwBE;EACE,oCAAA;EAGA,sBJjCS;AFsyBb;AMlwBE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;ANowBJ;AMjwBE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,WAAA;EACA,oCAAA;EACA,+CAAA;EACA,mBAAA;ANmwBJ;AMhwBE;EACE,YAAA;EACA,mBAAA;EACA,YAAA;EACA,kBAAA;EACA,+CAAA;EACA,8BAAA;ANkwBJ;AMhwBI;EACE,8BAAA;ANkwBN;AM9vBE;EAEE,0DAAA;EACA,0BAAA;EAEA,0BAAA;ANiwBJ;AMtwBE;EACE,oCAAA;EAGA,sBJxES;EI0ET,6BAAA;ANgwBJ;AM9vBI;EACE,6BAAA;EACA,eAAA;EACA,yBJ7FO;AF61Bb;AM5vBE;EACE,YAAA;EACA,YAAA;EACA,mBAAA;EACA,qDAAA;EACA,mBAAA;EACA,YAAA;EACA,aAAA;AN8vBJ;AM3vBM;EACE,qCAAA;AN6vBR;AMzvBI;EACE,sBAAA;AN2vBN;AMpvBI;EACE,YAAA;EACA,kBAAA;EACA,mBAAA;EACA,YAAA;EACA,qDAAA;EACA,mBAAA;EACA,YAAA;ANsvBN;AMnvBI;EACE,YAAA;ANqvBN;AMjvBE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;ANmvBJ;;AM3uBA;EACE,WAAA;EACA,iBAAA;EACA,4BAAA;EACA,YAAA;EACA,kBAAA;EACA,gDAAA;AN8uBF;AM5uBE;EACE,kBAAA;EACA,mBAAA;EACA,cJvIW;AFq3Bf;AM3uBE;EACE,YAAA;EACA,kBAAA;AN6uBJ;AM1uBE;EACE,kBAAA;AN4uBJ;AMzuBE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,sBAAA;EACA,kBAAA;AN2uBJ;AMzuBI;EACE,yBJpLO;AF+5Bb;AMxuBI;EACE,uBAAA;AN0uBN;AMvuBI;EACE,cAAA;ANyuBN;AMruBE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;ANuuBJ;AMpuBE;EACE,YAAA;ANsuBJ;;AMluBA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;ANquBF;AMnuBE;EACE,kBAAA;ANquBJ;AMjuBI;EACE,qBAAA;ANmuBN;;AM9tBA;;;;;;EAOE,kBAAA;ANguBF;;AM7tBA;;EAEE,YAAA;ANguBF;;AM7tBA;EACE,YAAA;EACA,aAAA;ANguBF;;AM5tBE;EAEE,kBAAA;EACA,8BJtOS;EIuOT,YAAA;EACA,WAAA;AN8tBJ;AM1tBE;EACE,sBJ9OS;EI+OT,eAAA;EAGA,8BAAA;AN0tBJ;;AMrtBE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,kBAAA;EACA,sBJ9PS;EI+PT,mBAAA;ANwtBJ;AMrtBE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;ANutBJ;AMptBE;EASE,mBAAA;AN8sBJ;AMttBI;EACE,kBAAA;ANwtBN;AMrtBI;EACE,gBAAA;ANutBN;;AMhtBA;EACE,YAAA;ANmtBF;;AMhtBA;EACE,aAAA;EACA,8BAAA;ANmtBF;AMjtBE;EACE,kBAAA;ANmtBJ;AMhtBE;EACE,aAAA;EACA,uBAAA;EACA,mBAAA;ANktBJ;AM/sBE;EACE,kBAAA;EACA,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,kBAAA;ANitBJ;AM9sBE;EACE,kBAAA;EACA,WAAA;ANgtBJ;AMzsBE;EACE,kBAAA;EACA,kBAAA;EACA,WAAA;AN2sBJ;;AMtsBE;EAEE,yBAAA;ANwsBJ;AMrsBE;EAEE,kCAAA;ANssBJ;AMnsBE;EAEE,yBAAA;ANosBJ;AMjsBE;EAEE,iCAAA;ANksBJ;;AM9rBA;EACE,eAAA;EACA,WAAA;ANisBF;AM/rBE;EACE,sBAAA;ANisBJ;;AM7rBA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,8BAAA;EACA,gDAAA;ANgsBF;AM9rBE;EAIE,2BAAA;ANosBJ;AMxsBE;EACE,kBAAA;EACA,gBAAA;EACA,YAAA;EAEA,eAAA;EACA,UAAA;EACA,mBAAA;EACA,8BJ7WS;AF6iCb;AM7rBE;EACE,gBAAA;EACA,mBAAA;AN+rBJ;;AM3rBA;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;AN8rBF;AM5rBE;EACE,mBAAA;EACA,eAAA;AN8rBJ;AM1rBE;EACE,eAAA;EACA,UAAA;EACA,YAAA;EACA,mBAAA;AN4rBJ;AMzrBE;EACE,gBAAA;EACA,mBAAA;AN2rBJ;;AMvrBA;EACE,kBAAA;AN0rBF;;AMvrBA;EACE,mBAAA;AN0rBF;;AMvrBA;EACE,uBAAA;AN0rBF;;AMvrBA;EACE,sBAAA;AN0rBF;;AMvrBA;EACE,cAAA;AN0rBF;;AMvrBA;EACE,uBAAA;AN0rBF;;AMvrBA;EACE,qBAAA;AN0rBF;;AMvrBA;EACE,kBAAA;AN0rBF;;AMvrBA;EACE,YAAA;EACA,oCAAA;EACA,yBAAA;EACA,+CAAA;EACA,mBAAA;AN0rBF;;AMtrBE;EACE,mBAAA;EACA,YAAA;EACA,YAAA;EACA,YAAA;EACA,8BAAA;EACA,yBJ7bS;AFsnCb;AMvrBI;EACE,YAAA;ANyrBN;AMrrBE;EACE,YAAA;EACA,gBAAA;EACA,uBAAA;EACA,eAAA;ANurBJ;;AMnrBA;EACE,aAAA;EACA,mBAAA;ANsrBF;AMprBE;EACE,cAAA;EACA,UAAA;ANsrBJ;AMprBI;EACE,6BAAA;ANsrBN;AMnrBI;EACE,YAAA;ANqrBN;AMlrBI;EACE,WAAA;ANorBN;;AM/qBA;EACE,mBAAA;EAEA,aAAA;ANirBF;AM/qBE;EACE,YAAA;EAEA,oCJ1eS;EI2eT,6BAAA;EACA,eAAA;ANgrBJ;AM9qBI;EACE,yBJ9fO;EI+fP,6BAAA;ANgrBN;AM7qBI;EACE,yBJngBO;AFkrCb;;AM1qBA;EACE,YAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AN6qBF;;AO1rCA;EACE,YAAA;AP6rCF;;AOxrCE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,yBLGS;EKFT,iBAAA;AP2rCJ;AOxrCE;EACE,aAAA;EACA,gDAAA;EACA,8BAAA;EACA,mBAAA;AP0rCJ;AOvrCE;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;APyrCJ;;AOrrCA;EACE,YAAA;EACA,iBAAA;EACA,kBAAA;EACA,mBAAA;EACA,qDAAA;EACA,8BLrBW;AF6sCb;AOtrCE;EACE,yBL3BQ;EK4BR,kBAAA;EACA,aAAA;EACA,mBAAA;APwrCJ;;AOprCA;EACE,YAAA;EACA,kBAAA;APurCF;;AOprCA;EACE,mBAAA;APurCF;;AOprCA;EAEE,uBAAA;APwrCF;;AO1rCA;EACE,YAAA;EAEA,kBAAA;APurCF;;AQjvCA;EACE,kBAAA;ARovCF;AQlvCE;EACE,kBAAA;EACA,SAAA;ARovCJ;;AQ3uCE;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,mBAAA;AR8uCJ;AQ5uCI;EACE,kBAAA;EACA,kBAAA;AR8uCN;AQ3uCI;EACE,YAAA;EACA,aAAA;EACA,sBAAA;EACA,8BAAA;AR6uCN;AQ1uCM;EACE,mBAAA;AR4uCR;AQxuCI;EACE,aAAA;EAEA,8BAAA;EACA,mBAAA;ARyuCN;AQvuCM;EACE,uBAAA;ARyuCR;AQruCI;EACE,YAAA;ARuuCN;AQpuCI;EACE,aAAA;EAEA,8BAAA;EACA,mBAAA;ARquCN;AQluCI;EACE,kBAAA;EACA,aAAA;ARouCN;AQluCM;EACE,kBAAA;EACA,YAAA;ARouCR;AQluCQ;EACE,eAAA;ARouCV;;AQ7tCA;EACE,kBAAA;ARguCF;;AQ7tCA;EACE,gBAAA;ARguCF;;AQ7tCA;EACE,aAAA;EACA,uBAAA;EACA,kBAAA;EACA,kBAAA;ARguCF;;AQ7tCA;EACE,aAAA;EACA,8BAAA;EACA,mBAAA;EAQA,mBAAA;ARytCF;AQ9tCI;EACE,iBAAA;ARguCN;;AQztCA;EACE,aAAA;EACA,gBAAA;EACA,eAAA;EAEA,iBAAA;EACA,mBAAA;EACA,eAAA;EACA,mBAAA;AR2tCF;AQxtCE;EACE,kBAAA;AR0tCJ;AQvtCE;EAGE,8BN3GS;EM8GT,WAAA;EACA,sBAAA;EACA,kBAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;ARqtCJ;AQntCI;EACE,eAAA;EACA,WAAA;EACA,gBAAA;EACA,mBAAA;ARqtCN;AQjtCM;EACE,iBAAA;ARmtCR;AQ3sCI;EACE,eAAA;EACA,sBAAA;EACA,cAAA;AR6sCN;AQlsCI;EACE,YAAA;EACA,8BNtKO;AF02Cb;AQjsCI;EAEE,0BAAA;ARmsCN;AQrsCI;EACE,WAAA;ARosCN;AQjsCM;EACE,sBNhKK;AFm2Cb;;ASj3CA;EACE,iBAAA;EACA,aAAA;EACA,8BPYW;AFw2Cb;;ASj3CA;EACE,gBAAA;EACA,yBPIU;EOFV,YAAA;EACA,WAAA;EACA,aAAA;EACA,8BAAA;ATm3CF;;ASh3CA;EACE,aAAA;EACA,YAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;ATm3CF;ASj3CE;EACE,YAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;ATm3CJ;ASj3CI;EACE,mBAAA;ATm3CN;ASh3CI;EACE,WAAA;EACA,8BPnCO;EOoCP,mBAAA;EACA,kBAAA;EACA,yBPvBO;AFy4Cb;AS92CE;EACE,eAAA;EACA,sBAAA;ATg3CJ;AS92CI;EACE,yBP/CO;EOgDP,sBAAA;ATg3CN;;AS32CA;EACE,UAAA;EACA,iBAAA;EACA,iBAAA;EACA,aAAA;EACA,sBAAA;EAEA,gBAAA;AT62CF;AS32CE;EACE,YAAA;EACA,aAAA;EACA,4BAAA;EACA,8BPlES;EOmET,yBPpDS;EOqDT,aAAA;EACA,8BAAA;EACA,mBAAA;AT62CJ;ASz2CE;EACE,aAAA;EACA,8BAAA;AT22CJ;ASx2CE;EACE,gBAAA;EACA,aAAA;EACA,8BAAA;EACA,mBAAA;AT02CJ;ASv2CE;EACE,cAAA;EACA,kBAAA;ATy2CJ;ASv2CI;EACE,2BAAA;ATy2CN;ASt2CI;EACE,cAAA;EACA,UAAA;ATw2CN;ASr2CI;EACE,cAAA;EACA,UAAA;ATu2CN;ASp2CI;EACE,cAAA;EACA,UAAA;ATs2CN;;ASh2CA;EACE,WAAA;ATm2CF;ASj2CE;EACE,kBAAA;EACA,cAAA;ATm2CJ;ASj2CI;EACE,gBAAA;ATm2CN;ASh2CI;EACE,cAAA;EACA,UAAA;ATk2CN;AS/1CI;EACE,cAAA;EACA,UAAA;ATi2CN;AS91CI;EACE,cAAA;EACA,UAAA;ATg2CN;AS71CI;EACE,eAAA;EACA,sBAAA;AT+1CN;AS71CM;EACE,yBP/IK;EOgJL,sBAAA;AT+1CR;AS11CE;EACE,eAAA;EACA,sBAAA;AT41CJ;AS11CI;EACE,sBAAA;EACA,yBP3JO;AFu/Cb;;ASv1CA;EACE,kBAAA;EACA,YAAA;EACA,aAAA;EACA,8BAAA;EACA,8BAAA;EACA,aAAA;EACA,mBAAA;EACA,kBAAA;AT01CF;ASp1CE;EACE,YAAA;EACA,aAAA;ATs1CJ;ASp1CI;EACE,kBAAA;EACA,WAAA;EACA,YAAA;ATs1CN;ASl1CE;EACE,aAAA;EACA,YAAA;EACA,aAAA;EACA,YAAA;EACA,eAAA;ATo1CJ;ASj1CE;EAEE,UAAA;EAEA,0CAAA;ATi1CJ;AS90CE;EACE,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,YAAA;ATg1CJ;AS90CI;EACE,gBAAA;EACA,mBAAA;EACA,8BAAA;EACA,mBAAA;ATg1CN;AS70CI;EACE,mBAAA;EACA,8BAAA;AT+0CN;AS30CE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;AT60CJ;AS30CI;EACE,mBAAA;EACA,mBAAA;AT60CN;ASz0CE;EAEE,uBAAA;EACA,uBAAA;EAEA,2BAAA;AT20CJ;ASh1CE;EACE,yBAAA;EAGA,YAAA;AT40CJ;ASx0CE;EACE,0BAAA;AT20CJ;AS50CE;EAEE,sBAAA;AT00CJ;ASx0CI;EACE,sBAAA;EACA,yBPrPO;AF+jDb;ASt0CE;EACE,0BAAA;ATy0CJ;AS10CE;EAEE,sBAAA;ATw0CJ;ASt0CI;EACE,sBAAA;EACA,yBP/PO;AFukDb;ASp0CE;EACE,eAAA;ATs0CJ;ASj0CE;EACE,kBAAA;EACA,yBP3QS;AF8kDb;ASj0CI;EACE,YAAA;EACA,UAAA;ATm0CN;ASh0CI;EACE,YAAA;EACA,UAAA;ATk0CN;AS/zCI;EACE,YAAA;EACA,UAAA;ATi0CN;;AAhlDE;EACE,aAAA;EACA,mBAAA;EACA,gBAAA;EACA,WAAA;EACA,MAAA;EACA,WAAA;AAmlDJ;AA9kDE;EACE,aAAA;EACA,mBAAA;AAglDJ;AA9kDI;EACE,yBEdM;AF8lDZ;;AA3kDA;EACE,eAAA;AA8kDF;AA5kDE;EACE,iBAAA;EACA,YAAA;AA8kDJ;;AA1kDA;EACE,UAAA;AA6kDF;;AAxkDE;EACE,eAAA;EACA,gBAAA;EACA,iBAAA;EACA,mBAAA;EACA,gBAAA;EACA,YAAA;EACA,aAAA;EACA,uBAAA;EACA,mBAAA;EACA,eAAA;EACA,wCEtDS;EFuDT,2CEvDS;EFwDT,iBAAA;EACA,mBE3CS;AFsnDb;AAzkDI;EACE,0CE5DO;AFuoDb;AAxkDI;EACE,yCAAA;AA0kDN;AApkDE;EACE,kBAAA;AAskDJ;AA3jDI;EACE,eAAA;EACA,sBAAA;AA6jDN;AA3jDM;EACE,yBE1FK;EF2FL,sBAAA;AA6jDR;AAxjDE;EACE,eAAA;EACA,gBAAA;EACA,YAAA;EACA,WAAA;EACA,kBAAA;EACA,kBAAA;EACA,YAAA;EACA,uBAAA;EACA,cAAA;EACA,sBAAA;EACA,kBAAA;AA0jDJ;AAxjDI;EACE,eAAA;EACA,aAAA;AA0jDN;AAvjDI;EAEE,8BEjGU;EFkGV,mBEpGO;AF4pDb;AArjDI;EACE,YAAA;EACA,eAAA;EACA,8BExGU;EFyGV,mBE3GO;EF4GP,2CE1HO;AFirDb;AAhjDI;EACE,gBAAA;EACA,mBErHO;EFsHP,uBAAA;AAkjDN;AA7iDE;EACE,aAAA;EACA,eAAA;EACA,eAAA;AA+iDJ;AA5iDE;EACE,gBAAA;EACA,gBAAA;AA8iDJ;AA3iDE;EACE,eAAA;EACA,eAAA;EACA,kBAAA;AA6iDJ;AA1iDE;EACE,gBAAA;EACA,gBAAA;AA4iDJ;AAziDE;EACE,eAAA;EACA,eAAA;AA2iDJ;AAxiDE;EACE,gBAAA;EACA,gBAAA;AA0iDJ;AAviDE;EACE,gBAAA;EACA,gBAAA;AAyiDJ;AAtiDE;EACE,gBAAA;EACA,gBAAA;AAwiDJ;AAriDE;EACE,eAAA;EACA,eAAA;AAuiDJ;AApiDE;EAGE,qDAAA;AAsiDJ;AAziDE;EACE,eAAA;EACA,eAAA;AAuiDJ;AApiDI;EACE,YAAA;EACA,eAAA;EACA,gBAAA;AAsiDN;AAjiDE;EACE,6BAAA;AAqiDJ;AAtiDE;EAEE,wCEvMS;EFwMT,2CExMS;AF2uDb;AAjiDI;EACE,YAAA;AAmiDN;AA/hDE;EACE,eAAA;EACA,eAAA;AAiiDJ;AA9hDE;EACE,gBAAA;EACA,gBAAA;AAgiDJ;AA9hDI;EACE,UAAA;EACA,eAAA;AAgiDN;AA5hDE;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,YAAA;EACA,WAAA;AA8hDJ;AA5hDI;EACE,qDAAA;AA8hDN;AA1hDE;EACE,gBAAA;EACA,gBAAA;AA4hDJ;AArhDE;EACE,eAAA;EACA,eAAA;AAuhDJ;AAphDE;EAEE,wBAAA;EACA,qBAAA;EACA,gBAAA;EACA,eAAA;AAqhDJ;AAlhDE;EACE,YAAA;EACA,gBAAA;EACA,eAAA;AAohDJ;AAlhDI;EACE,YAAA;EACA,gBAAA;EACA,eAAA;AAohDN;AA/gDI;EACE,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,YAAA;AAihDN;;AA5gDA;EACE,WAAA;EACA,YAAA;AA+gDF;;AAj+CE;EACE,gBAAA;EACA,eAAA;EACA,0CEzUS;EF0UT,2CE1US;EF2UT,kBAAA;AAo+CJ;AAl+CI;EACE,kBAAA;AAo+CN;AAj+CI;EACE,YAAA;AAm+CN;AAh+CI;EACE,aAAA;AAk+CN;;AA79CA;EACE;IACE,iBAAA;IACA,YAAA;EAg+CF;EA79CA;IACE,iBAAA;IACA,YAAA;EA+9CF;EA59CA;IACE,iBAAA;IACA,YAAA;EA89CF;AACF;AA19CE;EACE,iBAAA;AA49CJ;AAz9CE;EACE,YAAA;AA29CJ;AAt9CE;EACE,gBAAA;EACA,gBAAA;AAw9CJ;AAt9CI;EACE,0CE5XO;AFo1Db;AAr9CI;EACE,iBAAA;AAu9CN;AAp9CI;EACE,YAAA;AAs9CN;;AAj9CA;EACE,yBAAA;EACA,YAAA;EACA,WAAA;EACA,mBAAA;EACA,6BAAA;AAo9CF;AAl9CE;EAME,8BAAA;AA+8CJ;AA58CI;EACE,iBAAA;EACA,mBAAA;AA88CN;AAr8CE;EACE,yBAAA;EACA,iBAAA;AAu8CJ;AAl8CE;EACE,uBAAA;EACA,uCAAA;AAo8CJ;AAh8CE;EACE,4BAAA;AAm8CJ;AAp8CE;EAEE,yBAAA;AAk8CJ;AA97CE;EACE,4BAAA;AAi8CJ;AAl8CE;EAEE,iCAAA;AAg8CJ;;AA37CA;EACE,aAAA;EACA,mBAAA;AA87CF;;AA37CA;EAIE,yCAAA;AA+7CF;;AAn8CA;EACE,WAAA;EACA,YAAA;EACA,sBE3bW;EF6bX,sBAAA;AA87CF;AA57CE;EACE,eAAA;EACA,sBAAA;EACA,YAAA;AA87CJ;;AA17CA;EACE,WAAA;EACA,YAAA;EACA,eAAA;EACA,sBAAA;AA67CF;AA37CE;EACE,eAAA;EACA,sBAAA;EACA,YAAA;AA67CJ;;AAx7CE;EACE,gBAAA;EACA,gBAAA;AA27CJ;AAx7CE;EACE,gBAAA;EACA,gBAAA;AA07CJ;AAv7CE;EACE,eAAA;EACA,eAAA;AAy7CJ;AAt7CE;EACE,gBAAA;EACA,gBAAA;AAw7CJ;AAr7CE;EACE,eAAA;EACA,eAAA;AAu7CJ;AAp7CE;EACE,gBAAA;EACA,gBAAA;AAs7CJ;AAn7CE;EACE,eAAA;EACA,eAAA;AAq7CJ;AAl7CE;EACE,eAAA;EACA,eAAA;AAo7CJ;AA56CE;EACE,eAAA;EACA,eAAA;AA86CJ;AAv6CI;EACE,aAAA;EACA,mBAAA;AAy6CN;AAt6CI;EACE,iBAAA;EACA,YAAA;AAw6CN;AAp6CE;EACE,eAAA;EACA,eAAA;AAs6CJ;AAn6CE;EACE,gBAAA;EACA,gBAAA;AAq6CJ","sourcesContent":["@import \"../main\";\n@import \"top_filters\";\n@import \"table_nav\";\n@import \"files_modal\";\n@import \"route_modal\";\n@import \"comments_modal\";\n@import \"planModal\";\n@import \"adminPanel\";\n\n.main-table {\n  &__header {\n    display: flex;\n    align-items: center;\n    position: sticky;\n    z-index: 10;\n    top: 0;\n    width: 100%;\n    //border: 1px solid black;\n    //border-top: none;\n  }\n\n  &__item {\n    display: flex;\n    align-items: center;\n\n    &-form {\n      color: $text_gray;\n    }\n  }\n}\n\ninput.table__data {\n  padding: 0 10px;\n\n  &--compl {\n    background: green;\n    color: white;\n  }\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table {\n\n  &__cell {\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 18px;\n    letter-spacing: 0em;\n    text-align: left;\n    height: 28px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    cursor: default;\n    border-top: $btn_border;\n    border-bottom: $btn_border;\n    background: white;\n    color: $table_text;\n\n    &:not(:last-child) {\n      border-right: $btn_border;\n    }\n\n    &--top {\n      background: rgba(156, 156, 156, 1) !important;\n      //color: white;\n      //background: $table_bg !important;\n    }\n  }\n\n  &:last-child {\n    border-right: none;\n  }\n\n  &-form {\n\n    input {\n      //color: $button_color;\n    }\n  }\n\n  &__use {\n    label {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $main_green;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__data {\n    font-size: 14px;\n    font-weight: 400;\n    height: 28px;\n    width: 100%;\n    text-align: center;\n    border-radius: 1px;\n    border: none;\n    background: transparent;\n    color: inherit;\n    outline: 3.3px $button_color;\n    position: relative;\n\n    &--ro {\n      cursor: default;\n      outline: none;\n    }\n\n    &--chosen {\n      //font-size: 15px;\n      background: $table_bg_main;\n      color: $table_text;\n    }\n\n    &--opened {\n      height: 56px;\n      font-size: 15px;\n      background: $table_bg_main;\n      color: $table_text;\n      border-bottom: $btn_border;\n    }\n\n    //&--opened.table__data--current {\n    //  border-bottom: 2px solid black;\n    //}\n\n    &--current {\n      font-weight: 600;\n      color: $table_text;\n      border: 2px solid black;\n      //font-size: 16px;\n    }\n  }\n\n  &__db {\n    display: flex;\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__timestamp {\n    min-width: 110px;\n    max-width: 110px;\n  }\n\n  &__files {\n    min-width: 45px;\n    max-width: 45px;\n    position: relative;\n  }\n\n  &__number {\n    min-width: 120px;\n    max-width: 120px;\n  }\n\n  &__sample {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &__client {\n    min-width: 160px;\n    max-width: 160px;\n  }\n\n  &__name {\n    min-width: 260px;\n    max-width: 260px;\n  }\n\n  &__material {\n    min-width: 140px;\n    max-width: 140px;\n  }\n\n  &__quantity {\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__issued {\n    min-width: 70px;\n    max-width: 70px;\n    border-right: $btn_border !important;\n\n    &--done {\n      color: green;\n      font-size: 16px;\n      font-weight: 600;\n      //animation: issued-ready infinite 4s;\n    }\n  }\n\n  &__complete {\n    border-right: none !important;\n    border-top: $btn_border;\n    border-bottom: $btn_border;\n\n    input {\n      height: 26px;\n    }\n  }\n\n  &__m {\n    min-width: 36px;\n    max-width: 36px;\n  }\n\n  &__endtime {\n    min-width: 140px;\n    max-width: 140px;\n\n    &--dead {\n      color: red;\n      font-size: 15px;\n    }\n  }\n\n  &__route {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: 29px;\n    width: 50px;\n\n    &:last-child {\n      border-right: $btn_border !important;\n    }\n  }\n\n  &__routes {\n    min-width: 500px;\n    max-width: 500px;\n  }\n\n  &-routes__issued {\n    //border-top: 1px solid black;\n  }\n\n  &__p {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &-p-select,\n  &-m-select {\n    -webkit-appearance: none;\n    -moz-appearance: none;\n    appearance: none;\n    cursor: pointer;\n  }\n\n  &__comment {\n    flex-grow: 1;\n    min-width: 200px;\n    max-width: 100%;\n\n    &--top {\n      flex-grow: 1;\n      min-width: 200px;\n      max-width: 100%;\n    }\n  }\n\n  &-routes {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      height: 28px;\n    }\n  }\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body {\n  //&__trattr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 260%;\n  //    width: auto;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n  //\n  //&__attr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 100%;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n\n\n  &_cell {\n    max-height: 56px;\n    font-size: 16px;\n    border-right: $btn_border;\n    border-bottom: $btn_border;\n    position: relative;\n\n    &:last-child {\n      border-right: none;\n    }\n\n    &--opened {\n      height: 56px;\n    }\n\n    &--flex {\n      display: flex;\n    }\n  }\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n\n  50% {\n    background: green;\n    color: white;\n  }\n\n  100% {\n    background: white;\n    color: black;\n  }\n}\n\n.table__route {\n  &:first-child {\n    border-left: none;\n  }\n\n  &--date {\n    flex-grow: 1;\n    //overflow: auto;\n    //width: 100%;\n  }\n\n  &--issued {\n    border-top: none;\n    max-height: 28px;\n\n    &:last-child {\n      border-right: $btn_border;\n    }\n\n    &:first-child {\n      border-left: none;\n    }\n\n    input {\n      height: 26px;\n    }\n  }\n}\n\n.route {\n  color: rgb(107, 102, 102);;\n  height: 24px;\n  width: 48px;\n  border-radius: 15px;\n  border: 2px solid transparent;\n\n  &--inplan {\n    //border-top: 2px solid $text_gray;\n    //border-bottom: 2px solid $text_gray;\n    //border-right: 2px solid $text_gray;\n    //border-left: 2px solid $text_gray !important;\n    //background: rgb(197 195 195);\n    background: rgb(181 173 173);\n    //background: rgb(213 220 213);\n\n    .route {\n      background: white;\n      border-radius: 15px;\n    }\n  }\n\n  &--planned {\n    //text-decoration: underline;\n    //font-style: italic;\n  }\n\n  &--paused {\n    border: 2px solid #51a5e3;\n    background: white;\n    //color: white !important;\n    //border-radius: 15px;\n  }\n\n  &--error {\n    color: white !important;\n    background: rgba(210, 66, 66, 1) !important;\n    //border-radius: 15px;\n  }\n\n  &--started {\n    background: white !important;\n    border: 2px solid #e06c00;\n    //border-radius: 15px;\n  }\n\n  &--completed {\n    background: white !important;\n    border: 2px solid rgba(0, 130, 29, 1);\n    //border-radius: 15px;\n  }\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__copy {\n  width: 10px;\n  border: none;\n  color: $text_black;\n  background: rgb(156, 156, 156) !important;\n  transition: color .3s;\n\n  &:hover {\n    cursor: pointer;\n    transition: color .3s;\n    color: white;\n  }\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color .3s;\n\n  &:hover {\n    cursor: pointer;\n    transition: color .3s;\n    color: white;\n  }\n}\n\n.table {\n  &__issued--report {\n    min-width: 105px;\n    max-width: 105px;\n  }\n\n  &__plan--report {\n    min-width: 105px;\n    max-width: 105px;\n  }\n\n  &__plan--shift {\n    min-width: 73px;\n    max-width: 73px;\n  }\n\n  &__plan--need-shift {\n    min-width: 100px;\n    max-width: 100px;\n  }\n\n  &__plan--adj {\n    min-width: 90px;\n    max-width: 90px;\n  }\n\n  &__plan--theoradj {\n    min-width: 100px;\n    max-width: 100px;\n  }\n\n  &__plan--percent {\n    min-width: 80px;\n    max-width: 80px;\n  }\n\n  &__shift--report {\n    min-width: 75px;\n    max-width: 75px;\n  }\n\n  //&__plan--shift {\n  //  min-width: 65px;\n  //  max-width: 65px;\n  //}\n\n  &__route--report {\n    min-width: 75px;\n    max-width: 75px;\n  }\n\n  &__route--date {\n    //border-right: 1px solid black;\n    //min-width: 750px;\n\n    &__list {\n      display: flex;\n      align-items: center;\n    }\n\n    &__item {\n      margin-right: 5px;\n      height: 28px\n    }\n  }\n\n  &__operator--report {\n    min-width: 95px;\n    max-width: 95px;\n  }\n\n  &__issued-plan--report {\n    min-width: 120px;\n    max-width: 120px;\n  }\n}","@import \"var\";\n\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n  //font-family: 'Yanone Kaffeesatz', sans-serif;\n  font-family: 'Nunito', sans-serif;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  display: none;\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput[type=number] {\n  -moz-appearance: textfield;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput, select {\n  outline: none;\n  //font-family: 'Yanone Kaffeesatz', sans-serif;\n  font-family: 'Nunito', sans-serif;\n}\n\nhtml {\n  height: 100%;\n  //font-family: 'Yanone Kaffeesatz', sans-serif;\n  font-family: 'Nunito', sans-serif;\n}\n\nbody {\n  //font-family: Inter, sans-serif;\n  //font-family: 'Yanone Kaffeesatz', sans-serif;\n  font-family: 'Nunito', sans-serif;\n  background: rgba(236, 236, 236, 1);\n  height: 95%;\n}\n\n.container {\n  padding: 0 15px;\n  height: 98%;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: $text_black;\n  height: 80%;\n  //border-left: 1px solid black;\n  //border-right: 1px solid black;\n\n  &--reports {\n    @media screen and (min-width: 2025px) {\n      margin: 0 auto 15px;\n      width: 2025px;\n    }\n  }\n\n  &__button {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    height: 28px;\n    text-align: center;\n    border: 1px solid black;\n    border-radius: 5px;\n    background: white;\n    color: $text_black;\n    transition: color .3s;\n    cursor: pointer;\n    padding: 5px;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s;\n    }\n\n    &--select {\n      outline: none;\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 19px;\n      letter-spacing: 0em;\n      text-align: center;\n      //border-radius: 15px;\n      background: $table_bg !important;\n      color: $main_green;\n      cursor: pointer;\n      padding: 3px 7px;\n      border: none;\n    }\n\n    &--click {\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 19px;\n      letter-spacing: 0em;\n      text-align: center;\n      border-radius: 15px;\n      border: $btn_border;\n      box-shadow: $btn_shadow;\n      background: white;\n      color: $text_black;\n      cursor: pointer;\n      padding: 3px 7px;\n    }\n  }\n\n  &__input {\n    padding: 5px;\n    cursor: text;\n    border: 1px solid black;\n    border-radius: 5px;\n    color: $text_black;\n  }\n\n  &-table__data {\n    width: 100%;\n    height: 100%;\n    overflow: auto;\n    margin-bottom: 5px;\n    //border-left: 1px solid black;\n    //border-right: 1px solid black;\n    //border-bottom: 1px solid black;\n    border-left: $btn_border;\n    border-right: $btn_border;\n    border-bottom: $btn_border;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    background: white;\n\n    //@media screen and (max-width: 1200px) {\n    //  height: 75vh;\n    //}\n    //\n    //@media screen and (min-width: 1500px) {\n    //  height: 86vh;\n    //}\n    //\n    //@media screen and (min-width: 1920px) {\n    //  height: 86vh;\n    //}\n\n    &--reports {\n      overflow-y: scroll;\n      overflow-x: auto;\n    }\n  }\n\n  &__select {\n    text-align: center !important;\n    width: 100%;\n  }\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active, /* активная/посещенная ссылка */\na:hover, /* при наведении */\na {\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n  //background: white;\n}\n\nbutton {\n  border: none;\n  background: none;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test {\n  &__form {\n    display: none;\n    visibility: hidden;\n  }\n\n  &__list {\n    background: none;\n  }\n\n  &__item {\n    background: transparent;\n  }\n\n  &__input {\n    background: transparent;\n    outline: none;\n    border: none;\n  }\n}\n\n.admin-form {\n  &__button {\n    width: 130px;\n    transition: color .3s;\n    position: absolute;\n    right: 24px;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n\n  &__user {\n    margin-right: 10px;\n  }\n\n  &__exit {\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $text_black;\n    }\n  }\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n\n.search {\n  display: flex;\n  align-items: center;\n\n  @media screen and (max-width: 1200px) {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 100000;\n  position: absolute;\n  min-width: 100%;\n  //bottom: -33px;\n  color: black;\n\n  //background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  background: rgba(236, 236, 236, 0.9); /* Полупрозрачный цвет фона */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border-radius: 5px;\n  //border: 1px solid #333;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, .25);\n\n\n  &--long {\n    min-width: 300%;\n  }\n\n  &--errored {\n    padding: 0;\n    color: black;\n  }\n}\n\n.routes-block {\n  display: flex;\n  align-items: center;\n}\n\n.archive-block {\n  display: flex;\n  align-items: center;\n}\n\n.header-routes {\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  position: relative;\n}\n\n.loupe {\n  width: 10px;\n  transition: fill .3s;\n\n  &:hover {\n    //transition: fill .3s;\n    //fill: $main_green;\n  }\n}\n\n.planned__label {\n  margin-right: 7px;\n}\n\n.plan-divider {\n  margin-right: 15px;\n\n  &--modal {\n    position: absolute;\n    bottom: 55px;\n    left: 19px;\n    //margin-left: 15px;\n    //align-self: flex-start;\n  }\n}\n\n.plan-auto--modal {\n  position: absolute;\n  bottom: 55px;\n  left: 170px;\n}\n\n.plan-hider {\n  margin-right: 15px;\n\n  &--chosen {\n    border: 1px solid rgb(255, 255, 255);\n    color: rgb(255, 255, 255);\n    background: rgb(137, 175, 137);\n  }\n}\n\n.spinner-loader {\n  //animation: rotate 2s linear infinite;\n  z-index: 2;\n  width: 50px;\n  height: 50px;\n  fill: none;\n  background: transparent !important;\n\n  //& .path {\n  //  stroke: hsl(210, 70, 75);\n  //  stroke-linecap: round;\n  //  animation: dash 1.5s ease-in-out infinite;\n  //}\n\n}\n\n@keyframes rotate {\n  100% {\n    transform: rotate(360deg);\n  }\n}\n\n@keyframes dash {\n  0% {\n    stroke-dasharray: 1, 150;\n    stroke-dashoffset: 0;\n  }\n  50% {\n    stroke-dasharray: 90, 150;\n    stroke-dashoffset: -35;\n  }\n  100% {\n    stroke-dasharray: 90, 150;\n    stroke-dashoffset: -124;\n  }\n}\n\n.bg-red {\n  background: rgb(210, 66, 66) !important;\n  color: white !important;\n}\n\n.report-complete {\n  color: #0be50b !important;\n  font-size: 16px !important;\n  font-weight: 600 !important;\n}\n\n.not-planned {\n  color: #d4d421 !important;\n}\n\n.report-refresh {\n  margin-right: 10px;\n}\n\n.order__plot-report {\n  cursor: pointer !important;\n  transition: color .3s linear;\n\n  &:hover {\n    color: $main_green;\n    transition: color .3s linear;\n  }\n}","$main_green: rgba(137, 175, 137, 1);\n\n$btn_shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n$btn_border: 1px solid rgba(203, 203, 203, 1);\n$btn_border_color: rgba(203, 203, 203, 1);\n\n$input_shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.27) inset;\n\n$filter_green: linear-gradient(0deg, #698769, #698769);\n$filter_border: 1px solid rgba(130, 130, 130, 1);\n$current_filter_border: 2px solid rgba(217, 221, 220, 1);\n\n$text_gray: rgb(107, 102, 102);\n//$text_highgray: #424242;\n$text_black: rgba(66, 66, 66, 1);\n$text_white: rgba(255, 255, 255, 1);\n\n$table_text: rgba(0, 0, 0, 1);\n$table_bg: rgba(217, 221, 220, 1);\n$table_bg_main: rgba(217, 221, 217, 1);\n\n\n$hover_aqua: #13d9d9;\n$button_color: #447e9b;\n$gray_bg: #f3efef;",".nav-filters {\n  width: 77%;\n  position: relative;\n  height: 113px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  //border: 1px solid black;\n  border: $btn_border;\n  border-radius: 15px;\n  padding: 5px 25px;\n\n  display: flex;\n  flex-direction: column;\n\n  @media screen and (min-width: 1920px) {\n    width: 82%;\n  }\n\n  &__list {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    //&:not(:last-child) {\n    //  padding-bottom: 15px;\n    //  margin-bottom: 5px;\n    //}\n  }\n\n  &__item {\n    margin-bottom: 7px;\n\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__button {\n    &--chosen {\n      background: $main_green;\n      color: $text_white;\n    }\n  }\n}\n\n.nav-filters {\n  //&__item {\n  //  min-width: 70px;\n  //  width: auto;\n  //  height: 27px;\n  //}\n\n  &__button {\n    width: auto;\n    max-width: 100%;\n    height: 27px;\n    white-space: nowrap;\n  }\n\n  &__plots {\n    margin-top: 10px;\n    border-bottom: $btn_border;\n    margin-bottom: 6px;\n    padding-bottom: 8px;\n      //margin-bottom: 5px;\n  }\n\n  &__filters {\n    flex-wrap: wrap;\n    height: 50px;\n    margin-top: 7px;\n    margin-bottom: 0 !important;\n    overflow-y: auto;\n  }\n\n  &__reset {\n    position: absolute;\n    bottom: -28px;\n    width: 161px;\n    display: block;\n    align-self: center;\n  }\n}\n\n.nav {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  margin-top: 10px;\n}\n\n.nav-control {\n  position: relative;\n  width: 313px;\n  height: 113px;\n  //border: 1px solid black;\n  border: $btn_border;\n  border-radius: 15px;\n  padding: 20px 20px 10px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__group {\n    margin-bottom: 5px;\n    font-size: 15px;\n    font-weight: 500;\n    line-height: 17px;\n    letter-spacing: 0em;\n  }\n\n  &--opened {\n    z-index: 1000;\n    height: auto;\n    position: absolute;\n    right: 0;\n    top: 0;\n  }\n\n  &__nav {\n    display: flex;\n    //flex-direction: column;\n    align-items: center;\n    justify-content: space-between;\n    border-bottom: 2px solid $btn_border_color;\n    margin-bottom: 5px;\n  }\n\n  &__left {\n    width: 200px;\n  }\n\n  &__admin {\n    font-size: 16px;\n    font-weight: 600;\n    line-height: 26px;\n    letter-spacing: 0em;\n    cursor: pointer;\n    transition: color .3s;\n    color: $text_gray;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__user {\n    display: flex;\n    margin-bottom: 7px;\n  }\n\n  &__name {\n    font-size: 17px;\n    font-weight: 700;\n    line-height: 21px;\n    letter-spacing: 0em;\n    color: rgba(76, 88, 102, 1);\n    margin-right: 7px;\n  }\n\n  &__exit {\n    a {\n      color: rgba(210, 66, 66, 1);\n      font-size: 16px;\n      font-weight: 400;\n      line-height: 21px;\n      letter-spacing: 0em;\n    }\n  }\n\n  &__search {\n    font-size: 18px;\n    font-weight: 500;\n    line-height: 23px;\n    letter-spacing: 0em;\n    text-align: center;\n    color: $main_green;\n\n    &-btn {\n      &:hover {\n        svg {\n          fill: green;\n        }\n      }\n    }\n  }\n\n  &__routes {\n    padding-bottom: 5px;\n    margin-bottom: 5px;\n    display: flex;\n    flex-direction: column;\n    align-items: flex-end;\n    border-bottom: 2px solid $btn_border_color;\n  }\n\n  &__route {\n\n    &-link {\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 26px;\n      letter-spacing: 0em;\n      cursor: pointer;\n      color: $text_gray;\n\n      &:hover {\n        color: $main_green;\n      }\n\n      &--current {\n        text-decoration: underline;\n        color: $main_green;\n      }\n    }\n  }\n\n  &__burger {\n    position: relative;\n    top: -5px;\n    cursor: pointer;\n\n    &-item {\n      display: block;\n      width: 40px;\n      height: 5px;\n      background: $text_gray;\n      border-radius: 15px;\n\n      &:not(:last-child) {\n        margin-bottom: 6px;\n      }\n    }\n  }\n}\n\n.search-orders {\n  &__label {\n\n  }\n\n  &__input {\n    margin-right: 0 !important;\n    padding-left: 9px;\n    width: 170px !important;\n    cursor: text !important;\n  }\n}","@import \"../var\";\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: $main_green;\n  //border: 1px solid black;\n  border: $btn_border;\n  border-bottom: none;\n  border-radius: 15px 15px 0 0;\n  padding: 5px 30px;\n  height: 49px;\n  //margin-bottom: 30px;\n\n  &__title {\n    //min-width: 330px;\n    position: relative;\n    font-size: 27px;\n    font-weight: 700;\n    line-height: 29px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: $text_white;\n    margin-right: 10px;\n\n    //&--plan {\n    //  min-width: 280px;\n    //}\n    //\n    //&--report {\n    //  min-width: 240px;\n    //}\n  }\n\n  &__nav {\n    display: flex;\n    align-items: center;\n    //width: 400px;\n  }\n\n  &__button {\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n}\n\n.header-routes {\n  &__filter {\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__planned {\n    &-date {\n      width: 140px;\n    }\n  }\n}\n\n#search__target {\n  width: 120px !important;\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  border: 1px solid $text_white;\n  color: $text_white;\n  background: $main_green;\n}",".modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n\n  &_content {\n    display: flex;\n    flex-direction: column;\n    width: 900px;\n    height: auto;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    border-radius: 15px;\n    background: rgba(236, 236, 236, 1);\n\n    &-block {\n      padding: 5px;\n      display: flex;\n      justify-content: space-between;\n      align-items: center;\n      width: 100%;\n    }\n  }\n\n  &-header {\n    width: 100%;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 5px;\n    background: $main_green;\n    color: $text_white;\n    text-align: center;\n    height: 35px;\n    border-radius: 15px 15px 0px 0px;\n  }\n\n  &__trigger {\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n    justify-content: center;\n    width: 100%;\n    height: 100px;\n    //background: ;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    color: $main_green;\n    background: $text_white;\n  }\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n  //margin-right: 15px;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 15px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n\n  &__file {\n    position: relative;\n    width: 260px;\n    height: 260px;\n    margin-bottom: 100px;\n  }\n}\n\n.link__preview {\n  display: block;\n  width: 260px;\n  height: 260px;\n  margin-bottom: 10px;\n}\n\n.file {\n  &__preview {\n    width: 260px;\n    height: 260px;\n    //object-fit: cover;\n  }\n\n  &__download {\n    cursor: pointer;\n    position: absolute;\n    width: 30px;\n    height: 40px;\n    bottom: 5px;\n    right: 10px;\n    color: $main_green !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: green !important;\n      transition: color .3s;\n    }\n  }\n\n  &__remove {\n    cursor: pointer;\n    top: 0px;\n    right: 5px;\n    position: absolute;\n    color: $main_green !important;\n    font-size: 26px;\n    transform: rotate(45deg);\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: red !important;\n      transition: color .3s;\n    }\n  }\n\n\n  &__original {\n    position: absolute;\n    top: 5px;\n    left: 5px;\n    color: $main_green !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: green !important;\n      transition: color .3s;\n    }\n  }\n\n  &__name {\n    color: $text_black;\n    word-wrap: break-word;\n    text-align: center;\n  }\n\n  &__all {\n    align-self: center;\n    width: 170px;\n    margin-bottom: 15px;\n  }\n}",".modal_content--route {\n  width: 619px;\n  height: auto;\n}\n\n.route {\n  &__config {\n    padding: 13px 10px 0;\n    background: rgba(236, 236, 236, 1);\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  }\n\n  &__title {\n    font-size: 16px;\n    font-weight: 500;\n    line-height: 19px;\n    margin-bottom: 10px;\n    color: $text_black;\n  }\n\n  &-block {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      margin-bottom: 10px;\n    }\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n  }\n\n  &__input {\n    &:not(:disabled), {\n      cursor: pointer;\n    }\n\n    &:not(:read-only) {\n\n    }\n  }\n\n  &-plan__date {\n    border: 1px solid rgba(173, 173, 173, 1);\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n    margin-right: 0 !important;\n    color: $text_black;\n  }\n\n  &__label {\n    text-align: center;\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 17px;\n    letter-spacing: 0em;\n    margin-bottom: 7px;\n  }\n\n  &__btn {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    width: 97px;\n    border: 1px solid rgba(173, 173, 173, 1);\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n    border-radius: 15px;\n  }\n\n  &__select {\n    width: 130px;\n    margin-bottom: 10px;\n    border: none;\n    border-radius: 7px;\n    box-shadow: 2px 2px 5px 0px rgba(0, 0, 0, 0.25);\n    background: rgba(255, 255, 255, 1);\n\n    &:disabled {\n      background: rgba(255, 255, 255, 1);\n    }\n  }\n\n  &-day__quantity {\n    border: 1px solid rgba(173, 173, 173, 1);\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n    margin-right: 0 !important;\n    color: $text_black;\n    cursor: pointer !important;\n    transition: color .3s linear;\n\n    &:hover {\n      transition: color .3s linear;\n      cursor: pointer;\n      color: $main_green;\n    }\n  }\n\n  &__input {\n    width: 136px;\n    height: 28px;\n    margin-right: -40px;\n    box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n    border-radius: 15px;\n    border: none;\n    outline: none;\n\n    &:not(:disabled) {\n      &:focus {\n        outline: 2px solid $main_green;\n      }\n    }\n\n    &--small {\n      width: 80px !important;\n\n      &:not(:last-child) {\n        //margin-right: 20px;\n      }\n    }\n\n    &--top {\n      width: 136px;\n      text-align: center;\n      margin-bottom: 10px;\n      height: 28px;\n      box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n      border-radius: 15px;\n      border: none;\n    }\n\n    &--middle {\n      width: 155px;\n    }\n  }\n\n  &__section {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 15px;\n  }\n}\n\n.report-route__btn {\n  //margin-right: 30px;\n}\n\n.section-logs {\n  width: 100%;\n  background: white;\n  border-radius: 0 5px 5px 5px;\n  padding: 5px;\n  margin-bottom: 8px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__title {\n    text-align: center;\n    margin-bottom: 10px;\n    color: $button_color;\n  }\n\n  &__list {\n    height: 85px;\n    overflow-y: scroll;\n  }\n\n  &__input {\n    padding-left: 10px;\n  }\n\n  &__item {\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 18px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: rgba(87, 87, 87, 1);\n    margin-bottom: 5px;\n\n    &--system {\n      color: $main_green;\n    }\n\n    &--error {\n      color: rgba(210, 66, 66, 1);\n    }\n\n    &--pause {\n      color: #51a5e3;\n    }\n  }\n\n  &__comment {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 30px;\n  }\n\n  &__input {\n    width: 350px;\n  }\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n\n  &__cancel {\n    margin-right: 30px;\n  }\n\n  &__delete {\n    &:hover {\n      color: red !important;\n    }\n  }\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued,\n{\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment {\n  &__prev {\n    //margin: 12px auto 0;\n    overflow-y: scroll;\n    background: $text_white;\n    height: 100%;\n    width: 100%;\n    //border-radius: 15px;\n  }\n\n  &__item {\n    color: $text_black;\n    font-size: 17px;\n    //padding: 10px 13px;\n    //padding: 5px 0;\n    border-bottom: 1px solid black;\n  }\n}\n\n.confirm {\n  &__title {\n    font-size: 20px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    margin-top: 10px;\n    text-align: center;\n    color: $text_black;\n    margin-bottom: 25px;\n  }\n\n  &__section {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  &__button {\n    &--ok {\n      margin-right: 25px;\n    }\n\n    &--search {\n      margin-top: 20px;\n    }\n\n    margin-bottom: 10px;\n  }\n}\n\n.progress-block {\n  width: 180px;\n}\n\n.quantity-block {\n  display: flex;\n  justify-content: space-between;\n\n  &--rel {\n    position: relative;\n  }\n\n  &__labels {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  &__label {\n    margin-right: 47px;\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 17px;\n    letter-spacing: 0em;\n    text-align: center;\n  }\n\n  &__issued {\n    position: relative;\n    right: -5px;\n  }\n\n  &__shifts {\n    //margin-right: 33px;\n  }\n\n  &__inshifts {\n    margin-right: 44px;\n    position: relative;\n    right: 10px;\n  }\n}\n\n.route-type {\n  &__paused {\n    //color: rgba(224, 108, 0, 1) !important;\n    border: 2px solid #51a5e3;\n  }\n\n  &__error {\n    //color: rgba(210, 66, 66, 1) !important;\n    border: 2px solid rgba(210, 66, 66, 1);\n  }\n\n  &__start {\n    //color: rgba(24, 136, 217, 1) !important;\n    border: 2px solid #e06c00;\n  }\n\n  &__finish {\n    //color: rgba(0, 130, 29, 1) !important;\n    border: 2px solid rgba(0, 130, 29, 1);\n  }\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray !important;\n  }\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgba(236, 236, 236, 1);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__input {\n    padding-left: 10px;\n    margin-top: 20px;\n    height: 28px;\n    text-align: left !important;\n    margin-right: 0;\n    width: 90%;\n    margin-bottom: 15px;\n    background: $text_white;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  &__date {\n    margin-bottom: 10px;\n    margin-right: 0;\n\n  }\n\n  &__input {\n    margin-right: 0;\n    width: 20%;\n    height: 28px;\n    margin-bottom: 15px;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.user__block {\n  margin-right: 40px;\n}\n\n.endtime__block {\n  margin-right: 107px;\n}\n\n.start-route__btn {\n  color: rgba(224, 108, 0, 1);\n}\n\n.end-route__btn {\n  color: rgba(0, 130, 29, 1);\n}\n\n.pause-route__btn {\n  color: #51a5e3;\n}\n\n.error-route__btn {\n  color: rgba(210, 66, 66, 1);\n}\n\n.section-report {\n  justify-content: left;\n}\n\n.issued-modal_trigger {\n  margin-right: 75px;\n}\n\n.send__comment {\n  width: 130px;\n  border: 2px solid rgba(105, 135, 105, 1);\n  color: rgba(105, 135, 105, 1);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n\n.section-finish {\n  &__sub {\n    border-radius: 15px;\n    width: 130px;\n    height: 40px;\n    border: none;\n    background: rgba(105, 135, 105, 1);\n    color: $text_white;\n\n    &--route:disabled {\n      color: black;\n    }\n  }\n\n  &__delete {\n    border: none;\n    background: none;\n    color: rgba(210, 66, 66, 1);\n    cursor: pointer;\n  }\n}\n\n.issued-top {\n  display: flex;\n  align-items: center;\n\n  &__item {\n    padding: 5px 0;\n    width: 39%;\n\n    &:not(:last-child) {\n      border-right: 1px solid black;\n    }\n\n    &--date {\n      width: 120px;\n    }\n\n    &--summary {\n      width: 80px;\n    }\n  }\n}\n\n.logs-filter {\n  border-radius: 15px;\n  //padding-left: 5px;\n  display: flex;\n\n  &__button {\n    padding: 3px;\n    //border: 1px solid $btn_border_color;\n    background-color: $text_white;\n    transition: color .3s linear;\n    cursor: pointer;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s linear;\n    }\n\n    &--current {\n      color: $main_green;\n    }\n  }\n}\n\n.modal__shift-block {\n  width: 130px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n}",".modal_content--comments {\n  width: 612px;\n}\n\n\n.comments {\n  &__title {\n    font-size: 20px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: $text_white;\n    margin-left: 31px;\n  }\n\n  &-content {\n    padding: 24px;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    background: rgba(236, 236, 236, 1);\n    border-radius: 15px;\n  }\n\n  &__add {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n}\n\n.comments-list {\n  height: 90px;\n  padding: 7px 10px;\n  overflow-y: scroll;\n  border-radius: 15px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  background: $text_white;\n\n  &__item {\n    color: $text_gray;\n    margin-bottom: 5px;\n    display: flex;\n    align-items: center;\n  }\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n}\n\n.comments__prev {\n  margin-bottom: 10px;\n}\n\n.comments__yours {\n  width: 350px;\n  cursor: text !important;\n  padding-left: 10px;\n}",".modal-plan {\n  position: relative;\n\n  .confirm__section {\n    position: absolute;\n    bottom: 0;\n  }\n}\n\n.modal {\n  &-plan__date {\n\n  }\n\n  &-plan {\n    padding: 5px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    &__today {\n      text-align: center;\n      align-self: center;\n    }\n\n    &__section {\n      width: 250px;\n      display: flex;\n      flex-direction: column;\n      justify-content: space-between;\n      //align-items: center;\n\n      &:not(:last-child) {\n        margin-bottom: 10px;\n      }\n    }\n\n    &__data {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n\n      &--center {\n        justify-content: center;\n      }\n    }\n\n    &__input {\n      width: 120px;\n    }\n\n    &__check {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n    }\n\n    &__exclude {\n      text-align: center;\n      height: 100px;\n\n      &-option {\n        text-align: center;\n        padding: 2px;\n\n        &:hover {\n          cursor: pointer;\n        }\n      }\n    }\n  }\n}\n\n.confirm__title--plan {\n  margin-bottom: 5px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.plan-period {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n\n  &__btn {\n    &:not(:last-child) {\n      margin-right: 5px;\n    }\n  }\n\n  margin-bottom: 10px;\n}\n\n.plan-dates {\n  display: flex;\n  overflow-y: auto;\n  max-height: 60%;\n  //justify-content: space-between;\n  margin-left: 15px;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-bottom: 10px;\n  //min-height: 308px;\n\n  .plan-dates__item {\n    margin-bottom: 4px;\n  }\n\n  &__item {\n    //width: 105px;\n    //padding: 5px;\n    background: $text_white;\n    //margin-bottom: 7px;\n\n    width: 95px;\n    transition: color .3s;\n    text-align: center;\n    height: 28px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    &--small {\n      font-size: 13px;\n      width: 34px;\n      box-shadow: none;\n      padding-bottom: 1px;\n\n      //margin: 0 1px;\n\n      &:not(:last-child) {\n        margin-right: 3px;\n      }\n    }\n\n    //&--small  + .plan-dates__item--busy {\n    //  color: blue;\n    //}\n\n    &:hover {\n      cursor: pointer;\n      transition: color .3s;\n      color: #09d009;\n    }\n\n    //&:not(:last-child) {\n    //  margin-right: 7px;\n    //}\n\n    //&:not(:last-child) {\n    //  border-right: 1px solid black;\n    //}\n\n    &--inplan {\n      color: white;\n      background: $main_green;\n    }\n\n    &--busy {\n      color: blue;\n      cursor: default !important;\n\n      &:hover {\n        color: $text_black;\n      }\n    }\n  }\n}",".admin-panel {\n  min-width: 1200px;\n  height: 600px;\n  background: $text_white;\n}\n\n.panel-nav {\n  margin-top: 10px;\n  color: $text_gray;\n\n  padding: 5px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav-navigation {\n  padding: 10px;\n  width: 350px;\n  height: 200px;\n  background: rgba(236, 236, 236, 1);\n  border-radius: 15px;\n\n  &__item {\n    height: 28px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n\n    &:not(:last-child) {\n      margin-bottom: 10px;\n    }\n\n    &--title {\n      width: 100%;\n      background: $main_green;\n      border-radius: 15px;\n      text-align: center;\n      color: $text_white;\n    }\n  }\n\n  &__text {\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s;\n    }\n  }\n}\n\n.nav-content {\n  width: 70%;\n  min-height: 500px;\n  max-height: 500px;\n  display: flex;\n  flex-direction: column;\n\n  overflow-y: auto;\n\n  &__columns {\n    height: 40px;\n    padding: 10px;\n    border-radius: 15px 15px 0 0;\n    background: $main_green;\n    color: $text_white;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    //height: 28px;\n  }\n\n  &__items {\n    padding: 10px;\n    background: rgba(236, 236, 236, 1);\n  }\n\n  &__item {\n    min-height: 40px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n\n  &__column {\n    min-width: 20%;\n    text-align: center;\n\n    &--left {\n      text-align: left !important;\n    }\n\n    &-name {\n      min-width: 45%;\n      width: 45%;\n    }\n\n    &-shortname {\n      min-width: 15%;\n      width: 15%;\n    }\n\n    &-hide {\n      min-width: 10%;\n      width: 10%;\n    }\n  }\n\n}\n\n.nav-item {\n  width: 100%;\n\n  &__column {\n    text-align: center;\n    min-width: 20%;\n\n    &--left {\n      text-align: left;\n    }\n\n    &-name {\n      min-width: 45%;\n      width: 45%;\n    }\n\n    &-shortname {\n      min-width: 15%;\n      width: 15%;\n    }\n\n    &-hide {\n      min-width: 10%;\n      width: 10%;\n    }\n\n    &--edit {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $main_green;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__pos {\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n}\n\n.edit-form {\n  align-self: center;\n  width: 726px;\n  display: flex;\n  justify-content: space-between;\n  background: rgba(236, 236, 236, 1);\n  padding: 25px;\n  border-radius: 15px;\n  position: relative;\n\n  &__delete {\n    //align-self: flex-start;\n  }\n\n  &--group {\n    width: 300px;\n    height: 320px;\n\n    .edit-form__user {\n      border-right: none;\n      width: 100%;\n      height: 100%;\n    }\n  }\n\n  &__text {\n    padding: 10px;\n    width: 250px;\n    height: 100px;\n    resize: none;\n    cursor: pointer;\n  }\n\n  &__user {\n    //margin-top: 13px;\n    width: 50%;\n    //height: 284px;\n    border-right: 1px solid $text_gray;\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 15px;\n    width: 251px;\n\n    &--do {\n      margin-top: 20px;\n      flex-direction: row;\n      justify-content: space-between;\n      align-items: center;\n    }\n\n    &--checker {\n      flex-direction: row;\n      justify-content: space-between;\n    }\n  }\n\n  &__label {\n    font-size: 18px;\n    font-weight: 400;\n    line-height: 30px;\n    letter-spacing: 0em;\n\n    &--checker {\n      flex-direction: row;\n      margin-right: 168px;\n    }\n  }\n\n  &__input {\n    padding: 5px 5px 5px 10px;\n    width: 250px !important;\n    height: 28px !important;\n    cursor: text;\n    margin-bottom: 0 !important;\n  }\n\n  &__group {\n    cursor: pointer !important;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__plot {\n    cursor: pointer !important;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__submit {\n    cursor: pointer;\n    //margin-top: 20px;\n    //align-self: flex-end;\n  }\n\n  &__succ {\n    position: absolute;\n    color: $main_green;\n\n    &--user {\n      bottom: 70px;\n      left: 25px;\n    }\n\n    &--filter {\n      bottom: 80px;\n      left: 27px;\n    }\n\n    &--group {\n      bottom: 80px;\n      left: 27px;\n    }\n  }\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_filters_topFilters__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modules/filters/topFilters */ "./web/src/static/js/modules/filters/topFilters.js");
/* harmony import */ var _getPlans__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./getPlans */ "./web/src/static/js/plan/getPlans.js");
/* harmony import */ var _filters_newPlanCheck__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filters/newPlanCheck */ "./web/src/static/js/plan/filters/newPlanCheck.js");
/* harmony import */ var _filters_topPlansFilters__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filters/topPlansFilters */ "./web/src/static/js/plan/filters/topPlansFilters.js");
...
if (window.location.href.endsWith('main/plan')) {
  (0,_filters_topPlansFilters__WEBPACK_IMPORTED_MODULE_5__.topPlansFilters)();
  (0,_filters_newPlanCheck__WEBPACK_IMPORTED_MODULE_4__.reportPlanningDatesFilter)();
