...
/* harmony import */ var _users__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./users */ "./web/src/static/js/modules/admin/users.js");
/* harmony import */ var _groups__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./groups */ "./web/src/static/js/modules/admin/groups.js");
/* harmony import */ var _drawPlots__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./drawPlots */ "./web/src/static/js/modules/admin/drawPlots.js");
/* harmony import */ var _filters__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./filters */ "./web/src/static/js/modules/admin/filters.js");
/* harmony import */ var _constructor__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./constructor */ "./web/src/static/js/modules/admin/constructor.js");
...
const getAndDrawData = (url, drawFunc, modal) => {
  ...
  fetch(`${_state__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/${url}`).then(res => res.json()).then(data => {
...
const adminHandler = () => {
  ...
  adminModalBtn.addEventListener('click', () => {
    ...
    usersBtn.addEventListener('click', () => {
      getAndDrawData('users/get-all', _users__WEBPACK_IMPORTED_MODULE_4__.drawUsers, adminModal);
    });
    groupsBtn.addEventListener('click', () => {
      getAndDrawData('groups/get-all', _groups__WEBPACK_IMPORTED_MODULE_5__.drawGroups, adminModal);
    });
    plotBtn.addEventListener('click', () => {
      getAndDrawData('plots/get-all', _drawPlots__WEBPACK_IMPORTED_MODULE_6__.drawAdminPlots, adminModal);
    });
    filtersBtn.addEventListener('click', () => {
      getAndDrawData('filters/get-all', _filters__WEBPACK_IMPORTED_MODULE_7__.drawAdminFilters, adminModal);
      console.log('hi');
    });
    constructorBtn.addEventListener('click', () => {
      getAndDrawData('filters/get-all', _constructor__WEBPACK_IMPORTED_MODULE_8__.drawConstructor, adminModal);
    });
  });
};
...
const submitFilters = async data => {
  await fetch(`${_state__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/filters/edit-position`, {
    method: "PUT",
    headers: {
...
const drawAdminPlots = (modal, datas) => {
  ...
  modal.querySelectorAll('.nav-item__column--edit').forEach(editor => {
    editor.addEventListener('click', () => {
      ...
      (0,_sendData__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/plots/get-plot`, 'POST', JSON.stringify({
        'id': userID
      })).then(data => {
        return data.json();
      }).then(data => {
...
const drawAdminFilters = (modal, datas) => {
  ...
  modal.querySelectorAll('.nav-item__column--edit').forEach(editor => {
    editor.addEventListener('click', () => {
      const userID = editor.querySelector('.hidden-input').value;
      (0,_sendData__WEBPACK_IMPORTED_MODULE_0__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/filters/get-filter`, 'POST', JSON.stringify({
        'id': userID
      })).then(data => {
        return data.json();
      }).then(data => {
...
const drawGroups = (modal, datas) => {
  ...
  modal.querySelectorAll('.nav-item__column--edit').forEach(editor => {
    editor.addEventListener('click', () => {
      const userID = editor.querySelector('.hidden-input').value;
      (0,_sendData__WEBPACK_IMPORTED_MODULE_1__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_2__.appAddr}/api/groups/get-group`, 'POST', JSON.stringify({
        'id': userID
      })).then(data => {
        return data.json();
      }).then(data => {
...
const drawUsers = (modal, users) => {
  ...
  modal.querySelectorAll('.nav-item__column--edit').forEach(editor => {
    editor.addEventListener('click', () => {
      const userID = editor.querySelector('.hidden-input').value;
      (0,_sendData__WEBPACK_IMPORTED_MODULE_1__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_2__.appAddr}/api/users/get-user`, 'POST', JSON.stringify({
        'id': userID
      })).then(data => {
        return data.json();
      }).then(data => {
...
const drawFiles = (modal, files, id, parent) => {
  ...
  if (files.length) {
    ...
    document.querySelectorAll(".file__remove").forEach(btn => {
      btn.addEventListener('click', e => {
        ...
        (0,_sendData__WEBPACK_IMPORTED_MODULE_3__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_0__.appAddr}/api/files/remove-file/${id}/${file.querySelector('.file__name').textContent}`, 'POST', null).then(res => {
          if (res.ok) {
...
const planDateHandler = (addedDates, plot, routeID) => {
  ...
  let newBusy = [];
  (0,_sendData__WEBPACK_IMPORTED_MODULE_2__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_3__.appAddr}/api/plans/get-busy`, 'POST', JSON.stringify({
    "plot": plot,
    "route_id": routeID
  })).then(res => {
    return res.json();
...
const triggerRoutesModal = e => {
  ...
  let logName = _state__WEBPACK_IMPORTED_MODULE_2__.state.adminCheck || _state__WEBPACK_IMPORTED_MODULE_2__.state.techCheck ? _table__WEBPACK_IMPORTED_MODULE_3__.user.nickname : '';
  let planned = false;
  let info = false;
  ...
  if (info) {
    ...
    if (!_state__WEBPACK_IMPORTED_MODULE_2__.state.operCheck || routeInfo['user']) {
  ...
  pauseBtn.addEventListener('click', () => {
    if (!pauseBtn.classList.contains('route-type__paused')) {
      ...
      addLog(_table__WEBPACK_IMPORTED_MODULE_3__.user.nickname, `Сбросил паузу`, '#visible__comments');
      activateNextStage('route__select--user');
  ...
  document.querySelector('.section-finish__sub').addEventListener('click', () => {
    ...
    if (!(parent === null)) {
      parent.classList.remove('table-form--old');
      parent.classList.add('table-form--upd');
      (0,_sendData__WEBPACK_IMPORTED_MODULE_5__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_2__.appAddr}/api/reports/update`, 'POST', JSON.stringify(obj));
    }
    (0,_submitOrdersData__WEBPACK_IMPORTED_MODULE_4__.submitData)();
...
const getTheorEndTime = (routeQuantity, routeDayQuantity, issued, startTime, theorEndInp, shifts) => {
  ...
  if (routeQuantity && routeDayQuantity && startTime) {
    ...
    (0,_sendData__WEBPACK_IMPORTED_MODULE_5__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_2__.appAddr}/api/time/theoretic`, 'POST', JSON.stringify(timeInfo)).then(res => {
      return res.json();
    }).then(data => {
...
const getOrders = function () {
  ...
  (0,_sendData__WEBPACK_IMPORTED_MODULE_9__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/orders/get-all`, 'POST', JSON.stringify(params)).then(res => res.json()).then(data => {
    if (_state__WEBPACK_IMPORTED_MODULE_1__.state.isArchive) {
    ...
    if (!data.data) {
      ...
      title.textContent = _state__WEBPACK_IMPORTED_MODULE_1__.state.isArchive ? 'Архив заказов' : 'Журнал заказов';
    }
    const nums = [];
    const clients = [];
    const materials = [];
    ...
    (0,_getData__WEBPACK_IMPORTED_MODULE_3__.getData)('users/get-users').then(res => {
      ...
      document.querySelector('.nav-control__total').textContent = `Всего в ${_state__WEBPACK_IMPORTED_MODULE_1__.state.isArchive ? 'архиве' : 'работе'} ${_state__WEBPACK_IMPORTED_MODULE_1__.state.orders.length}`;
...
function submitSingleOrder(id) {
  ...
  console.log(form);
  let success;
  (0,_sendData__WEBPACK_IMPORTED_MODULE_2__.sendData)(`${_state__WEBPACK_IMPORTED_MODULE_1__.appAddr}/api/orders/update`, 'PUT', JSON.stringify(createRes(form))).then(res => {
...
/* harmony import */ var _modules_filters_filterOrders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../modules/filters/filterOrders */ "./web/src/static/js/modules/filters/filterOrders.js");
/* harmony import */ var _globalFilterReports__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./globalFilterReports */ "./web/src/static/js/report/filters/globalFilterReports.js");
...
const topReportFilter = () => {
  ...
  links.forEach(link => {
    link.addEventListener('click', () => {
      ...
      navRoutes.classList.toggle('hidden__input');
      if (link.textContent.trim().includes('Архив')) {
        (0,_modules_orders__WEBPACK_IMPORTED_MODULE_1__.getOrders)('get-old');
      } else if (link.textContent.trim().includes('Главная')) {
        window.location.href = link.querySelector('.hidden__input').value;
...
const filterRouteReports = () => {
  ...
  _modules_state__WEBPACK_IMPORTED_MODULE_0__.state.filteredOrders.forEach(order => {
    (0,_globalFilterReports__WEBPACK_IMPORTED_MODULE_5__.globalFilterReports)(order);
  });
  // bindOrdersListeners()
};
...
/* harmony import */ var _filters_globalFilterReports__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./filters/globalFilterReports */ "./web/src/static/js/report/filters/globalFilterReports.js");
/* harmony import */ var _filters_topReportFilter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filters/topReportFilter */ "./web/src/static/js/report/filters/topReportFilter.js");
  ...
  (0,_modules_sendData__WEBPACK_IMPORTED_MODULE_1__.sendData)(`${_modules_state__WEBPACK_IMPORTED_MODULE_0__.appAddr}/api/reports/get-all`, 'POST', JSON.stringify(reportTime)).then(resp => resp.json()).then(data => {
    ...
    data.data.forEach(d => {
      ...
      if (_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.filtered && filters.length) {
        // console.log('big filter')
        (0,_filters_globalFilterReports__WEBPACK_IMPORTED_MODULE_5__.globalFilterReports)(d, filters);
        (0,_filters_topReportFilter__WEBPACK_IMPORTED_MODULE_6__.filterRouteReports)();
      } else if (_modules_state__WEBPACK_IMPORTED_MODULE_0__.state.filtered) {
        console.log('table filter');
        (0,_filters_globalFilterReports__WEBPACK_IMPORTED_MODULE_5__.globalFilterReports)(d);
      } else if (filters.length) {
        console.log('top filter');
        (0,_filters_topReportFilter__WEBPACK_IMPORTED_MODULE_6__.filterRouteReports)();
      } else {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@charset \"UTF-8\";\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput, select {\n  outline: none;\n}\n\nbody {\n  font-family: Inter;\n  background: rgb(236, 236, 236);\n}\n\n.container {\n  padding: 0 15px;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: rgb(66, 66, 66);\n  margin-bottom: 15px;\n}\n@media screen and (min-width: 1522px) {\n  .main--reports {\n    margin: 0 auto 15px;\n    width: 1492px;\n  }\n}\n.main__button {\n  height: 28px;\n  text-align: center;\n  border: 1px solid black;\n  border-radius: 5px;\n  background: white;\n  color: rgb(66, 66, 66);\n  transition: color 0.3s;\n  cursor: pointer;\n  padding: 5px;\n}\n.main__button:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.main__button--select {\n  background: rgb(217, 221, 220) !important;\n}\n.main__button--select {\n  outline: none;\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  letter-spacing: 0em;\n  text-align: center;\n  color: rgb(137, 175, 137);\n  cursor: pointer;\n  padding: 3px 7px;\n  border: none;\n}\n.main__button--click {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  letter-spacing: 0em;\n  text-align: center;\n  border-radius: 15px;\n  border: 1px solid rgb(203, 203, 203);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  background: white;\n  color: rgb(66, 66, 66);\n  cursor: pointer;\n  padding: 3px 7px;\n}\n.main__input {\n  padding: 5px;\n  cursor: text;\n  border: 1px solid black;\n  border-radius: 5px;\n  color: rgb(66, 66, 66);\n}\n.main-table__data {\n  width: 100%;\n  height: 75vh;\n  overflow: scroll;\n  margin-bottom: 5px;\n  border-left: 1px solid black;\n  border-right: 1px solid black;\n  border-bottom: 1px solid black;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  background: white;\n}\n@media screen and (max-width: 1200px) {\n  .main-table__data {\n    height: 75vh;\n  }\n}\n@media screen and (min-width: 1500px) {\n  .main-table__data {\n    height: 86vh;\n  }\n}\n@media screen and (min-width: 1920px) {\n  .main-table__data {\n    height: 86vh;\n  }\n}\n.main__select {\n  text-align: center !important;\n}\n.main__select {\n  width: 100%;\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n}\n\n.warning {\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active,\na:hover,\na {\n  -webkit-text-decoration: none;\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n}\nselect:disabled:hover {\n  color: gray;\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\n\nbutton {\n  border: none;\n  background: none;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n}\nbutton:disabled:hover {\n  color: gray;\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test__form {\n  display: none;\n  visibility: hidden;\n}\n.test__list {\n  background: none;\n}\n.test__item {\n  background: transparent;\n}\n.test__input {\n  background: transparent;\n  outline: none;\n  border: none;\n}\n\n.admin-form__button {\n  width: 130px;\n  transition: color 0.3s;\n  position: absolute;\n  right: 24px;\n}\n.admin-form__button:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n.admin-form__user {\n  margin-right: 10px;\n}\n.admin-form__exit {\n  transition: color 0.3s;\n}\n.admin-form__exit:hover {\n  transition: color 0.3s;\n  color: #13d9d9;\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n.search {\n  display: flex;\n  align-items: center;\n}\n@media screen and (max-width: 1200px) {\n  .search {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 1;\n  position: absolute;\n  min-width: 100%;\n  background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border: 1px solid #333;\n}\n.check-helper--long {\n  min-width: 300%;\n}\n.check-helper--errored {\n  padding: 0;\n  color: black;\n}\n\n.routes-block {\n  display: flex;\n  align-items: center;\n}\n\n.archive-block {\n  display: flex;\n  align-items: center;\n}\n\n.header-routes {\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  position: relative;\n}\n\n.nav-filters {\n  width: 77%;\n  position: relative;\n  height: 113px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 5px 25px;\n  display: flex;\n  flex-direction: column;\n}\n@media screen and (min-width: 1920px) {\n  .nav-filters {\n    width: 82%;\n  }\n}\n.nav-filters__list {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.nav-filters__list:not(:last-child) {\n  padding-bottom: 15px;\n  margin-bottom: 5px;\n}\n.nav-filters__item:not(:last-child) {\n  margin-right: 10px;\n}\n.nav-filters__button--chosen {\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n}\n\n.nav-filters__plots {\n  margin-top: 10px;\n  border-bottom: 1px solid black;\n  margin-bottom: 10px;\n}\n.nav-filters__filters {\n  margin-bottom: 0 !important;\n}\n.nav-filters__filters {\n  margin-top: 7px;\n}\n.nav-filters__reset {\n  width: 131px;\n  display: block;\n  align-self: center;\n}\n\n.nav {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  margin-top: 10px;\n}\n\n.nav-control {\n  width: 313px;\n  height: 113px;\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 20px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.nav-control--opened {\n  z-index: 1000;\n  height: auto;\n  position: absolute;\n  right: 0;\n  top: 0;\n}\n.nav-control__nav {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.nav-control__left {\n  width: 200px;\n}\n.nav-control__admin {\n  font-size: 14px;\n  font-weight: 500;\n  line-height: 17px;\n  letter-spacing: 0em;\n  margin-bottom: 10px;\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-control__admin:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n.nav-control__user {\n  display: flex;\n  margin-bottom: 7px;\n}\n.nav-control__name {\n  font-size: 16px;\n  font-weight: 700;\n  line-height: 21px;\n  letter-spacing: 0em;\n  color: rgb(76, 88, 102);\n  margin-right: 7px;\n}\n.nav-control__exit a {\n  color: rgb(210, 66, 66);\n  font-size: 16px;\n  font-weight: 400;\n  line-height: 21px;\n  letter-spacing: 0em;\n}\n.nav-control__total {\n  font-size: 18px;\n  font-weight: 500;\n  line-height: 23px;\n  letter-spacing: 0em;\n  text-align: center;\n  color: rgb(137, 175, 137);\n}\n.nav-control__routes {\n  margin-bottom: 5px;\n  display: flex;\n  justify-content: space-between;\n}\n.nav-control__route-link {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  cursor: pointer;\n}\n.nav-control__route-link:hover {\n  color: rgb(137, 175, 137);\n}\n.nav-control__route-link--current {\n  -webkit-text-decoration: underline;\n  text-decoration: underline;\n}\n.nav-control__burger {\n  position: relative;\n  top: -5px;\n  cursor: pointer;\n}\n.nav-control__burger-item {\n  display: block;\n  width: 40px;\n  height: 5px;\n  background: rgb(66, 66, 66);\n  border-radius: 15px;\n}\n.nav-control__burger-item:not(:last-child) {\n  margin-bottom: 6px;\n}\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: rgb(137, 175, 137);\n  border: 1px solid black;\n  border-bottom: none;\n  border-radius: 15px 15px 0 0;\n  padding: 5px 30px;\n  height: 49px;\n}\n.main-header__title {\n  position: relative;\n  top: -1px;\n  font-size: 27px;\n  font-weight: 700;\n  line-height: 29px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(255, 255, 255);\n  margin-right: 20px;\n}\n.main-header__nav {\n  display: flex;\n  align-items: center;\n}\n.main-header__button:not(:last-child) {\n  margin-right: 20px;\n}\n\n.header-routes__filter:not(:last-child) {\n  margin-right: 10px;\n}\n.header-routes__planned-date {\n  width: 140px;\n}\n\n#search__target {\n  width: 120px !important;\n}\n\n#search__target {\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  border: 1px solid rgb(255, 255, 255);\n  color: rgb(255, 255, 255);\n  background: rgb(137, 175, 137);\n}\n\n.modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n}\n.modal_content {\n  display: flex;\n  flex-direction: column;\n  width: 900px;\n  height: auto;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n  background: rgb(236, 236, 236);\n}\n.modal-header {\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding: 5px;\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n  text-align: center;\n  height: 35px;\n  border-radius: 15px 15px 0px 0px;\n}\n.modal__trigger {\n  display: flex;\n  align-items: center;\n  cursor: pointer;\n  justify-content: center;\n  width: 100%;\n  height: 100px;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  color: rgb(137, 175, 137);\n  background: rgb(255, 255, 255);\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 5px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n}\n.data__file {\n  position: relative;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 60px;\n}\n\n.link__preview {\n  display: block;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 10px;\n}\n\n.file__preview {\n  width: 280px;\n  height: 280px;\n}\n.file__download {\n  color: rgb(137, 175, 137) !important;\n}\n.file__download {\n  cursor: pointer;\n  position: absolute;\n  width: 30px;\n  height: 40px;\n  bottom: 5px;\n  right: 10px;\n  transition: color 0.3s;\n}\n.file__download:hover {\n  color: green !important;\n}\n.file__download:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__remove {\n  color: rgb(137, 175, 137) !important;\n}\n.file__remove {\n  cursor: pointer;\n  top: 0px;\n  right: 5px;\n  position: absolute;\n  font-size: 26px;\n  transform: rotate(45deg);\n  transition: color 0.3s;\n}\n.file__remove:hover {\n  color: red !important;\n}\n.file__remove:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__original {\n  color: rgb(66, 66, 66) !important;\n}\n.file__original {\n  position: absolute;\n  top: 5px;\n  left: 5px;\n  transition: color 0.3s;\n}\n.file__original:hover {\n  color: rgb(137, 175, 137) !important;\n}\n.file__original:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.file__name {\n  color: rgb(66, 66, 66);\n  text-align: center;\n}\n.file__all {\n  align-self: center;\n  width: 170px;\n  margin-bottom: 15px;\n}\n\n.modal_content--route {\n  width: 619px;\n  height: auto;\n}\n\n.route__config {\n  padding: 13px 10px 0;\n  background: rgb(236, 236, 236);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.route__title {\n  font-size: 16px;\n  font-weight: 500;\n  line-height: 19px;\n  margin-bottom: 10px;\n}\n.route-block__wrapper {\n  display: flex;\n  align-items: center;\n  margin-bottom: 10px;\n}\n.route__block {\n  display: flex;\n  flex-direction: column;\n}\n.route__input:not(:disabled) {\n  cursor: pointer;\n}\n.route-plan__date {\n  border: 1px solid rgb(173, 173, 173) !important;\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n  margin-right: 0 !important;\n}\n.route-plan__date {\n  color: rgb(66, 66, 66);\n}\n.route__label {\n  text-align: center;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 17px;\n  letter-spacing: 0em;\n  margin-bottom: 7px;\n}\n.route__btn {\n  align-items: center;\n  width: 97px;\n  border: 1px solid rgb(173, 173, 173);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n.route__select {\n  width: 130px;\n  margin-bottom: 10px;\n  border: none;\n  border-radius: 7px;\n  box-shadow: 2px 2px 5px 0px rgba(0, 0, 0, 0.25);\n  background: rgb(255, 255, 255);\n}\n.route__select:disabled {\n  background: rgb(255, 255, 255);\n}\n.route__input {\n  width: 136px;\n  height: 28px;\n  margin-right: -40px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  border-radius: 15px;\n  border: none;\n  outline: none;\n}\n.route__input:not(:disabled):focus {\n  outline: 2px solid rgb(137, 175, 137);\n}\n.route__input--small {\n  width: 80px !important;\n}\n.route__input--top {\n  width: 136px;\n  text-align: center;\n  margin-bottom: 10px;\n  height: 28px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  border-radius: 15px;\n  border: none;\n}\n.route__input--middle {\n  width: 155px;\n}\n.route__section {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n\n.section-logs {\n  width: 100%;\n  background: white;\n  border-radius: 5px;\n  padding: 5px;\n  margin-bottom: 8px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.section-logs__title {\n  text-align: center;\n  margin-bottom: 10px;\n  color: #447e9b;\n}\n.section-logs__list {\n  height: 85px;\n  overflow-y: scroll;\n}\n.section-logs__input {\n  padding-left: 10px;\n}\n.section-logs__item {\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 18px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(87, 87, 87);\n  margin-bottom: 5px;\n}\n.section-logs__item--system {\n  color: rgb(137, 175, 137);\n}\n.section-logs__item--error {\n  color: rgb(210, 66, 66);\n}\n.section-logs__comment {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 30px;\n}\n.section-logs__input {\n  width: 350px;\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n}\n.section-finish__cancel {\n  margin-right: 30px;\n}\n.section-finish__delete:hover {\n  color: red !important;\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued {\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment__prev {\n  margin: 12px auto 0;\n  overflow-y: scroll;\n  background: rgb(255, 255, 255);\n  height: 80%;\n  width: 90%;\n  border-radius: 15px;\n}\n.comment__item {\n  color: rgb(66, 66, 66);\n  font-size: 17px;\n  padding: 10px 13px;\n}\n\n.confirm__title {\n  font-size: 20px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  margin-top: 10px;\n  text-align: center;\n  color: rgb(66, 66, 66);\n  margin-bottom: 25px;\n}\n.confirm__section {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n.confirm__button {\n  margin-bottom: 10px;\n}\n.confirm__button--ok {\n  margin-right: 25px;\n}\n\n.progress-block {\n  width: 180px;\n}\n\n.quantity-block {\n  display: flex;\n  justify-content: space-between;\n}\n.quantity-block__labels {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n.quantity-block__label {\n  margin-right: 47px;\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 17px;\n  letter-spacing: 0em;\n  text-align: center;\n}\n.quantity-block__issued {\n  position: relative;\n  right: -5px;\n}\n.quantity-block__inshifts {\n  margin-right: 44px;\n  position: relative;\n  right: 10px;\n}\n\n.route-type__paused {\n  border: 2px solid rgb(224, 108, 0);\n}\n.route-type__error {\n  border: 2px solid rgb(210, 66, 66);\n}\n.route-type__start {\n  border: 2px solid rgb(24, 136, 217);\n}\n.route-type__finish {\n  border: 2px solid rgb(0, 130, 29);\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n}\n#route__delete:disabled:hover {\n  color: gray !important;\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgb(236, 236, 236);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n}\n.modal-error__input {\n  text-align: left !important;\n}\n.modal-error__input {\n  padding-left: 10px;\n  margin-top: 20px;\n  height: 28px;\n  margin-right: 0;\n  width: 90%;\n  margin-bottom: 15px;\n  background: rgb(255, 255, 255);\n}\n.modal-error__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-issued__date {\n  margin-bottom: 10px;\n  margin-right: 0;\n}\n.modal-issued__input {\n  margin-right: 0;\n  width: 20%;\n  height: 28px;\n  margin-bottom: 15px;\n}\n.modal-issued__title {\n  margin-top: 10px;\n  margin-bottom: 15px;\n}\n\n.user__block {\n  margin-right: 40px;\n}\n\n.endtime__block {\n  margin-right: 107px;\n}\n\n.start-route__btn {\n  color: rgb(24, 136, 217);\n}\n\n.end-route__btn {\n  color: rgb(0, 130, 29);\n}\n\n.pause-route__btn {\n  color: rgb(224, 108, 0);\n}\n\n.error-route__btn {\n  color: rgb(210, 66, 66);\n}\n\n.section-report {\n  justify-content: left;\n}\n\n.issued-modal_trigger {\n  margin-right: 75px;\n}\n\n.send__comment {\n  width: 130px;\n  border: 2px solid rgb(105, 135, 105);\n  color: rgb(105, 135, 105);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n\n.section-finish__sub {\n  border-radius: 15px;\n  width: 130px;\n  height: 40px;\n  border: none;\n  background: rgb(105, 135, 105);\n  color: rgb(255, 255, 255);\n}\n.section-finish__delete {\n  border: none;\n  background: none;\n  color: rgb(210, 66, 66);\n  cursor: pointer;\n}\n\n.modal_content--comments {\n  width: 612px;\n}\n\n.comments__title {\n  font-size: 20px;\n  font-weight: 500;\n  line-height: 26px;\n  letter-spacing: 0em;\n  text-align: left;\n  color: rgb(255, 255, 255);\n  margin-left: 31px;\n}\n.comments-content {\n  padding: 24px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  background: rgb(236, 236, 236);\n  border-radius: 15px;\n}\n.comments__add {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n\n.comments-list {\n  height: 90px;\n  padding: 7px 10px;\n  overflow-y: scroll;\n  border-radius: 15px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  background: rgb(255, 255, 255);\n}\n.comments-list__item {\n  color: rgb(70, 70, 70);\n  margin-bottom: 5px;\n  display: flex;\n  align-items: center;\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n}\n\n.comments__prev {\n  margin-bottom: 10px;\n}\n\n.comments__yours {\n  cursor: text !important;\n}\n\n.comments__yours {\n  width: 350px;\n  padding-left: 10px;\n}\n\n.modal-plan {\n  padding: 5px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n}\n.modal-plan__today {\n  text-align: center;\n  align-self: center;\n}\n.modal-plan__section {\n  width: 250px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.modal-plan__section:not(:last-child) {\n  margin-bottom: 10px;\n}\n.modal-plan__data {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__data--center {\n  justify-content: center;\n}\n.modal-plan__input {\n  width: 120px;\n}\n.modal-plan__check {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.modal-plan__exclude {\n  text-align: center;\n  height: 100px;\n}\n.modal-plan__exclude-option {\n  text-align: center;\n  padding: 2px;\n}\n.modal-plan__exclude-option:hover {\n  cursor: pointer;\n}\n\n.confirm__title--plan {\n  margin-bottom: 5px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.plan-period {\n  margin-bottom: 10px;\n}\n.plan-period__btn:not(:last-child) {\n  margin-right: 5px;\n}\n\n.plan-dates {\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-left: -2px;\n}\n.plan-dates__item {\n  width: 56px;\n  padding: 5px;\n  background: rgb(255, 255, 255);\n  margin-bottom: 7px;\n  transition: color 0.3s;\n  text-align: center;\n}\n.plan-dates__item:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: #09d009;\n}\n.plan-dates__item:not(:last-child) {\n  margin-right: 7px;\n}\n.plan-dates__item--inplan {\n  color: white;\n  background: rgb(137, 175, 137);\n}\n.plan-dates__item--busy {\n  border: 1px solid rgb(137, 175, 137);\n}\n\n.admin-panel {\n  min-width: 1200px;\n  width: 80%;\n  height: 600px;\n  background: rgb(255, 255, 255);\n}\n\n.panel-nav {\n  margin-top: 10px;\n  color: rgb(70, 70, 70);\n  padding: 5px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav-navigation {\n  padding: 10px;\n  width: 350px;\n  height: 200px;\n  background: rgb(236, 236, 236);\n  border-radius: 15px;\n}\n.nav-navigation__item {\n  height: 28px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-navigation__item:not(:last-child) {\n  margin-bottom: 10px;\n}\n.nav-navigation__item--title {\n  width: 100%;\n  background: rgb(137, 175, 137);\n  border-radius: 15px;\n  text-align: center;\n  color: rgb(255, 255, 255);\n}\n.nav-navigation__text {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-navigation__text:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n\n.nav-content {\n  width: 70%;\n  min-height: 500px;\n  max-height: 500px;\n  display: flex;\n  flex-direction: column;\n  overflow: scroll;\n}\n.nav-content__columns {\n  height: 40px;\n  padding: 10px;\n  border-radius: 15px 15px 0 0;\n  background: rgb(137, 175, 137);\n  color: rgb(255, 255, 255);\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-content__items {\n  padding: 10px;\n  background: rgb(236, 236, 236);\n}\n.nav-content__item {\n  height: 28px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.nav-content__column {\n  min-width: 20%;\n  text-align: center;\n}\n.nav-content__column--left {\n  text-align: left !important;\n}\n\n.nav-item {\n  width: 100%;\n}\n.nav-item__column {\n  text-align: center;\n  min-width: 20%;\n}\n.nav-item__column--left {\n  text-align: left;\n}\n.nav-item__column--edit {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-item__column--edit:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.nav-item__pos {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.nav-item__pos:hover {\n  transition: color 0.3s;\n  color: rgb(137, 175, 137);\n}\n\n.edit-form {\n  align-self: center;\n  width: 726px;\n  display: flex;\n  justify-content: space-between;\n  background: rgb(236, 236, 236);\n  padding: 25px;\n  border-radius: 15px;\n}\n.edit-form--group {\n  width: 300px;\n  height: 350px;\n}\n.edit-form--group .edit-form__user {\n  border-right: none;\n  width: 100%;\n  height: 100%;\n}\n.edit-form__text {\n  padding: 10px;\n  width: 250px;\n  height: 100px;\n  resize: none;\n  cursor: pointer;\n}\n.edit-form__user {\n  margin-top: 13px;\n  width: 50%;\n  height: 284px;\n  border-right: 1px solid rgb(70, 70, 70);\n}\n.edit-form__block {\n  display: flex;\n  flex-direction: column;\n  margin-bottom: 15px;\n}\n.edit-form__block--checker {\n  flex-direction: row;\n}\n.edit-form__label {\n  font-size: 18px;\n  font-weight: 400;\n  line-height: 30px;\n  letter-spacing: 0em;\n}\n.edit-form__label--checker {\n  flex-direction: row;\n  margin-right: 168px;\n}\n.edit-form__input {\n  width: 250px !important;\n  height: 28px !important;\n  cursor: text !important;\n  margin-bottom: 0 !important;\n}\n.edit-form__input {\n  padding: 5px 5px 5px 10px;\n}\n.edit-form__submit {\n  cursor: pointer;\n  margin-top: 20px;\n  align-self: flex-end;\n}\n\n.main-table__header {\n  display: flex;\n  align-items: center;\n  position: sticky;\n  z-index: 10;\n  top: 0;\n  width: 100%;\n}\n.main-table__item {\n  display: flex;\n  align-items: center;\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table__cell {\n  font-size: 14px;\n  font-weight: 400;\n  line-height: 18px;\n  letter-spacing: 0em;\n  text-align: left;\n  height: 28px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  cursor: default;\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n  background: white;\n  color: rgb(0, 0, 0);\n}\n.table__cell:not(:last-child) {\n  border-right: 1px solid black;\n}\n.table__cell--top {\n  background: rgb(217, 221, 220) !important;\n}\n.table:last-child {\n  border-right: none;\n}\n.table__use label {\n  cursor: pointer;\n  transition: color 0.3s;\n}\n.table__use label:hover {\n  color: rgb(137, 175, 137);\n  transition: color 0.3s;\n}\n.table__data {\n  font-size: 14px;\n  font-weight: 400;\n  height: 28px;\n  width: 100%;\n  text-align: center;\n  border-radius: 1px;\n  border: none;\n  background: white;\n  color: black;\n  outline: 3.3px #447e9b;\n  position: relative;\n}\n.table__data--ro {\n  cursor: default;\n  outline: none;\n}\n.table__data--chosen {\n  background: rgb(217, 221, 217);\n  color: rgb(0, 0, 0);\n}\n.table__data--opened {\n  height: 56px;\n  font-size: 15px;\n  background: rgb(217, 221, 217);\n  color: rgb(0, 0, 0);\n  border-bottom: 1px solid black;\n}\n.table__data--opened.table__data--current {\n  border-bottom: 2px solid black;\n}\n.table__data--current {\n  font-weight: 600;\n  color: rgb(0, 0, 0);\n  border: 1px solid black;\n}\n.table__db {\n  display: flex;\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__timestamp {\n  min-width: 100px;\n  max-width: 100px;\n}\n.table__files {\n  min-width: 32px;\n  max-width: 32px;\n  position: relative;\n}\n.table__number {\n  min-width: 80px;\n  max-width: 80px;\n}\n.table__sample {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table__client {\n  min-width: 160px;\n  max-width: 160px;\n}\n.table__name {\n  min-width: 260px;\n  max-width: 260px;\n}\n.table__material {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__quantity {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued {\n  border-right: 1px solid black !important;\n}\n.table__issued {\n  min-width: 70px;\n  max-width: 70px;\n}\n.table__issued--done {\n  color: green;\n  animation: issued-ready infinite 4s;\n}\n.table__complete {\n  border-right: none !important;\n}\n.table__complete {\n  border-top: 1px solid black;\n  border-bottom: 1px solid black;\n}\n.table__complete input {\n  height: 26px;\n}\n.table__m {\n  min-width: 36px;\n  max-width: 36px;\n}\n.table__endtime {\n  min-width: 140px;\n  max-width: 140px;\n}\n.table__route {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 29px;\n  width: 45px;\n}\n.table__route:last-child {\n  border-right: 1px solid black !important;\n}\n.table__routes {\n  min-width: 450px;\n  max-width: 450px;\n}\n.table__p {\n  min-width: 60px;\n  max-width: 60px;\n}\n.table-p-select, .table-m-select {\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  cursor: pointer;\n}\n.table__comment {\n  flex-grow: 1;\n  min-width: 200px;\n  max-width: 100%;\n}\n.table-routes__wrapper {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 28px;\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body_cell {\n  max-height: 56px;\n  font-size: 16px;\n  border-right: 1px solid black;\n  border-bottom: 1px solid black;\n  position: relative;\n}\n.table-body_cell:last-child {\n  border-right: none;\n}\n.table-body_cell--opened {\n  height: 56px;\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n  50% {\n    background: green;\n    color: white;\n  }\n  100% {\n    background: white;\n    color: black;\n  }\n}\n.table__route:first-child {\n  border-left: none;\n}\n.table__route--issued {\n  border-top: none;\n  max-height: 28px;\n}\n.table__route--issued:last-child {\n  border-right: 1px solid black;\n}\n.table__route--issued:first-child {\n  border-left: none;\n}\n.table__route--issued input {\n  height: 26px;\n}\n\n.route {\n  color: black;\n  height: 24px;\n  width: 37px;\n}\n.route--inplan {\n  border-left: 1px solid black !important;\n}\n.route--inplan {\n  border-top: 1px solid black;\n  border-bottom: 2px solid black;\n  border-right: 2px solid black;\n}\n.route--paused {\n  color: white !important;\n}\n.route--paused {\n  background: rgb(224, 108, 0);\n  border-radius: 15px;\n}\n.route--error {\n  color: white !important;\n}\n.route--error {\n  background: rgb(210, 66, 66);\n  border-radius: 15px;\n}\n.route--started {\n  background: white !important;\n}\n.route--started {\n  border: 2px solid rgb(81, 165, 227);\n  border-radius: 15px;\n}\n.route--completed {\n  background: white !important;\n}\n.route--completed {\n  border: 2px solid rgb(0, 130, 29);\n  border-radius: 15px;\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color 0.3s;\n}\n.order__delete:hover {\n  cursor: pointer;\n  transition: color 0.3s;\n  color: white;\n}\n\n.table__issued--report {\n  min-width: 105px;\n  max-width: 105px;\n}\n.table__plan--report {\n  min-width: 105px;\n  max-width: 105px;\n}\n.table__route--report {\n  min-width: 65px;\n  max-width: 65px;\n}\n.table__operator--report {\n  min-width: 95px;\n  max-width: 95px;\n}\n.table__issued-plan--report {\n  min-width: 120px;\n  max-width: 120px;\n}", "",{"version":3,"sources":["webpack://./web/src/static/css/table/table.scss","webpack://./web/src/static/css/main.scss","webpack://./web/src/static/css/var.scss","webpack://./web/src/static/css/table/top_filters.scss","webpack://./web/src/static/css/table/table_nav.scss","webpack://./web/src/static/css/table/files_modal.scss","webpack://./web/src/static/css/table/route_modal.scss","webpack://./web/src/static/css/table/comments_modal.scss","webpack://./web/src/static/css/table/planModal.scss","webpack://./web/src/static/css/table/adminPanel.scss"],"names":[],"mappings":"AAAA,gBAAgB;ACEhB;EACE,UAAA;EACA,SAAA;EACA,sBAAA;ADAF;;ACGA;;EAEE,8CAAA;EACA,wBAAA;EACA,SAAA,EAAA,uEAAA;ADAF;;ACGA;EACE,aAAA;ADAF;;ACGA;EACE,kBAAA;EACA,8BAAA;ADAF;;ACGA;EACE,eAAA;ADAF;;ACGA;EACE,gBAAA;ADAF;;ACGA;EACE,wBAAA;EACA,6BAAA;ADAF;;ACGA;EACE,wBAAA;EACA,6BAAA;ADAF;;ACGA;EACE,sBC/BW;EDgCX,mBAAA;ADAF;ACKI;EADF;IAEI,mBAAA;IACA,aAAA;EDFJ;AACF;ACKE;EACE,YAAA;EACA,kBAAA;EACA,uBAAA;EACA,kBAAA;EACA
EACA,gBAAA;AAspCJ","sourcesContent":["@import \"../main\";\n@import \"top_filters\";\n@import \"table_nav\";\n@import \"files_modal\";\n@import \"route_modal\";\n@import \"comments_modal\";\n@import \"planModal\";\n@import \"adminPanel\";\n\n.main-table {\n  &__header {\n    display: flex;\n    align-items: center;\n    position: sticky;\n    z-index: 10;\n    top: 0;\n    width: 100%;\n    //border: 1px solid black;\n    //border-top: none;\n  }\n\n  &__item {\n    display: flex;\n    align-items: center;\n  }\n}\n\ninput.table__data {\n  padding: 0 10px;\n}\n\ninput.tr {\n  padding: 0;\n}\n\n.table {\n  &__cell {\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 18px;\n    letter-spacing: 0em;\n    text-align: left;\n    height: 28px;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    cursor: default;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    background: white;\n    color: $table_text;\n\n    &:not(:last-child) {\n      border-right: 1px solid black;\n    }\n\n    &--top {\n      background: $table_bg !important;\n    }\n  }\n\n  &:last-child {\n    border-right: none;\n  }\n\n  &-form {\n\n    input {\n      //color: $button_color;\n    }\n  }\n\n  &__use {\n    label {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $main_green;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__data {\n    font-size: 14px;\n    font-weight: 400;\n    height: 28px;\n    width: 100%;\n    text-align: center;\n    border-radius: 1px;\n    border: none;\n    background: white;\n    color: black;\n    outline: 3.3px $button_color;\n    position: relative;\n\n    &--ro {\n      cursor: default;\n      outline: none;\n    }\n\n    &--chosen {\n      //font-size: 15px;\n      background: $table_bg_main;\n      color: $table_text;\n    }\n\n    &--opened {\n      height: 56px;\n      font-size: 15px;\n      background: $table_bg_main;\n      color: $table_text;\n      border-bottom: 1px solid black;\n    }\n\n    &--opened.table__data--current {\n      border-bottom: 2px solid black;\n    }\n\n    &--current {\n      font-weight: 600;\n      color: $table_text;\n      border: 1px solid black;\n      //font-size: 16px;\n    }\n  }\n\n  &__db {\n    display: flex;\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__timestamp {\n    min-width: 100px;\n    max-width: 100px;\n  }\n\n  &__files {\n    min-width: 32px;\n    max-width: 32px;\n    position: relative;\n  }\n\n  &__number {\n    min-width: 80px;\n    max-width: 80px;\n  }\n\n  &__sample {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &__client {\n    min-width: 160px;\n    max-width: 160px;\n  }\n\n  &__name {\n    min-width: 260px;\n    max-width: 260px;\n  }\n\n  &__material {\n    min-width: 140px;\n    max-width: 140px;\n  }\n\n  &__quantity {\n    min-width: 70px;\n    max-width: 70px;\n  }\n\n  &__issued {\n    min-width: 70px;\n    max-width: 70px;\n    border-right: 1px solid black !important;\n\n    &--done {\n      color: green;\n      animation: issued-ready infinite 4s;\n    }\n  }\n\n  &__complete {\n    border-right: none !important;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n\n    input {\n      height: 26px;\n    }\n  }\n\n  &__m {\n    min-width: 36px;\n    max-width: 36px;\n  }\n\n  &__endtime {\n    min-width: 140px;\n    max-width: 140px;\n  }\n\n  &__route {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    height: 29px;\n    width: 45px;\n\n    &:last-child {\n      border-right: 1px solid black !important;\n    }\n  }\n\n  &__routes {\n    min-width: 450px;\n    max-width: 450px;\n  }\n\n  &-routes__issued {\n    //border-top: 1px solid black;\n  }\n\n  &__p {\n    min-width: 60px;\n    max-width: 60px;\n  }\n\n  &-p-select,\n  &-m-select {\n    -webkit-appearance: none;\n    -moz-appearance: none;\n    appearance: none;\n    cursor: pointer;\n  }\n\n  &__comment {\n    flex-grow: 1;\n    min-width: 200px;\n    max-width: 100%;\n  }\n\n  &-routes {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      height: 28px;\n    }\n  }\n}\n\n.files__ico {\n  width: 30px;\n  height: 20px;\n}\n\n.table-body {\n  //&__trattr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 260%;\n  //    width: auto;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n  //\n  //&__attr {\n  //  position: relative;\n  //\n  //  &:hover:after {\n  //    box-sizing: border-box;\n  //    min-width: 100%;\n  //    text-align: center;\n  //    content: attr(data-title);\n  //    position: absolute; /* Абсолютное позиционирование */\n  //    left: 0;\n  //    top: 130%; /* Положение подсказки */\n  //    z-index: 1; /* Отображаем подсказку поверх других элементов */\n  //    background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  //    font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  //    font-size: 11px; /* Размер текста подсказки */\n  //    padding: 5px 5px; /* Поля */\n  //    border: 1px solid #333;\n  //  }\n  //}\n\n\n  &_cell {\n    max-height: 56px;\n    font-size: 16px;\n    border-right: 1px solid black;\n    border-bottom: 1px solid black;\n    position: relative;\n\n    &:last-child {\n      border-right: none;\n    }\n\n    &--opened {\n      height: 56px;\n    }\n  }\n}\n\n@keyframes issued-ready {\n  0% {\n    background: white;\n    color: black;\n  }\n\n  50% {\n    background: green;\n    color: white;\n  }\n\n  100% {\n    background: white;\n    color: black;\n  }\n}\n\n.table__route {\n  &:first-child {\n    border-left: none;\n  }\n\n  &--issued {\n    border-top: none;\n    max-height: 28px;\n\n    &:last-child {\n      border-right: 1px solid black;\n    }\n\n    &:first-child {\n      border-left: none;\n    }\n\n    input {\n      height: 26px;\n    }\n  }\n}\n\n.route {\n  color: black;\n  height: 24px;\n  width: 37px;\n\n  &--inplan {\n    border-top: 1px solid black;\n    border-bottom: 2px solid black;\n    border-right: 2px solid black;\n    border-left: 1px solid black !important;\n  }\n\n  &--planned {\n    //text-decoration: underline;\n    //font-style: italic;\n  }\n\n  &--paused {\n    background: rgba(224, 108, 0, 1);\n    color: white !important;\n    border-radius: 15px;\n  }\n\n  &--error {\n    color: white !important;\n    background: rgba(210, 66, 66, 1);\n    border-radius: 15px;\n  }\n\n  &--started {\n    background: white !important;\n    border: 2px solid rgba(81, 165, 227, 1);\n    border-radius: 15px;\n  }\n\n  &--completed {\n    background: white !important;\n    border: 2px solid rgba(0, 130, 29, 1);\n    border-radius: 15px;\n  }\n}\n\n.table-info {\n  display: flex;\n  align-items: center;\n}\n\n.order__delete {\n  width: 20px;\n  border: none;\n  background: red;\n  transition: color .3s;\n\n  &:hover {\n    cursor: pointer;\n    transition: color .3s;\n    color: white;\n  }\n}\n\n.table {\n  &__issued--report {\n    min-width: 105px;\n    max-width: 105px;\n  }\n\n  &__plan--report {\n    min-width: 105px;\n    max-width: 105px;\n  }\n\n  &__route--report {\n    min-width: 65px;\n    max-width: 65px;\n  }\n\n  &__operator--report {\n    min-width: 95px;\n    max-width: 95px;\n  }\n\n  &__issued-plan--report {\n    min-width: 120px;\n    max-width: 120px;\n  }\n}","@import \"var\";\n\n* {\n  padding: 0;\n  margin: 0;\n  box-sizing: border-box;\n}\n\ninput::-webkit-outer-spin-button,\ninput::-webkit-inner-spin-button {\n  /* display: none; <- Crashes Chrome on hover */\n  -webkit-appearance: none;\n  margin: 0; /* <-- Apparently some margin are still there even though it's hidden */\n}\n\ninput, select {\n  outline: none;\n}\n\nbody {\n  font-family: Inter;\n  background: rgba(236, 236, 236, 1);\n}\n\n.container {\n  padding: 0 15px;\n}\n\nul {\n  list-style: none;\n}\n\n.hidden-input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.hidden__input {\n  display: none !important;\n  visibility: hidden !important;\n}\n\n.main {\n  color: $text_black;\n  margin-bottom: 15px;\n  //border-left: 1px solid black;\n  //border-right: 1px solid black;\n\n  &--reports {\n    @media screen and (min-width: 1522px) {\n      margin: 0 auto 15px;\n      width: 1492px;\n    }\n  }\n\n  &__button {\n    height: 28px;\n    text-align: center;\n    border: 1px solid black;\n    border-radius: 5px;\n    background: white;\n    color: $text_black;\n    transition: color .3s;\n    cursor: pointer;\n    padding: 5px;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s;\n    }\n\n    &--select {\n      outline: none;\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 19px;\n      letter-spacing: 0em;\n      text-align: center;\n      //border-radius: 15px;\n      background: $table_bg !important;\n      color: $main_green;\n      cursor: pointer;\n      padding: 3px 7px;\n      border: none;\n    }\n\n    &--click {\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 19px;\n      letter-spacing: 0em;\n      text-align: center;\n      border-radius: 15px;\n      border: $btn_border;\n      box-shadow: $btn_shadow;\n      background: white;\n      color: $text_black;\n      cursor: pointer;\n      padding: 3px 7px;\n    }\n  }\n\n  &__input {\n    padding: 5px;\n    cursor: text;\n    border: 1px solid black;\n    border-radius: 5px;\n    color: $text_black;\n  }\n\n  &-table__data {\n    width: 100%;\n    height: 75vh;\n    overflow: scroll;\n    margin-bottom: 5px;\n    border-left: 1px solid black;\n    border-right: 1px solid black;\n    border-bottom: 1px solid black;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    background: white;\n\n    @media screen and (max-width: 1200px) {\n      height: 75vh;\n    }\n\n    @media screen and (min-width: 1500px) {\n      height: 86vh;\n    }\n\n    @media screen and (min-width: 1920px) {\n      height: 86vh;\n    }\n  }\n\n  &__select {\n    text-align: center !important;\n    width: 100%;\n  }\n}\n\n.success {\n  color: green !important;\n}\n\n.error {\n  color: red !important;\n}\n\n.warning {\n  color: #c0c03b !important;\n  margin-right: 10px;\n}\n\n.click-chose,\n.click-select {\n  cursor: pointer !important;\n}\n\na:active, /* активная/посещенная ссылка */\na:hover, /* при наведении */\na {\n  text-decoration: none;\n  color: #666;\n}\n\nselect:disabled {\n  cursor: default;\n  background: none;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\ninput:disabled {\n  cursor: default;\n  color: gray;\n}\n\nbutton {\n  border: none;\n  background: none;\n}\n\nbutton:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray;\n  }\n}\n\n.select-user {\n  margin-bottom: 25px;\n  width: 100px;\n  align-self: center;\n}\n\n.test {\n  &__form {\n    display: none;\n    visibility: hidden;\n  }\n\n  &__list {\n    background: none;\n  }\n\n  &__item {\n    background: transparent;\n  }\n\n  &__input {\n    background: transparent;\n    outline: none;\n    border: none;\n  }\n}\n\n.admin-form {\n  &__button {\n    width: 130px;\n    transition: color .3s;\n    position: absolute;\n    right: 24px;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n\n  &__user {\n    margin-right: 10px;\n  }\n\n  &__exit {\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $hover_aqua;\n    }\n  }\n}\n\n.header-user__block {\n  position: absolute;\n  display: flex;\n}\n\n\n.search {\n  display: flex;\n  align-items: center;\n\n  @media screen and (max-width: 1200px) {\n    display: none;\n  }\n}\n\n.orders__total {\n  margin-right: 10px;\n}\n\n.table__db {\n  position: relative;\n}\n\n.check-helper {\n  text-align: center;\n  z-index: 1;\n  position: absolute;\n  min-width: 100%;\n  //bottom: -33px;\n  background: rgba(255, 255, 230, 0.9); /* Полупрозрачный цвет фона */\n  font-family: Arial, sans-serif; /* Гарнитура шрифта */\n  font-size: 11px; /* Размер текста подсказки */\n  padding: 5px 5px; /* Поля */\n  border: 1px solid #333;\n\n  &--long {\n    min-width: 300%;\n  }\n\n  &--errored {\n    padding: 0;\n    color: black;\n  }\n}\n\n.routes-block {\n  display: flex;\n  align-items: center;\n}\n\n.archive-block {\n  display: flex;\n  align-items: center;\n}\n\n.header-routes {\n  display: flex;\n  align-items: center;\n}\n\n.header {\n  position: relative;\n}","$main_green: rgba(137, 175, 137, 1);\n\n$btn_shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n$btn_border: 1px solid rgba(203, 203, 203, 1);\n\n$input_shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.27) inset;\n\n$filter_green: linear-gradient(0deg, #698769, #698769);\n$filter_border: 1px solid rgba(130, 130, 130, 1);\n$current_filter_border: 2px solid rgba(217, 221, 220, 1);\n\n$text_gray: rgba(70, 70, 70, 1);\n$text_black: rgba(66, 66, 66, 1);\n$text_white: rgba(255, 255, 255, 1);\n\n$table_text: rgba(0, 0, 0, 1);\n$table_bg: rgba(217, 221, 220, 1);\n$table_bg_main: rgba(217, 221, 217, 1);\n\n\n$hover_aqua: #13d9d9;\n$button_color: #447e9b;\n$gray_bg: #f3efef;",".nav-filters {\n  width: 77%;\n  position: relative;\n  height: 113px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 5px 25px;\n\n  display: flex;\n  flex-direction: column;\n\n  @media screen and (min-width: 1920px) {\n    width: 82%;\n  }\n\n  &__list {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    &:not(:last-child) {\n      padding-bottom: 15px;\n      margin-bottom: 5px;\n    }\n  }\n\n  &__item {\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__button {\n    &--chosen {\n      background: $main_green;\n      color: $text_white;\n    }\n  }\n}\n\n.nav-filters {\n  &__plots {\n    margin-top: 10px;\n    border-bottom: 1px solid black;\n    margin-bottom: 10px;\n  }\n\n  &__filters {\n    margin-top: 7px;\n    margin-bottom: 0 !important;\n  }\n\n  &__reset {\n    width: 131px;\n    display: block;\n    align-self: center;\n  }\n}\n\n.nav {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 10px;\n  margin-top: 10px;\n}\n\n.nav-control {\n  width: 313px;\n  height: 113px;\n  border: 1px solid black;\n  border-radius: 15px;\n  padding: 20px;\n  background: white;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &--opened {\n    z-index: 1000;\n    height: auto;\n    position: absolute;\n    right: 0;\n    top: 0;\n  }\n\n  &__nav {\n    display: flex;\n    //flex-direction: column;\n    align-items: center;\n    justify-content: space-between;\n  }\n\n  &__left {\n    width: 200px;\n  }\n\n  &__admin {\n    font-size: 14px;\n    font-weight: 500;\n    line-height: 17px;\n    letter-spacing: 0em;\n    margin-bottom: 10px;\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n\n  &__user {\n    display: flex;\n    margin-bottom: 7px;\n  }\n\n  &__name {\n    font-size: 16px;\n    font-weight: 700;\n    line-height: 21px;\n    letter-spacing: 0em;\n    color: rgba(76, 88, 102, 1);\n    margin-right: 7px;\n  }\n\n  &__exit {\n    a {\n      color: rgba(210, 66, 66, 1);\n      font-size: 16px;\n      font-weight: 400;\n      line-height: 21px;\n      letter-spacing: 0em;\n    }\n  }\n\n  &__total {\n    font-size: 18px;\n    font-weight: 500;\n    line-height: 23px;\n    letter-spacing: 0em;\n    text-align: center;\n    color: $main_green;\n  }\n\n  &__routes {\n    margin-bottom: 5px;\n    display: flex;\n    justify-content: space-between;\n  }\n\n  &__route {\n\n    &-link {\n      font-size: 16px;\n      font-weight: 500;\n      line-height: 26px;\n      letter-spacing: 0em;\n      cursor: pointer;\n\n      &:hover {\n        color: $main_green;\n      }\n\n      &--current {\n        text-decoration: underline;\n      }\n    }\n  }\n\n  &__burger {\n    position: relative;\n    top: -5px;\n    cursor: pointer;\n\n    &-item {\n      display: block;\n      width: 40px;\n      height: 5px;\n      background: $text_black;\n      border-radius: 15px;\n\n      &:not(:last-child) {\n        margin-bottom: 6px;\n      }\n    }\n  }\n}","@import \"../var\";\n\n.main-header {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  background: $main_green;\n  border: 1px solid black;\n  border-bottom: none;\n  border-radius: 15px 15px 0 0;\n  padding: 5px 30px;\n  height: 49px;\n  //margin-bottom: 30px;\n\n  &__title {\n    position: relative;\n    top: -1px;\n    font-size: 27px;\n    font-weight: 700;\n    line-height: 29px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: $text_white;\n    margin-right: 20px;\n  }\n\n  &__nav {\n    display: flex;\n    align-items: center;\n    //width: 400px;\n  }\n\n  &__button {\n    &:not(:last-child) {\n      margin-right: 20px;\n    }\n  }\n}\n\n.header-routes {\n  &__filter {\n    &:not(:last-child) {\n      margin-right: 10px;\n    }\n  }\n\n  &__planned {\n    &-date {\n      width: 140px;\n    }\n  }\n}\n\n#search__target {\n  width: 120px !important;\n  margin-right: 5px;\n}\n\n#search__input {\n  height: 28px;\n  margin-right: 5px;\n}\n\n.route__filter--chosen {\n  border: 1px solid $text_white;\n  color: $text_white;\n  background: $main_green;\n}",".modal {\n  display: none;\n  background: transparent;\n  position: fixed;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n  z-index: 100;\n\n  &_content {\n    display: flex;\n    flex-direction: column;\n    width: 900px;\n    height: auto;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    border-radius: 15px;\n    background: rgba(236, 236, 236, 1);\n  }\n\n  &-header {\n    width: 100%;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    padding: 5px;\n    background: $main_green;\n    color: $text_white;\n    text-align: center;\n    height: 35px;\n    border-radius: 15px 15px 0px 0px;\n  }\n\n  &__trigger {\n    display: flex;\n    align-items: center;\n    cursor: pointer;\n    justify-content: center;\n    width: 100%;\n    height: 100px;\n    //background: ;\n    border-top: 1px solid black;\n    border-bottom: 1px solid black;\n    color: $main_green;\n    background: $text_white;\n  }\n}\n\n.modal_vis {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n.body_block {\n  overflow: hidden;\n  //margin-right: 15px;\n}\n\n.data {\n  display: flex;\n  height: 350px;\n  padding: 5px;\n  overflow-y: scroll;\n  justify-content: space-between;\n  flex-wrap: wrap;\n  margin-bottom: 70px;\n\n  &__file {\n    position: relative;\n    width: 280px;\n    height: 280px;\n    margin-bottom: 60px;\n  }\n}\n\n.link__preview {\n  display: block;\n  width: 280px;\n  height: 280px;\n  margin-bottom: 10px;\n}\n\n.file {\n  &__preview {\n    width: 280px;\n    height: 280px;\n    //object-fit: cover;\n  }\n\n  &__download {\n    cursor: pointer;\n    position: absolute;\n    width: 30px;\n    height: 40px;\n    bottom: 5px;\n    right: 10px;\n    color: $main_green !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: green !important;\n      transition: color .3s;\n    }\n  }\n\n  &__remove {\n    cursor: pointer;\n    top: 0px;\n    right: 5px;\n    position: absolute;\n    color: $main_green !important;\n    font-size: 26px;\n    transform: rotate(45deg);\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: red !important;\n      transition: color .3s;\n    }\n  }\n\n\n  &__original {\n    position: absolute;\n    top: 5px;\n    left: 5px;\n    color: $text_black !important;\n    transition: color .3s;\n\n    &:hover {\n      cursor: pointer;\n      color: $main_green !important;\n      transition: color .3s;\n    }\n  }\n\n  &__name {\n    color: $text_black;\n    text-align: center;\n  }\n\n  &__all {\n    align-self: center;\n    width: 170px;\n    margin-bottom: 15px;\n  }\n}",".modal_content--route {\n  width: 619px;\n  height: auto;\n}\n\n.route {\n  &__config {\n    padding: 13px 10px 0;\n    background: rgba(236, 236, 236, 1);\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n  }\n\n  &__title {\n    font-size: 16px;\n    font-weight: 500;\n    line-height: 19px;\n    margin-bottom: 10px;\n  }\n\n  &-block {\n    &__wrapper {\n      display: flex;\n      align-items: center;\n      margin-bottom: 10px;\n    }\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n  }\n\n  &__input {\n    &:not(:disabled), {\n      cursor: pointer;\n    }\n\n    &:not(:read-only) {\n\n    }\n  }\n\n  &-plan__date {\n    border: 1px solid rgba(173, 173, 173, 1) !important;\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25) !important;\n    margin-right: 0 !important;\n    color: $text_black;\n  }\n\n  &__label {\n    text-align: center;\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 17px;\n    letter-spacing: 0em;\n    margin-bottom: 7px;\n  }\n\n  &__btn {\n    align-items: center;\n    width: 97px;\n    border: 1px solid rgba(173, 173, 173, 1);\n    box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n    border-radius: 15px;\n  }\n\n  &__select {\n    width: 130px;\n    margin-bottom: 10px;\n    border: none;\n    border-radius: 7px;\n    box-shadow: 2px 2px 5px 0px rgba(0, 0, 0, 0.25);\n    background: rgba(255, 255, 255, 1);\n\n    &:disabled {\n      background: rgba(255, 255, 255, 1);\n    }\n  }\n\n  &__input {\n    width: 136px;\n    height: 28px;\n    margin-right: -40px;\n    box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n    border-radius: 15px;\n    border: none;\n    outline: none;\n\n    &:not(:disabled) {\n      &:focus {\n        outline: 2px solid $main_green;\n      }\n    }\n\n    &--small {\n      width: 80px !important;\n\n      &:not(:last-child) {\n        //margin-right: 20px;\n      }\n    }\n\n    &--top {\n      width: 136px;\n      text-align: center;\n      margin-bottom: 10px;\n      height: 28px;\n      box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n      border-radius: 15px;\n      border: none;\n    }\n\n    &--middle {\n      width: 155px;\n    }\n  }\n\n  &__section {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 15px;\n  }\n}\n\n.report-route__btn {\n  //margin-right: 30px;\n}\n\n.section-logs {\n  width: 100%;\n  background: white;\n  border-radius: 5px;\n  padding: 5px;\n  margin-bottom: 8px;\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__title {\n    text-align: center;\n    margin-bottom: 10px;\n    color: $button_color;\n  }\n\n  &__list {\n    height: 85px;\n    overflow-y: scroll;\n  }\n\n  &__input {\n    padding-left: 10px;\n  }\n\n  &__item {\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 18px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: rgba(87, 87, 87, 1);\n    margin-bottom: 5px;\n\n    &--system {\n      color: $main_green;\n    }\n\n    &--error {\n      color: rgba(210, 66, 66, 1);\n    }\n  }\n\n  &__comment {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    margin-bottom: 30px;\n  }\n\n  &__input {\n    width: 350px;\n  }\n}\n\n.section-finish {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  margin-bottom: 15px;\n\n  &__cancel {\n    margin-right: 30px;\n  }\n\n  &__delete {\n    &:hover {\n      color: red !important;\n    }\n  }\n}\n\n#quantity,\n#day_quantity,\n#issued,\n#error-route__msg,\n#error__time,\n#route__issued,\n{\n  text-align: center;\n}\n\n#error-route__msg,\n.issued-route__num:not(:disabled) {\n  cursor: text;\n}\n\n.modal_content--issued {\n  width: 250px;\n  height: 300px;\n}\n\n.comment {\n  &__prev {\n    margin: 12px auto 0;\n    overflow-y: scroll;\n    background: $text_white;\n    height: 80%;\n    width: 90%;\n    border-radius: 15px;\n  }\n\n  &__item {\n    color: $text_black;\n    font-size: 17px;\n    padding: 10px 13px;\n  }\n}\n\n.confirm {\n  &__title {\n    font-size: 20px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    margin-top: 10px;\n    text-align: center;\n    color: $text_black;\n    margin-bottom: 25px;\n  }\n\n  &__section {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  &__button {\n    &--ok {\n      margin-right: 25px;\n    }\n\n    margin-bottom: 10px;\n  }\n}\n\n.progress-block {\n  width: 180px;\n}\n\n.quantity-block {\n  display: flex;\n  justify-content: space-between;\n\n  &__labels {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n  }\n\n  &__label {\n    margin-right: 47px;\n    font-size: 14px;\n    font-weight: 400;\n    line-height: 17px;\n    letter-spacing: 0em;\n    text-align: center;\n  }\n\n  &__issued {\n    position: relative;\n    right: -5px;\n  }\n\n  &__shifts {\n    //margin-right: 33px;\n  }\n\n  &__inshifts {\n    margin-right: 44px;\n    position: relative;\n    right: 10px;\n  }\n}\n\n.route-type {\n  &__paused {\n    //color: rgba(224, 108, 0, 1) !important;\n    border: 2px solid rgba(224, 108, 0, 1);\n  }\n\n  &__error {\n    //color: rgba(210, 66, 66, 1) !important;\n    border: 2px solid rgba(210, 66, 66, 1);\n  }\n\n  &__start {\n    //color: rgba(24, 136, 217, 1) !important;\n    border: 2px solid rgba(24, 136, 217, 1);\n  }\n\n  &__finish {\n    //color: rgba(0, 130, 29, 1) !important;\n    border: 2px solid rgba(0, 130, 29, 1);\n  }\n}\n\n#route__delete:disabled {\n  cursor: default;\n  color: gray;\n\n  &:hover {\n    color: gray !important;\n  }\n}\n\n.modal-error {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  background: rgba(236, 236, 236, 1);\n  box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n\n  &__input {\n    padding-left: 10px;\n    margin-top: 20px;\n    height: 28px;\n    text-align: left !important;\n    margin-right: 0;\n    width: 90%;\n    margin-bottom: 15px;\n    background: $text_white;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.modal-issued {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  &__date {\n    margin-bottom: 10px;\n    margin-right: 0;\n\n  }\n\n  &__input {\n    margin-right: 0;\n    width: 20%;\n    height: 28px;\n    margin-bottom: 15px;\n  }\n\n  &__title {\n    margin-top: 10px;\n    margin-bottom: 15px;\n  }\n}\n\n.user__block {\n  margin-right: 40px;\n}\n\n.endtime__block {\n  margin-right: 107px;\n}\n\n.start-route__btn {\n  color: rgba(24, 136, 217, 1);\n}\n\n.end-route__btn {\n  color: rgba(0, 130, 29, 1);\n}\n\n.pause-route__btn {\n  color: rgba(224, 108, 0, 1);\n}\n\n.error-route__btn {\n  color: rgba(210, 66, 66, 1);\n}\n\n.section-report {\n  justify-content: left;\n}\n\n.issued-modal_trigger {\n  margin-right: 75px;\n}\n\n.send__comment {\n  width: 130px;\n  border: 2px solid rgba(105, 135, 105, 1);\n  color: rgba(105, 135, 105, 1);\n  box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);\n  border-radius: 15px;\n}\n\n.section-finish {\n  &__sub {\n    border-radius: 15px;\n    width: 130px;\n    height: 40px;\n    border: none;\n    background: rgba(105, 135, 105, 1);\n    color: $text_white;\n  }\n\n  &__delete {\n    border: none;\n    background: none;\n    color: rgba(210, 66, 66, 1);\n    cursor: pointer;\n  }\n}\n",".modal_content--comments {\n  width: 612px;\n}\n\n\n.comments {\n  &__title {\n    font-size: 20px;\n    font-weight: 500;\n    line-height: 26px;\n    letter-spacing: 0em;\n    text-align: left;\n    color: $text_white;\n    margin-left: 31px;\n  }\n\n  &-content {\n    padding: 24px;\n    box-shadow: 3px 3px 15px 0px rgba(0, 0, 0, 0.25);\n    background: rgba(236, 236, 236, 1);\n    border-radius: 15px;\n  }\n\n  &__add {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n}\n\n.comments-list {\n  height: 90px;\n  padding: 7px 10px;\n  overflow-y: scroll;\n  border-radius: 15px;\n  box-shadow: 2px 2px 1px 0px rgba(0, 0, 0, 0.25) inset;\n  background: $text_white;\n\n  &__item {\n    color: $text_gray;\n    margin-bottom: 5px;\n    display: flex;\n    align-items: center;\n  }\n}\n\n.comment__button {\n  width: 100px;\n  align-self: center;\n}\n\n.comments__prev {\n  margin-bottom: 10px;\n}\n\n.comments__yours {\n  width: 350px;\n  cursor: text !important;\n  padding-left: 10px;\n}",".modal {\n  &-plan__date {\n\n  }\n\n  &-plan {\n    padding: 5px;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    &__today {\n      text-align: center;\n      align-self: center;\n    }\n\n    &__section {\n      width: 250px;\n      display: flex;\n      flex-direction: column;\n      justify-content: space-between;\n      //align-items: center;\n\n      &:not(:last-child) {\n        margin-bottom: 10px;\n      }\n    }\n\n    &__data {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n\n      &--center {\n        justify-content: center;\n      }\n    }\n\n    &__input {\n      width: 120px;\n    }\n\n    &__check {\n      display: flex;\n      //flex-direction: column;\n      justify-content: space-between;\n      align-items: center;\n    }\n\n    &__exclude {\n      text-align: center;\n      height: 100px;\n\n      &-option {\n        text-align: center;\n        padding: 2px;\n\n        &:hover {\n          cursor: pointer;\n        }\n      }\n    }\n  }\n}\n\n.confirm__title--plan {\n  margin-bottom: 5px;\n}\n\n.exclude-date {\n  background: gray;\n}\n\n.modal-plan__exclude {\n  height: 100px;\n  border: 1px solid black;\n  border-radius: 5px;\n  overflow-x: scroll;\n}\n\n.plan-period {\n  &__btn {\n    &:not(:last-child) {\n      margin-right: 5px;\n    }\n  }\n\n  margin-bottom: 10px;\n}\n\n.plan-dates {\n  display: flex;\n  //justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n  margin-left: -2px;\n\n  &__item {\n    width: 56px;\n    padding: 5px;\n    background: $text_white;\n    margin-bottom: 7px;\n    transition: color .3s;\n    text-align: center;\n\n    &:hover {\n      cursor: pointer;\n      transition: color .3s;\n      color: #09d009;\n    }\n\n    &:not(:last-child) {\n      margin-right: 7px;\n    }\n\n    &--inplan {\n      color: white;\n      background: $main_green;\n    }\n\n    &--busy {\n      border: 1px solid $main_green;\n    }\n  }\n}",".admin-panel {\n  min-width: 1200px;\n  width: 80%;\n  height: 600px;\n  background: $text_white;\n}\n\n.panel-nav {\n  margin-top: 10px;\n  color: $text_gray;\n\n  padding: 5px;\n  width: 100%;\n  display: flex;\n  justify-content: space-between;\n}\n\n.nav-navigation {\n  padding: 10px;\n  width: 350px;\n  height: 200px;\n  background: rgba(236, 236, 236, 1);\n  border-radius: 15px;\n\n  &__item {\n    height: 28px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n\n    &:not(:last-child) {\n      margin-bottom: 10px;\n    }\n\n    &--title {\n      width: 100%;\n      background: $main_green;\n      border-radius: 15px;\n      text-align: center;\n      color: $text_white;\n    }\n  }\n\n  &__text {\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      color: $main_green;\n      transition: color .3s;\n    }\n  }\n}\n\n.nav-content {\n  width: 70%;\n  min-height: 500px;\n  max-height: 500px;\n  display: flex;\n  flex-direction: column;\n\n  overflow: scroll;\n\n  &__columns {\n    height: 40px;\n    padding: 10px;\n    border-radius: 15px 15px 0 0;\n    background: $main_green;\n    color: $text_white;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    //height: 28px;\n  }\n\n  &__items {\n    padding: 10px;\n    background: rgba(236, 236, 236, 1);\n  }\n\n  &__item {\n    height: 28px;\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n  }\n\n  &__column {\n    min-width: 20%;\n    text-align: center;\n    \n    &--left {\n      text-align: left !important;\n    }\n  }\n\n}\n\n.nav-item {\n  width: 100%;\n\n  &__column {\n    text-align: center;\n    min-width: 20%;\n    \n    &--left {\n      text-align: left;\n    }\n\n    &--edit {\n      cursor: pointer;\n      transition: color .3s;\n\n      &:hover {\n        color: $main_green;\n        transition: color .3s;\n      }\n    }\n  }\n\n  &__pos {\n    cursor: pointer;\n    transition: color .3s;\n\n    &:hover {\n      transition: color .3s;\n      color: $main_green;\n    }\n  }\n}\n\n.edit-form {\n  align-self: center;\n  width: 726px;\n  display: flex;\n  justify-content: space-between;\n  background: rgba(236, 236, 236, 1);\n  padding: 25px;\n  border-radius: 15px;\n\n  &--group {\n    width: 300px;\n    height: 350px;\n\n    .edit-form__user {\n      border-right: none;\n      width: 100%;\n      height: 100%;\n    }\n  }\n\n  &__text {\n    padding: 10px;\n    width: 250px;\n    height: 100px;\n    resize: none;\n    cursor: pointer;\n  }\n\n  &__user {\n    margin-top: 13px;\n    width: 50%;\n    height: 284px;\n    border-right: 1px solid $text_gray;\n  }\n\n  &__block {\n    display: flex;\n    flex-direction: column;\n    margin-bottom: 15px;\n\n    &--checker {\n      flex-direction: row;\n    }\n  }\n\n  &__label {\n    font-size: 18px;\n    font-weight: 400;\n    line-height: 30px;\n    letter-spacing: 0em;\n\n    &--checker {\n      flex-direction: row;\n      margin-right: 168px;\n    }\n  }\n\n  &__input {\n    padding: 5px 5px 5px 10px;\n    width: 250px !important;\n    height: 28px !important;\n    cursor: text !important;\n    margin-bottom: 0 !important;\n  }\n\n  &__submit {\n    cursor: pointer;\n    margin-top: 20px;\n    align-self: flex-end;\n  }\n}"],"sourceRoot":""}]);
// Exports
